...
#    error "The magic number of the generated file <C:/CMSynergy_Projects/HwTrq/utp/contract/Sa_HwTrq/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
