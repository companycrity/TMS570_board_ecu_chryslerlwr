...
# define HwTrqStatusType_LowerLimit ((HwTrqStatusType)0u)
# define HwTrqStatusType_UpperLimit ((HwTrqStatusType)2u)
...
#  define HWTRQSTATUS_NONE ((HwTrqStatusType)0u)
# endif
...
#  define HWTRQSTATUS_ACTIVE ((HwTrqStatusType)1u)
# endif
...
#  define HWTRQSTATUS_FAULT ((HwTrqStatusType)2u)
# endif
...
struct Rte_CDS_Sa_HwTrq
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTRQ_APPL_VAR) HwTrq_Init_HwTrqScaleVal_VoltsPerDeg_f32;
  P2VAR(Rte_DE_ManufModeType, TYPEDEF, RTE_SA_HWTRQ_APPL_VAR) HwTrq_Init_MECCounter_Cnt_enum;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTRQ_APPL_VAR) HwTrq_Init_T1TrimVal_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTRQ_APPL_VAR) HwTrq_Init_T2TrimVal_Volt_f32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_SA_HWTRQ_APPL_VAR) HwTrq_Per1_AbsPosStepSignal_Cnt_u08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTRQ_APPL_VAR) HwTrq_Per1_AnaDiffHwTrq_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTRQ_APPL_VAR) HwTrq_Per1_AnaHwTorque_HwNm_f32;
  P2VAR(Rte_DE_HwTrqStatusType, TYPEDEF, RTE_SA_HWTRQ_APPL_VAR) HwTrq_Per1_ErrorActiveAnalog_Cnt_enum;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_HWTRQ_APPL_VAR) HwTrq_Per1_SrlComHwTrqValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTRQ_APPL_VAR) HwTrq_Per1_SysCAnaHwTorque_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTRQ_APPL_VAR) HwTrq_Per1_T1ADC_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTRQ_APPL_VAR) HwTrq_Per1_T2ADC_Volt_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_HWTRQ_APPL_VAR) HwTrq_Per2_CntrlDisRampComplete_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTRQ_APPL_VAR) HwTrq_Per2_SysCHwTorqueSqd_HwNmSq_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTRQ_APPL_VAR) HwTrq_Per2_T1ADC_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTRQ_APPL_VAR) HwTrq_Per2_T2ADC_Volt_f32;
  /* PIM Handles section */
  P2VAR(EOLTrqStepType, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_EOLTrqStepData;
  P2VAR(HwTrqScale_Datatype, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_HwTrqScaleData;
  P2VAR(HwTrqTrim_Datatype, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_HwTrqTrimData;
...
extern CONSTP2CONST(struct Rte_CDS_Sa_HwTrq, RTE_CONST, RTE_CONST) Rte_Inst_Sa_HwTrq;
...
#    error "The magic number of the generated file <C:/CMSynergy_Projects/HwTrq/utp/contract/Sa_HwTrq/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
