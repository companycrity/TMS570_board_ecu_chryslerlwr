...
struct Rte_CDS_Sa_HwTrq2
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTRQ2_APPL_VAR) HwTrq2_Per1_HwTrqScaleVal_VoltsPerDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTRQ2_APPL_VAR) HwTrq2_Per1_SysCHwTorqueSqd_HwNmSq_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTRQ2_APPL_VAR) HwTrq2_Per1_SysCT1ADC_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTRQ2_APPL_VAR) HwTrq2_Per1_SysCT2ADC_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTRQ2_APPL_VAR) HwTrq2_Per1_T1TrimVal_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTRQ2_APPL_VAR) HwTrq2_Per1_T2TrimVal_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTRQ2_APPL_VAR) HwTrq2_Per2_AnaHwTorque_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTRQ2_APPL_VAR) HwTrq2_Per2_SysCT1ADC_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTRQ2_APPL_VAR) HwTrq2_Per2_SysCT2ADC_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTRQ2_APPL_VAR) HwTrq2_Per2_T1TrimVal_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTRQ2_APPL_VAR) HwTrq2_Per2_T2TrimVal_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_HWTRQ2_APPL_VAR) HwTrq2_Per3_AnaDiffHwTrq_Volt_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Sa_HwTrq2, RTE_CONST, RTE_CONST) Rte_Inst_Sa_HwTrq2;
...
#    error "The magic number of the generated file <C:/CMSynergy_Projects/HwTrq/utp/contract/Sa_HwTrq2/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
