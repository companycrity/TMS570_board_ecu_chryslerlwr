...
#    error "The magic number of the generated file <C:/Synergy/EOTActuatorMng-zz4r1x/EOTActuatorMng/utp/contract/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
