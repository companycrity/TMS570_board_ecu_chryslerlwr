 ...
 *     Workspace:  C:/Synergy/EOTActuatorMng-zz4r1x/EOTActuatorMng/autosar
 *     SW-C Type:  Ap_EOTActuatorMng
 *  Generated at:  Sun Sep 16 13:25:57 2012
 *
 ...
 * %version:          16 %
 * %derived_by:       xz0btk %
 * %date_modified:    Fri Apr 26 13:48:51 2013 %
 *---------------------------------------------------------------------------------------------------------------------
...
/* Module variables */ 
STATIC VAR(float32, AUTOMATIC) EOTImpactPos_HwDeg_M_f32;
STATIC VAR(float32, AUTOMATIC) PrevEOTGain_Uls_M_f32; 
STATIC VAR(sint32, AUTOMATIC) FiltHWTrqSV_HwNm_M_s7p24;
STATIC VAR(uint32, AUTOMATIC) FiltEOTGainSV_HwNm_M_u1p31;
/* Display variables */
STATIC volatile VAR(float32, AUTOMATIC) EOTImpact_HwDeg_D_f32;
STATIC volatile VAR(float32, AUTOMATIC) LimitPosition_HwDeg_D_f32;
STATIC volatile VAR(float32, AUTOMATIC) EOTEnterGain_Uls_D_f32;
STATIC volatile VAR(float32, AUTOMATIC) EOTExitgain_Uls_D_f32;
STATIC volatile VAR(float32, AUTOMATIC) EOTGain_Uls_D_f32;
STATIC volatile VAR(float32, AUTOMATIC) FiltEOTGain_Uls_D_f32;
STATIC volatile VAR(float32, AUTOMATIC) EOTDamping_MtrNm_D_f32;
#define EOTACTUATORMNG_STOP_SEC_VAR_CLEARED_32
#include "MemMap.h" /* PRQA S 5087 */

#define EOTACTUATORMNG_START_SEC_VAR_CLEARED_BOOLEAN
#include "MemMap.h" /* PRQA S 5087 */
STATIC volatile VAR(boolean, AUTOMATIC) EOTDet_Cnt_D_lgc;
#define EOTACTUATORMNG_STOP_SEC_VAR_CLEARED_BOOLEAN
#include "MemMap.h" /* PRQA S 5087 */
#define EOTACTUATORMNG_START_SEC_VAR_CLEARED_UNSPECIFIED
#include "MemMap.h" /* PRQA S 5087 */
STATIC VAR(sesState_T, AUTOMATIC) SESState_Uls_M_enum;
 ...
 *********************************************************************************************************************/
	...
	if((EOTDet_Cnt_T_lgc == TRUE) || (TRUE == EOTDisable_Cnt_T_lgc))
	{
	...
	EOTExitGain_Uls_T_f32 = SES_CalcExitGain( HandWheelPos_HwDeg_T_f32, HwTorque_HwNm_T_f32, PrevEOTGain_Uls_M_f32, &FiltHwTrq_HwNm_T_f32);
	...
	if(SESState_Uls_M_enum == SES_DISABLED)
	{
	...
	PrevEOTGain_Uls_M_f32 = AssistEOTGain_Uls_T_f32;
...
STATIC FUNC(boolean, AUTOMATIC) EOTDetermination( VAR(boolean, AUTOMATIC) CwFound_Cnt_T_lgc, VAR(boolean, AUTOMATIC) CcwFound_Cnt_T_lgc)
{
	...
	EOTDet_Cnt_D_lgc = EOTDet_Cnt_T_lgc;
												...
												VAR(float32, AUTOMATIC) HandWheelPos_HwDeg_T_f32, VAR(float32, AUTOMATIC) VehicleSpeed_Kph_T_f32)
{
	...
	VAR(float32, AUTOMATIC) DeltaAstEOTLmt_MtrRadpS_T_f32;
		...
		{
			EOTImpactPos_HwDeg_M_f32 = FPM_FixedToFloat_m(k_EOTDefltPosition_HwDeg_u12p4, u12p4_T);
		}
		else 
		{
			if ( (EOTImpactPos_HwDeg_M_f32 > AbsHandWheelPos_HwDeg_T_f32) || (EOTImpactPos_HwDeg_M_f32 < AbsHandWheelPos_HwDeg_T_f32))
			{
				HwPosDiff_HwDeg_T_f32 = AbsHandWheelPos_HwDeg_T_f32 - EOTImpactPos_HwDeg_M_f32; 
				EOTImpactPos_HwDeg_M_f32 += ((FPM_FixedToFloat_m(k_PosRampStep_HwDeg_u12p4, u12p4_T) * (float32)Sign_f32_m(HwPosDiff_HwDeg_T_f32)));
			}
			else
			{
				EOTImpactPos_HwDeg_M_f32 = AbsHandWheelPos_HwDeg_T_f32;
			}
		}	
			
		/* update display variable */
		EOTImpact_HwDeg_D_f32 = EOTImpactPos_HwDeg_M_f32;
		...
		EOTImpactPos_HwDeg_T_u12p4 = FPM_FloatToFixed_m(EOTImpactPos_HwDeg_M_f32, u12p4_T);
...
STATIC FUNC(float32, AUTOMATIC) SES_DetLmtPos(VAR(float32, AUTOMATIC) CwEOT_HwDeg_T_f32, VAR(float32, AUTOMATIC) CcwEOT_HwDeg_T_f32, VAR(float32, AUTOMATIC) HandWheelPos_HwDeg_T_f32 )
{
	...
	LimitPosition_HwDeg_D_f32 = LimitPos_HwDeg_T_f32;
													...
													VAR(float32, AUTOMATIC) PrevEOTGain_Uls_T_f32, CONSTP2VAR(float32, AUTOMATIC, AUTOMATIC) FiltHwTrqPtr_HwNm_T_f32)
{
	...
	FiltHWTrqSV_HwNm_M_s7p24 = LPF_SvUpdate_s16InFixKTrunc_m(	HwTorque_HwNm_T_s7p8, 
																FiltHWTrqSV_HwNm_M_s7p24, 
                                      							k_EOTStateHwTrqLPFKn_Cnt_u16);
                                      								
	FiltHwTorque_HwNm_T_s7p8 = LPF_OpUpdate_s16InFixKTrunc_m(FiltHWTrqSV_HwNm_M_s7p24);
	*FiltHwTrqPtr_HwNm_T_f32 = FPM_FixedToFloat_m(FiltHwTorque_HwNm_T_s7p8, s7p8_T);
	...
	EOTExitgain_Uls_D_f32 = EOTExitGain_Uls_T_f32;
											...
											VAR(boolean, AUTOMATIC) EOTDisable_Cnt_T_lgc)
{
	...
	SESNextState_Uls_T_enum = SESState_Uls_M_enum;
	...
	SESState_Uls_M_enum = SESNextState_Uls_T_enum;
...
STATIC FUNC(float32, AUTOMATIC) SES_CalcEnterGain( VAR(float32, AUTOMATIC) HandWheelPos_HwDeg_T_f32, VAR(float32, AUTOMATIC) LimitPosition_HwDeg_T_f32, VAR(float32, AUTOMATIC) VehicleSpeed_Kph_T_f32)
{
	...
	EOTEnterGain_Uls_D_f32 = EOTEnterGain_Uls_T_f32;
...
STATIC FUNC(float32, AUTOMATIC) SES_CalcEOTGain( VAR(float32, AUTOMATIC) EOTEnterGain_Uls_T_f32, VAR(float32, AUTOMATIC) EOTExitGain_Uls_T_f32)
{
	...
	/* Update Display */
	EOTGain_Uls_D_f32 = EOTGain_Uls_T_f32;
...
STATIC FUNC(float32, AUTOMATIC) SES_FiltEOTGain( VAR(float32, AUTOMATIC) EOTGain_Uls_T_f32)
{
	...
	FiltEOTGainSV_HwNm_M_u1p31 = LPF_SvUpdate_u16InFixKTrunc_m(	EOTGain_Uls_T_u1p15, 
																FiltEOTGainSV_HwNm_M_u1p31, 
                                      							LPFKnVal_Cnt_T_u16);
                                      								
	FiltEOTGain_Uls_T_u1p15 = (uint16)LPF_OpUpdate_u16InFixKTrunc_m(FiltEOTGainSV_HwNm_M_u1p31);
	FiltEOTGain_Uls_T_f32 = FPM_FixedToFloat_m(FiltEOTGain_Uls_T_u1p15, u1p15_T);

	FiltEOTGain_Uls_D_f32 = FiltEOTGain_Uls_T_f32;
												 ...
												 VAR(float32, AUTOMATIC) MotorVel_MtrRadpS_T_f32)
{
	...
	else
	{
		...
		if( SESState_Uls_M_enum == SES_EXITING )
		{
	...
	EOTDamping_MtrNm_D_f32 = EOTDamping_MtrNm_T_f32;
