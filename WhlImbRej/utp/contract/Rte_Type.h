...
struct Rte_CDS_Ap_WhlImbRej
{
  /* Data Handles section */
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_WHLIMBREJ_APPL_VAR) WhlImbRej_Per1_DiagStsWIRDisable_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_WHLIMBREJ_APPL_VAR) WhlImbRej_Per1_HwTrq_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_WHLIMBREJ_APPL_VAR) WhlImbRej_Per1_QualWhlFreqL_Hz_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_WHLIMBREJ_APPL_VAR) WhlImbRej_Per1_QualWhlFreqR_Hz_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_WHLIMBREJ_APPL_VAR) WhlImbRej_Per1_VehSpdValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_WHLIMBREJ_APPL_VAR) WhlImbRej_Per1_VehSpd_Kph_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_WHLIMBREJ_APPL_VAR) WhlImbRej_Per1_WIRCmdAmpBlnd_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_WHLIMBREJ_APPL_VAR) WhlImbRej_Per1_WIRMfgEnable_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_WHLIMBREJ_APPL_VAR) WhlImbRej_Per1_WhlFreqQualified_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_WHLIMBREJ_APPL_VAR) WhlImbRej_Per1_WhlImbRejCmd_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_WHLIMBREJ_APPL_VAR) WhlImbRej_Per3_WhlImbRejCmd_MtrNm_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_WhlImbRej, RTE_CONST, RTE_CONST) Rte_Inst_Ap_WhlImbRej;
...
#    error "The magic number of the generated file <C:/Synergy/WhlImbRej-zz4r1x/WhlImbRej/utp/contract/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
