...
#include "MemMap.h"
STATIC VAR(float32, AUTOMATIC) CurrSrlComVehSpd_Kph_M_f32;
STATIC VAR(float32, AUTOMATIC) CurrSrlComVehLonAccel_KphpS_M_f32;
...
CurrSrlComVehSpd_Kph_M_f32  = Limit_m(SrlComVehSpd_Kph_T_f32,(CurrSrlComVehSpd_Kph_M_f32 -(k_VehSpdSlewRate_KphpSec_f32*D_2MS_SEC_F32 )), 
							  (CurrSrlComVehSpd_Kph_M_f32 + (k_VehSpdSlewRate_KphpSec_f32*D_2MS_SEC_F32) ));
...
CurrSrlComVehLonAccel_KphpS_M_f32  = Limit_m(SrlComVehLonAccel_KphpS_T_f32,(CurrSrlComVehLonAccel_KphpS_M_f32 -(k_VehAccelSlewRate_KphpSecSq_f32*D_2MS_SEC_F32 )), 
							  (CurrSrlComVehLonAccel_KphpS_M_f32 + (k_VehAccelSlewRate_KphpSecSq_f32*D_2MS_SEC_F32) ));
