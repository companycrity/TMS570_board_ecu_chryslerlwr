...
#    error "The magic number of the generated file <C:/SynergyWorkspace/WorkingProjects/HaLFTO-008.0_NoUTP/HaLFTO/utp/contract/Ap_HaLFTO/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
