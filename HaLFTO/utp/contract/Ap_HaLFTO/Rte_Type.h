...
struct Rte_CDS_Ap_HaLFTO
{
  /* Data Handles section */
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_HALFTO_APPL_VAR) HaLFTO_Per1_DSTState_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_HALFTO_APPL_VAR) HaLFTO_Per1_DiagStsNonRecRmpToZeroFltPres_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_HALFTO_APPL_VAR) HaLFTO_Per1_DiagStsRecRmpToZeroFltPres_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_HALFTO_APPL_VAR) HaLFTO_Per1_HaLFActive_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_HALFTO_APPL_VAR) HaLFTO_Per1_HaLFEnableRqst_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_HALFTO_APPL_VAR) HaLFTO_Per1_HaLFErrInterfaceActive_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_HALFTO_APPL_VAR) HaLFTO_Per1_HaLFExtSystemFltActive_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_HALFTO_APPL_VAR) HaLFTO_Per1_HaLFFuncPresent_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_HALFTO_APPL_VAR) HaLFTO_Per1_HaLFIntSystemFltActive_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_HALFTO_APPL_VAR) HaLFTO_Per1_HaLFSWATrqFail_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_HALFTO_APPL_VAR) HaLFTO_Per1_HaLFSlewComplete_Cnt_lgc;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_HALFTO_APPL_VAR) HaLFTO_Per1_HaLFState_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_HALFTO_APPL_VAR) HaLFTO_Per1_HaLFSuspend_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_HALFTO_APPL_VAR) HaLFTO_Per1_HaLFTrqOvReverseGearEngage_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_HALFTO_APPL_VAR) HaLFTO_Per1_HwTorque_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_HALFTO_APPL_VAR) HaLFTO_Per1_LimitPercentFiltered_Uls_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_HALFTO_APPL_VAR) HaLFTO_Per1_PrevHaLFEnableRqst_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_HALFTO_APPL_VAR) HaLFTO_Per1_PrevHaLFTrqOvCmdRqst_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_HALFTO_APPL_VAR) HaLFTO_Per1_TOEOLDisable_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_HALFTO_APPL_VAR) HaLFTO_Per1_VehicleSpeed_Kph_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_HaLFTO, RTE_CONST, RTE_CONST) Rte_Inst_Ap_HaLFTO;
...
#    error "The magic number of the generated file <C:/SynergyWorkspace/WorkingProjects/HaLFTO-008.0_NoUTP/HaLFTO/utp/contract/Ap_HaLFTO/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
