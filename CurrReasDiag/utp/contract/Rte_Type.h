...
# endif
# if (defined RTE_CONST_NTC_Num_ExVoltage) || (defined NTC_Num_ExVoltage)
#  if (!defined RTE_CONST_NTC_Num_ExVoltage) || (RTE_CONST_NTC_Num_ExVoltage != 176U)
#   error "Enumeration constant <NTC_Num_ExVoltage> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_NTC_Num_ExVoltage (176U)
#  define NTC_Num_ExVoltage (176U)
# endif
...
struct Rte_CDS_Ap_CurrReasDiag
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRREASDIAG_APPL_VAR) CurrReasDiag_Per1_ModIdx_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRREASDIAG_APPL_VAR) CurrReasDiag_Per1_MtrCurrQaxRef_IPM_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRREASDIAG_APPL_VAR) CurrReasDiag_Per1_MtrCurrQaxRef_SPM_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRREASDIAG_APPL_VAR) CurrReasDiag_Per1_MtrCurrQax_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRREASDIAG_APPL_VAR) CurrReasDiag_Per1_Vecu_Volt_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_CurrReasDiag, RTE_CONST, RTE_CONST) Rte_Inst_Ap_CurrReasDiag;
...
#    error "The magic number of the generated file <C:/Documents and Settings/nzx5jd/Desktop/DVOutput/Ap_CurrReasDiag/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
