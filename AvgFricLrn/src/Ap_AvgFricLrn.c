 ...
 * %version:          10 %
 * %derived_by:       qzx0t0 %
 * %date_modified:    Thu Oct 24 15:02:50 2013 %
 *---------------------------------------------------------------------------------------------------------------------
...
#define D_LRNCNSTRTIME_MS_U32        96U /* 12 * 8ms */
...
STATIC VAR(float32, AP_AVGFRICLRN_VAR) RawAvgFric_HwNm_M_f32[D_VEHSPDPTNUM_CNT_U16];
STATIC VAR(float32, AP_AVGFRICLRN_VAR) FiltAvgFric_HwNm_M_f32[D_VEHSPDPTNUM_CNT_U16];
STATIC VAR(float32, AP_AVGFRICLRN_VAR) SatAvgFric_HwNm_M_f32[D_VEHSPDPTNUM_CNT_U16];
STATIC VAR(float32, AP_AVGFRICLRN_VAR) VehBaselineFric_HwNm_M_f32[D_VEHSPDPTNUM_CNT_U16];
STATIC VAR(float32, AP_AVGFRICLRN_VAR) HwAngBuf_HwDeg_M_f32[D_BUFSIZE_CNT_U16];
STATIC VAR(float32, AP_AVGFRICLRN_VAR) HwVelBuf_HwDegpS_M_f32[D_BUFSIZE_CNT_U16];
STATIC VAR(float32, AP_AVGFRICLRN_VAR) ColTrqBuf_HwNm_M_f32[D_PHASESHIFTCNT_CNT_U16];
STATIC VAR(uint32,  AP_AVGFRICLRN_VAR) LearnConstTimer_mS_M_u32;
STATIC VAR(float32, AP_AVGFRICLRN_VAR) EstFric_HwNm_M_f32;
STATIC VAR(float32, AP_AVGFRICLRN_VAR) SatEstFric_HwNm_M_f32;
STATIC VAR(uint32, AP_AVGFRICLRN_VAR) FrictionDiagThreshTimer_mS_M_u32;
#define AVGFRICLRN_STOP_SEC_VAR_CLEARED_32
#include "MemMap.h" /* PRQA S 5087 */

#define AVGFRICLRN_START_SEC_VAR_CLEARED_BOOLEAN
#include "MemMap.h" /* PRQA S 5087 */
STATIC VAR(boolean, AP_AVGFRICLRN_VAR) RunOnce_Cnt_M_lgc;
STATIC VAR(boolean, AP_AVGFRICLRN_VAR) DefeatFricOffsetOutput_Cnt_M_lgc;
#define AVGFRICLRN_STOP_SEC_VAR_CLEARED_BOOLEAN
#include "MemMap.h" /* PRQA S 5087 */

#define AVGFRICLRN_START_SEC_VAR_CLEARED_UNSPECIFIED
#include "MemMap.h" /* PRQA S 5087 */
STATIC VAR(LPF32KSV_Str, AP_AVGFRICLRN_VAR) HwVelKSV_M_str;
STATIC VAR(LPF32KSV_Str, AP_AVGFRICLRN_VAR) LatAccKSV_M_str;
STATIC VAR(LPF32KSV_Str, AP_AVGFRICLRN_VAR) HwPosAuthorityKSV_M_str;
STATIC VAR(LPF32KSV_Str, AP_AVGFRICLRN_VAR) VehSpdKSV_M_str;
STATIC VAR(LPF32KSV_Str, AP_AVGFRICLRN_VAR) TemperatureKSV_M_str;
STATIC VAR(LPF32KSV_Str, AP_AVGFRICLRN_VAR) HwAngKSV_M_str;
STATIC VAR(LPF32KSV_Str, AP_AVGFRICLRN_VAR) ColTrqKSV_M_str;
STATIC VAR(LPF32KSV_Str, AP_AVGFRICLRN_VAR) FiltAvgKSV_M_str[D_VEHSPDPTNUM_CNT_U16];
STATIC VAR(LPF32KSV_Str, AP_AVGFRICLRN_VAR) AvgFricChgKSV_M_str;
STATIC VAR(FricLrnModeType, AP_AVGFRICLRN_VAR) PrevOpMode_Cnt_M_enum;
 ...
 *********************************************************************************************************************/
    ...
    PrevOpMode_Cnt_M_enum = (FricLrnModeType)Rte_Pim_AvgFricLrnData()->OpMode_Cnt_enum;
    
    for( i = 0U; i < D_VEHSPDPTNUM_CNT_U16; i++ )
    {
        VehBaselineFric_HwNm_M_f32[i] = t_BaselineFric_HwNm_f32[i];
        RawAvgFric_HwNm_M_f32[i] = Rte_Pim_AvgFricLrnData()->VehLearnedFric_HwNm_f32[i];
        FiltAvgFric_HwNm_M_f32[i] = Rte_Pim_AvgFricLrnData()->VehLearnedFric_HwNm_f32[i];
        SatAvgFric_HwNm_M_f32[i] = Rte_Pim_AvgFricLrnData()->VehLearnedFric_HwNm_f32[i];
    ...
    LPF_Init_f32_m(Rte_Pim_AvgFricLrnData()->FricOffset_HwNm_f32, k_FricOffsetLPFKn_Hz_f32, D_10MS_SEC_F32, &AvgFricChgKSV_M_str);
    
    
    (void)Rte_Call_SystemTime_GetSystemTime_mS_u32(&LearnConstTimer_mS_M_u32);
    
    LPF_KUpdate_f32_m(k_DataPrepLPFKn_Hz_f32, D_10MS_SEC_F32, &HwVelKSV_M_str);
    LPF_KUpdate_f32_m(k_DataPrepLPFKn_Hz_f32, D_10MS_SEC_F32, &LatAccKSV_M_str);
    LPF_KUpdate_f32_m(k_DataPrepLPFKn_Hz_f32, D_10MS_SEC_F32, &HwPosAuthorityKSV_M_str);
    LPF_KUpdate_f32_m(k_DataPrepLPFKn_Hz_f32, D_10MS_SEC_F32, &VehSpdKSV_M_str);
    LPF_KUpdate_f32_m(k_DataPrepLPFKn_Hz_f32, D_10MS_SEC_F32, &TemperatureKSV_M_str);
    LPF_KUpdate_f32_m(k_DataPrepLPFKn_Hz_f32, D_10MS_SEC_F32, &HwAngKSV_M_str);
    LPF_KUpdate_f32_m(k_DataPrepLPFKn_Hz_f32, D_10MS_SEC_F32, &ColTrqKSV_M_str);
 ...
 *********************************************************************************************************************/
    ...
    RunOnce_Cnt_M_lgc = D_TRUE_CNT_LGC;
        ...
        (OpMode_Cnt_T_enum == FRICLRN_NORMAL) )
    {
        ...
        HwVel_HwDegpS_T_f32 = LPF_OpUpdate_f32_m(HwVelUnfilt_HwDegpS_T_f32, &HwVelKSV_M_str);
        LatAcc_MpSecSqrd_T_f32 = LPF_OpUpdate_f32_m(LatAccUnfilt_MpSecSqrd_T_f32, &LatAccKSV_M_str);
        HwPosAuthority_Uls_T_f32 = LPF_OpUpdate_f32_m(HwPosAuthorityUnfilt_Uls_T_f32, &HwPosAuthorityKSV_M_str);
        VehSpd_Kph_T_f32 = LPF_OpUpdate_f32_m(VehSpdUnfilt_Kph_T_f32, &VehSpdKSV_M_str);
        Temperature_DegC_T_f32 = LPF_OpUpdate_f32_m(TemperatureUnfilt_DegC_T_f32, &TemperatureKSV_M_str);
        HwAng_HwDeg_T_f32 = LPF_OpUpdate_f32_m(HwAngUnfilt_HwDeg_T_f32, &HwAngKSV_M_str);
        ...
        ColTrq_HwNm_T_f32 = LPF_OpUpdate_f32_m(ColTrqUnfilt_HwNm_T_f32, &ColTrqKSV_M_str);
        ...
        SelColTrq_HwNm_T_f32 = ColTrqBuf_HwNm_M_f32[D_PHASESHIFTCNT_CNT_U16 - D_ONE_CNT_U16];
        LoadBuffer(ColTrq_HwNm_T_f32, ColTrqBuf_HwNm_M_f32, D_PHASESHIFTCNT_CNT_U16);
        ...
        (void)Rte_Call_SystemTime_DtrmnElapsedTime_mS_u32(LearnConstTimer_mS_M_u32, &ElapsedTime_mS_T_u32);
        ...
        if( OpMode_Cnt_T_enum == FRICLRN_CALIBRATION )
        {
            ...
            AvgFricChgKSV_M_str.SV_Uls_f32 = D_ZERO_ULS_F32;
            
            for( i = D_ZERO_CNT_U16; i < D_VEHSPDPTNUM_CNT_U16; i++ )
            {
                VehBaselineFric_HwNm_M_f32[i] = SatAvgFric_HwNm_M_f32[i];
            }
        ...
        else if( LearningEnable_Cnt_T_lgc == TRUE )
        {
            ...
            {
                AvgFricChg_HwNm_T_f32 = (SatAvgFric_HwNm_M_f32[VehSpdIndex_Cnt_T_u16] - VehBaselineFric_HwNm_M_f32[VehSpdIndex_Cnt_T_u16]) * t_FricChgWeight_Uls_f32[VehSpdIndex_Cnt_T_u16];
                
                Rte_Pim_AvgFricLrnData()->FricOffset_HwNm_f32 = LPF_OpUpdate_f32_m(AvgFricChg_HwNm_T_f32, &AvgFricChgKSV_M_str);
            }
        }
        else
        {
    ...
    if( (DefeatFricOffsetOutput_Cnt_M_lgc != D_FALSE_CNT_LGC) ||
    ...
    if( (PrevOpMode_Cnt_M_enum != (FricLrnModeType)Rte_Pim_AvgFricLrnData()->OpMode_Cnt_enum) &&
        (RunOnce_Cnt_M_lgc == D_TRUE_CNT_LGC) )
    {
        (void)Rte_Call_AvgFricLrnData_WriteBlock(NULL_PTR);
        Rte_Pim_AvgFricLrnData()->OpMode_Cnt_enum = (uint8)PrevOpMode_Cnt_M_enum;
    }
 ...
 *********************************************************************************************************************/
    ...
    *DefeatOffsetOutput_Cnt_lgc = DefeatFricOffsetOutput_Cnt_M_lgc;
 ...
 *********************************************************************************************************************/
    ...
    RunOnce_Cnt_M_lgc = D_FALSE_CNT_LGC;
 ...
 *********************************************************************************************************************/
    ...
    DefeatFricOffsetOutput_Cnt_M_lgc = DefeatOffsetOutput_Cnt_lgc;
 ...
 *********************************************************************************************************************/
    ...
    (void)Rte_Call_AvgFricLrnData_WriteBlock(NULL_PTR);
    PrevOpMode_Cnt_M_enum = (FricLrnModeType)OpMode_Uls_u08;
 ...
 *********************************************************************************************************************/
    ...
    for( i = 0U; i < D_VEHSPDPTNUM_CNT_U16; i++ )
    {
        Rte_Pim_AvgFricLrnData()->VehLearnedFric_HwNm_f32[i] = 
            Limit_m(SatAvgFric_HwNm_M_f32[i],
                                                                        ...
                                                                        P2VAR(float32, AUTOMATIC, AUTOMATIC) SelHwAng_HwDeg_T_f32)
{
    ...
    {
        if( (HwAngBuf_HwDeg_M_f32[i] > t_FrHystHwAPts_HwDeg_f32[D_HWPTNUMSUB1_CNT_U16]) ||
            (HwAngBuf_HwDeg_M_f32[i] < t_FrHystHwAPts_HwDeg_f32[0]) )
        {
    ...
    *SelHwAng_HwDeg_T_f32 = HwAngBuf_HwDeg_M_f32[D_PHASESHIFTCNT_CNT_U16 - 1U];
    
    LoadBuffer(HwAng_HwDeg_T_f32, HwAngBuf_HwDeg_M_f32, D_BUFSIZE_CNT_U16);
}
                                                                        ...
                                                                        P2VAR(uint16, AUTOMATIC, AUTOMATIC) Direction_Cnt_T_u16)
{
    ...
    HwVelMin_HwDegpS_T_f32 = HwVelBuf_HwDegpS_M_f32[0];
    HwVelMax_HwDegpS_T_f32 = HwVelBuf_HwDegpS_M_f32[0];
    ...
    {
        HwVelMin_HwDegpS_T_f32 = Min_m(HwVelMin_HwDegpS_T_f32, HwVelBuf_HwDegpS_M_f32[i]);
        HwVelMax_HwDegpS_T_f32 = Max_m(HwVelMax_HwDegpS_T_f32, HwVelBuf_HwDegpS_M_f32[i]);
        HwVelSum_HwDegpS_T_f32 += HwVelBuf_HwDegpS_M_f32[i];
        
        if( HwVelBuf_HwDegpS_M_f32[i] > D_ZERO_ULS_F32 )
        {
    ...
    LoadBuffer(HwVel_HwDegpS_T_f32, HwVelBuf_HwDegpS_M_f32, D_BUFSIZE_CNT_U16);
}
                                                                    ...
                                                                    VAR(uint16,  AUTOMATIC) Direction_Cnt_T_u16)
{
    ...
    /* Gate */
    for(  Gate_Cnt_T_u16 = D_ZERO_CNT_U16;
          ( (Gate_Cnt_T_u16 < D_HWPTNUMSUB1_CNT_U16) &&
    ...
    if( TotalCounter_Cnt_T_u32 >= k_LearningThreshold_Cnt_u32 )
    {
        ...
        for( i = D_ZERO_CNT_U16; i < D_HWPTNUMSUB1_CNT_U16; i++ )
        {
            RawAvg_HwNm_T_f32 +=  ( (Rte_Pim_AvgFricLrnData()->Theta_HwNm_f32[IndexOffsetInc_Cnt_T_u16][i] - Rte_Pim_AvgFricLrnData()->Theta_HwNm_f32[IndexOffsetDec_Cnt_T_u16][i]) + 
                                  ...
                                  ( ((float32)(Rte_Pim_AvgFricLrnData()->RangeCounter_Cnt_u16[IndexOffsetInc_Cnt_T_u16][i] + Rte_Pim_AvgFricLrnData()->RangeCounter_Cnt_u16[IndexOffsetDec_Cnt_T_u16][i])) /
                                    ((float32)TotalCounter_Cnt_T_u32) );
        }
        RawAvg_HwNm_T_f32 *= D_QUARTER_CNT_f32;
        
        RawAvgFric_HwNm_M_f32[VehSpdIndex_Cnt_T_u16] = RawAvg_HwNm_T_f32;
        
        FiltAvgFric_HwNm_M_f32[VehSpdIndex_Cnt_T_u16] = LPF_OpUpdate_f32_m(RawAvg_HwNm_T_f32, &FiltAvgKSV_M_str[VehSpdIndex_Cnt_T_u16]);
        
        SatAvgFric_HwNm_M_f32[VehSpdIndex_Cnt_T_u16] = Limit_m( FiltAvgFric_HwNm_M_f32[VehSpdIndex_Cnt_T_u16],
                                                                Rte_Pim_AvgFricLrnData()->VehLearnedFric_HwNm_f32[VehSpdIndex_Cnt_T_u16] - k_SatFricChgLim_HwNm_f32,
                                                                Rte_Pim_AvgFricLrnData()->VehLearnedFric_HwNm_f32[VehSpdIndex_Cnt_T_u16] + k_SatFricChgLim_HwNm_f32);
        
        EstFric_HwNm_M_f32 = RawAvg_HwNm_T_f32;
        SatEstFric_HwNm_M_f32 = SatAvgFric_HwNm_M_f32[VehSpdIndex_Cnt_T_u16];
    }
	
	for(i=0U; i < D_VEHSPDPTNUM_CNT_U16; i++)
	{
		if(RawAvgFric_HwNm_M_f32[i] > MaxRawAvgFric_HwNm_T_f32)
		{
			MaxRawAvgFric_HwNm_T_f32 = RawAvgFric_HwNm_M_f32[i];
		}
	}
	
	if((Abs_f32_m(MaxRawAvgFric_HwNm_T_f32)) >= k_FrictionDiagThreshold_HwNm_f32)
	{
		(void)Rte_Call_SystemTime_DtrmnElapsedTime_mS_u32(FrictionDiagThreshTimer_mS_M_u32, &ElapsedTime_mS_T_u32);
	...
	{
		(void)Rte_Call_SystemTime_GetSystemTime_mS_u32(&FrictionDiagThreshTimer_mS_M_u32);
...
STATIC INLINE FUNC(void, RTE_AP_AVGFRICLRN_APPL_CODE) BaselineMode( void )
{
    ...
    for( i = D_ZERO_CNT_U16; i < D_VEHSPDPTNUM_CNT_U16; i++ )
    {
        ...
        RawAvgFric_HwNm_M_f32[i]       = t_BaselineFric_HwNm_f32[i] + EOLFricDiff_HwNm_T_f32;
        FiltAvgFric_HwNm_M_f32[i]      = t_BaselineFric_HwNm_f32[i] + EOLFricDiff_HwNm_T_f32;
        SatAvgFric_HwNm_M_f32[i]       = t_BaselineFric_HwNm_f32[i] + EOLFricDiff_HwNm_T_f32;
        FiltAvgKSV_M_str[i].SV_Uls_f32 = t_BaselineFric_HwNm_f32[i] + EOLFricDiff_HwNm_T_f32;
    }
...
STATIC INLINE FUNC(void, RTE_AP_AVGFRICLRN_APPL_CODE) ClearMode( void )
{
    ...
    for( i = D_ZERO_CNT_U16; i < D_VEHSPDPTNUM_CNT_U16; i++ )
    {
        VehBaselineFric_HwNm_M_f32[i] = D_ZERO_ULS_F32;
        Rte_Pim_AvgFricLrnData()->VehLearnedFric_HwNm_f32[i] = D_ZERO_ULS_F32;
        RawAvgFric_HwNm_M_f32[i] = D_ZERO_ULS_F32;
        FiltAvgFric_HwNm_M_f32[i] = D_ZERO_ULS_F32;
        SatAvgFric_HwNm_M_f32[i] = D_ZERO_ULS_F32;
        FiltAvgKSV_M_str[i].SV_Uls_f32 = D_ZERO_ULS_F32;
    }
