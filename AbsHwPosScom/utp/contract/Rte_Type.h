...
struct Rte_CDS_Ap_AbsHwPosScom
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOSSCOM_APPL_VAR) AbsHwPosScom_Per1_CRFCumMtrPos_Deg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOSSCOM_APPL_VAR) AbsHwPosScom_Per1_CRFMtrTrqCmd_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOSSCOM_APPL_VAR) AbsHwPosScom_Per1_CRFMtrVel_MtrRadpS_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_ABSHWPOSSCOM_APPL_VAR) AbsHwPosScom_Per1_DiagStsHwPosDis_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOSSCOM_APPL_VAR) AbsHwPosScom_Per1_HwPosAuthority_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOSSCOM_APPL_VAR) AbsHwPosScom_Per1_HwPos_HwDeg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOSSCOM_APPL_VAR) AbsHwPosScom_Per1_HwTrq_HwNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_ABSHWPOSSCOM_APPL_VAR) AbsHwPosScom_Per1_SComInpHwAValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOSSCOM_APPL_VAR) AbsHwPosScom_Per1_SComInpHwA_HwDeg_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_ABSHWPOSSCOM_APPL_VAR) AbsHwPosScom_Per1_VehicleSpeedValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOSSCOM_APPL_VAR) AbsHwPosScom_Per1_VehicleSpeed_Kph_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_ABSHWPOSSCOM_APPL_VAR) AbsHwPosScom_Per2_KinIntDiagSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOSSCOM_APPL_VAR) AbsHwPosScom_Per3_CRFMtrTrqCmd_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ABSHWPOSSCOM_APPL_VAR) AbsHwPosScom_Per3_HwTrq_HwNm_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_AbsHwPosScom, RTE_CONST, RTE_CONST) Rte_Inst_Ap_AbsHwPosScom;
...
#    error "The magic number of the generated file <C:/Synergy/AbsHwPosScom-zz4r1x/AbsHwPosScom/utp/contract/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
