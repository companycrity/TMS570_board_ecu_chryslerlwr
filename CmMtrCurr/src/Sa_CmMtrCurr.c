 ...
 * %version:          18 %
 * %date_modified:    Thu Jan 23 11:28:51 2014 %
 *---------------------------------------------------------------------------------------------------------------------
 ...
 * 23/01/14   18      LK		Updated variables and constants names to meet naming convention					11063 and 10909
 */
/**********************************************************************************************************************
...
#define D_SCALE_VOLTSPERCOUNT_U3P29		(FPM_InitFixedPoint_m((D_ADCREF_VOLT_F32/(float32)D_ADCFULLSCALE_CNT_U16), u3p29_T))
...
#define D_MTRCURROFFLOCOMOFF_CNT_U16	500U
#define D_CURROFFNOOFAVG_CNT_U16		64U
#define D_MTRCURROFFZEROCOMOFF_CNT_U16	0U
#define D_MODIDENGONDEFEAT_CNT_B32		769U
...
STATIC volatile VAR(float32, SA_MTRCURR_VAR_NOINIT) CmMtrCurr_CorrMtrPosElec_Rev_D_f32;
STATIC volatile VAR(float32, SA_MTRCURR_VAR_NOINIT) CmMtrCurr_MtrCurrK1_Amp_D_f32;
STATIC volatile VAR(float32, SA_MTRCURR_VAR_NOINIT) CmMtrCurr_MtrCurrK2_Amp_D_f32;
...
STATIC volatile VAR(float32, SA_MTRCURR_VAR_NOINIT) CmMtrCurr_MtrCurr1OffsetDiff_Volt_D_f32;
STATIC volatile VAR(float32, SA_MTRCURR_VAR_NOINIT) CmMtrCurr_MtrCurr2OffsetDiff_Volt_D_f32;
STATIC volatile VAR(float32, SA_MTRCURR_VAR_NOINIT) CmMtrCurr_Duty1Cnts_Cnt_D_f32;
STATIC volatile VAR(float32, SA_MTRCURR_VAR_NOINIT) CmMtrCurr_Duty2Cnts_Cnt_D_f32;
STATIC volatile VAR(float32, SA_MTRCURR_VAR_NOINIT) CmMtrCurr_PosDelayCorrMtrPosElec_Rev_D_f32; /*Not Used*/
...
#include "MemMap.h" /* PRQA S 5087 */
/*Display variables*/
STATIC volatile VAR(uint16, SA_MTRCURR_VAR_NOINIT) CmMtrCurr_AdcMtrCurr1_Cnts_D_u16;
STATIC volatile VAR(uint16, SA_MTRCURR_VAR_NOINIT) CmMtrCurr_AdcMtrCurr2_Cnts_D_u16;
STATIC volatile VAR(uint16, SA_MTRCURR_VAR_NOINIT) CmMtrCurr_AdcMtrCurr1_Volt_D_u16;
/*Module level variables*/
			...
			(VhSpdValid_Cnt_T_lgc == TRUE) )
		{
			switch(CmMtrCurr_CurrOffState_Uls_M_enum)
			{
				case CURROFF_HIAVERAGE:
					...
					if(CmMtrCurr_CurrOffAvgCounter_Cnt_M_u16 == D_CURROFFNOOFAVG_CNT_U16)
					{
						CmMtrCurr_MtrCurr1OffsetHi_Volt_M_f32 = CmMtrCurr_MtrCurr1SumHi_Volt_M_f32 / ((float32)D_CURROFFNOOFAVG_CNT_U16);
						CmMtrCurr_MtrCurr2OffsetHi_Volt_M_f32 = CmMtrCurr_MtrCurr2SumHi_Volt_M_f32 / ((float32)D_CURROFFNOOFAVG_CNT_U16);
						AverageVecu_Volts_T_f32 = CmMtrCurr_VecuSum_Volt_M_f32 / ((float32)D_CURROFFNOOFAVG_CNT_U16);
						CmMtrCurr_MtrCurrValCmd_VoltCnt_M_f32 = ((float32)(AverageVecu_Volts_T_f32 * ((float32)(D_MTRCURROFFHICOMOFF_CNT_U16 - D_MTRCURROFFLOCOMOFF_CNT_U16))));
						CmMtrCurr_CurrOffAvgCounter_Cnt_M_u16 = 0u;
						ComOffset_Cnt_T_u16 = D_MTRCURROFFLOCOMOFF_CNT_U16;
				...
				case CURROFF_LOAVERAGE:
					...
					if(CmMtrCurr_CurrOffAvgCounter_Cnt_M_u16 == D_CURROFFNOOFAVG_CNT_U16)
					{
						CmMtrCurr_MtrCurr1OffsetLo_Volt_M_f32 = CmMtrCurr_MtrCurr1SumLo_Volt_M_f32 / ((float32)D_CURROFFNOOFAVG_CNT_U16);
						CmMtrCurr_MtrCurr2OffsetLo_Volt_M_f32 = CmMtrCurr_MtrCurr2SumLo_Volt_M_f32 / ((float32)D_CURROFFNOOFAVG_CNT_U16);
				...
				case CURROFF_ZEROAVERAGE:
					...
					if(CmMtrCurr_CurrOffAvgCounter_Cnt_M_u16 == D_CURROFFNOOFAVG_CNT_U16)
					{
						CmMtrCurr_MtrCurr1OffsetZero_Volt_M_f32 = CmMtrCurr_MtrCurr1SumZero_Volt_M_f32 / ((float32)D_CURROFFNOOFAVG_CNT_U16);
						CmMtrCurr_MtrCurr2OffsetZero_Volt_M_f32 = CmMtrCurr_MtrCurr2SumZero_Volt_M_f32 / ((float32)D_CURROFFNOOFAVG_CNT_U16);
				...
				case CURROFF_CALC:
						...
						(CmMtrCurr_MtrCurr2OffsetHi_Volt_M_f32 <= k_MtrCurrEOLMaxOffset_Volts_f32) )
					{
						...
						CmMtrCurr_MtrCurr1OffsetDiff_Volt_D_f32 = MtrCurr1offsetDiff_Volt_T_f32;
						CmMtrCurr_MtrCurr2OffsetDiff_Volt_D_f32 = MtrCurr2offsetDiff_Volt_T_f32;
...
FUNC(void, SA_CMMTRCURR_CODE) CurrDQPer1(void)
{
	...
	VAR(uint16,  AUTOMATIC) Phs1Curr_Volts_T_u3p13;
	VAR(uint16,  AUTOMATIC) Phs2Curr_Volts_T_u3p13;
	...
	Phs1Curr_Volts_T_u3p13 = (uint16)((((uint32)Phs1Curr_Cnt_T_u16) * D_SCALE_VOLTSPERCOUNT_U3P29) >> D_CNVRTP29TOP13_CNT_U16);
	Phs2Curr_Volts_T_u3p13 = (uint16)((((uint32)Phs2Curr_Cnt_T_u16) * D_SCALE_VOLTSPERCOUNT_U3P29) >> D_CNVRTP29TOP13_CNT_U16);
	Phs1Curr_Volts_T_f32 = FPM_FixedToFloat_m(Phs1Curr_Volts_T_u3p13, u3p13_T);
	Phs2Curr_Volts_T_f32 = FPM_FixedToFloat_m(Phs2Curr_Volts_T_u3p13, u3p13_T);
	Duty1Cnts_Cnt_T_f32 = FPM_FixedToFloat_m((((sint16)DCPhs1Comp_Cnt_T_u16) - ((sint16)D_MTRCURROFFLOCOMOFF_CNT_U16)), s15p0_T);
	Duty2Cnts_Cnt_T_f32 = FPM_FixedToFloat_m((((sint16)DCPhs2Comp_Cnt_T_u16) - ((sint16)D_MTRCURROFFLOCOMOFF_CNT_U16)), s15p0_T);
	
	
	CmMtrCurr_Duty1Cnts_Cnt_D_f32 = Duty1Cnts_Cnt_T_f32;
	CmMtrCurr_Duty2Cnts_Cnt_D_f32 = Duty2Cnts_Cnt_T_f32;
	...
	CmMtrCurr_AdcMtrCurr1_Cnts_D_u16 = Phs1Curr_Cnt_T_u16;
	CmMtrCurr_AdcMtrCurr2_Cnts_D_u16 = Phs2Curr_Cnt_T_u16;
	...
	CmMtrCurr_CorrMtrPosElec_Rev_D_f32 = CorrMtrPosElec_Rev_T_f32;
	...
	CmMtrCurr_MtrCurrK1_Amp_D_f32 = MtrCurrK1_Amps_T_f32;
	CmMtrCurr_MtrCurrK2_Amp_D_f32 = MtrCurrK2_Amps_T_f32;
