 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Ap_BVDiag.c
 *     Workspace:  C:/Synergy_projects/BVDiag-lz4p8n/BVDiag/autosar/Ap_BVDiag.dcf
 *     SW-C Type:  Ap_BVDiag
 *  Generated at:  Mon Mar 18 14:28:34 2013
 *
 ...
 * %version:           4 %
 * %derived_by:       rz3h1n %
 * %date_modified:    Mon Oct  7 11:18:57 2013 %
 *---------------------------------------------------------------------------------------------------------------------
 ...
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType (void) Rte_Call_SystemTime_DtrmnElapsedTime_mS_u16(UInt32 InitialTime, UInt16 *ElapsedTime)
 *     Synchronous Service Invocation. Timeout: None
 *   Std_ReturnType (void) Rte_Call_SystemTime_GetSystemTime_mS_u32(UInt32 *CurrentTime)
 *     Synchronous Service Invocation. Timeout: None
 *
 *********************************************************************************************************************/
