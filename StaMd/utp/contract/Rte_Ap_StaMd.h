...
extern VAR(Rte_tsTask_2msB_10, RTE_VAR_NOINIT) Rte_Task_2msB_10;
...
#  define Rte_IRead_StaMd_Per1_ATerm_Cnt_lgc() \
  (Rte_Task_2msB_10.Rte_RB.Rte_Ap_StaMd_StaMd_Per1.Rte_ATerm_Cnt_lgc.value)

#  define Rte_IRead_StaMd_Per1_CTerm_Cnt_lgc() \
  (Rte_Task_2msB_10.Rte_RB.Rte_Ap_StaMd_StaMd_Per1.Rte_CTerm_Cnt_lgc.value)

#  define Rte_IRead_StaMd_Per1_ControlledDampStatusComplete_Cnt_lgc() \
  (Rte_Task_2msB_10.Rte_RB.Rte_Ap_StaMd_StaMd_Per1.Rte_ControlledDampStatusComplete_Cnt_lgc.value)

#  define Rte_IRead_StaMd_Per1_FTerm_Cnt_lgc() \
  (Rte_Task_2msB_10.Rte_RB.Rte_Ap_StaMd_StaMd_Per1.Rte_FTerm_Cnt_lgc.value)

#  define Rte_IRead_StaMd_Per1_RampStatusComplete_Cnt_lgc() \
  (Rte_Task_2msB_10.Rte_RB.Rte_Ap_StaMd_StaMd_Per1.Rte_RampStatusComplete_Cnt_lgc.value)

#  define Rte_IRead_StaMd_Per1_TMFTestComplete_Cnt_lgc() \
  (Rte_Task_2msB_10.Rte_RB.Rte_Ap_StaMd_StaMd_Per1.Rte_TMFTestComplete_Cnt_lgc.value)
...
#  define Rte_Call_CloseCheckData_GetErrorStatus(arg1) (NvM_GetErrorStatus((NvM_BlockIdType)42, arg1), ((Std_ReturnType)RTE_E_OK))
#  define RTE_START_SEC_NVM_APPL_CODE
#  include "MemMap.h"
...
#  define Rte_Call_CloseCheckData_WriteBlock(arg1) (NvM_WriteBlock((NvM_BlockIdType)42, arg1))
...
#  define Rte_Call_StaMd_Per1_CP0_CheckpointReached() (WdgM_CheckpointReached((WdgM_SupervisedEntityIdType)1, (WdgM_CheckpointIdType)1))
...
#  define Rte_Call_TypeHData_WriteBlock(arg1) (NvM_WriteBlock((NvM_BlockIdType)15, arg1))
...
#    error "The magic number of the generated file <C:/CMSynergy_Projects/K2xx_Prod/GM_K2XX_EPS_TMS570/SwProject/Source/GenDataRte/Production/Components/Rte_Ap_StaMd.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
