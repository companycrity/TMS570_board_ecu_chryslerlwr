 ...
 * %version:          21 %
 * %derived_by:       lz4p8n %
 * %date_modified:    Mon Jun 17 16:44:35 2013 %
 *---------------------------------------------------------------------------------------------------------------------
 ...
 *********************************************************************************************************************/
	...
	else
	{
		...
		DampFWSatDamp_MtrNm_T_f32 = Limit_m(DampLimited_MtrNm_T_f32, LwrBoundRaw_MtrNm_T_f32, UprBoundRaw_MtrNm_T_f32);
		...
		if((DampLimited_MtrNm_T_f32 > UprBoundRaw_MtrNm_T_f32 ) || (DampLimited_MtrNm_T_f32 < LwrBoundRaw_MtrNm_T_f32))
		{
		...
		else if( DampPNAcc_Cnt_M_u16 > t_DampFWDampInrtCmpPNThesh_Cnt_u16[0] )
		{
			/* do nothing */
		}
		else
