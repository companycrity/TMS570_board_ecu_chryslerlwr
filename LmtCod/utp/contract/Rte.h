...
#    error "The magic number of the generated file <C:/cmsynergy/CBD_LmtCod_SF38/LmtCod-wz7x3j/LmtCod/utp/contract/Ap_LmtCod/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
