...
struct Rte_CDS_Ap_PAwTO
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Init1_HwTorque_HwNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per1_DiagStsNonRecRmpToZeroFltPres_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per1_DiagStsRecRmpToZeroFltPres_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per1_HandsOnDetect_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per1_HwTorque_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per1_LimitPercentFiltered_Uls_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per1_PABoostCurveSwitch_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per1_PAEnableRqst_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per1_PAErrInterfaceActive_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per1_PAExtSystemFltActive_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per1_PAIntSystemFltActive_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per1_PAWheelCriteriaMet_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per1_PrkAssistActive_Cnt_lgc;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per1_PrkAssistState_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per1_PrkAssistSuspend_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per1_PrkAsstFuncPresent_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per1_PrkAsstSlewComplete_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per1_TOEOLDisable_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per1_TrqOvReverseGearEngage_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per2_IWSSCalcVspd_Kph_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per2_PAEnableRqst_Cnt_lgc;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per2_PAManoeuvrePhase_Cnt_u08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per2_PATrqOvCmdRqst_HwNm_f32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per2_PAWhlDirRLStat_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per2_PAWhlDirRRStat_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per2_PAWhlPlsCntRLValid_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per2_PAWhlPlsCntRRValid_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per2_PrkAsstFuncPresent_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per2_TrqOvReverseGearEngage_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PAWTO_APPL_VAR) PAwTO_Per2_VehicleSpeed_Kph_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_PAwTO, RTE_CONST, RTE_CONST) Rte_Inst_Ap_PAwTO;
...
#    error "The magic number of the generated file <C:/CMSynergy/Ap_PAwTO/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
