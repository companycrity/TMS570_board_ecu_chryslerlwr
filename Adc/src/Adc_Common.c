...
* %version:          2 %
* %derived_by:       nzt9hv %
* %date_modified:    Mon Apr 29 09:29:25 2013 %
*---------------------------------------------------------------------------*/
#include "Std_Types.h"
 ...
 **********************************************************************************************************************/
#define D_NUMOFADCCALREADS_CNT_U8		8U
...
*****************************************************************************/
FUNC(uint8, ADC_CODE) ADCOffsetCalibration( adcctrlregs_t *adcREG )
{
	...
	if(ConvTimeOut_Cnt_T_lgc == D_FALSE_CNT_LGC)
	{
		...
		if(ConvTimeOut_Cnt_T_lgc == D_FALSE_CNT_LGC)
		{
			...
			adcREG->CALR = (uint32)((sint32)0x07FF - (sint32)(ReadResults_Cnt_T_u32/(sint32)(D_NUMOFADCCALREADS_CNT_U8 * 2)));
		}
	}
