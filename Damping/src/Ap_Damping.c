 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Ap_Damping.c
 *     Workspace:  C:/Documents and Settings/nzt9hv/My Documents/Synergy/ccm_wa/ESG_Dev_65/Damping-nzt9hv1/Damping/autosar
 *     SW-C Type:  Ap_Damping
 *  Generated at:  Thu Feb 21 10:52:27 2013
 *
 ...
 * %version:          16 %
 * %derived_by:       kzdyfh %
 * %date_modified:    Thu Apr 25 13:41:56 2013 %
 *---------------------------------------------------------------------------------------------------------------------
 ...
 *********************************************************************************************************************/
	...
	DampingCmd_MtrNm_T_f32 = Limit_m(DampingCmd_MtrNm_T_f32, D_DAMPINGCMDMIN_MTRNM_F32, D_DAMPINGCMDMAX_MTRNM_F32);
													    ...
													    )
{
	...
	VAR(float32, AUTOMATIC) MotorVelCRFFilt_MtrRadpS_T_f32;
	...
	MotorVelCRFFilt_MtrRadpS_T_f32 = LPF_OpUpdate_f32_m(MotorVelCRF_MtrRadpS_T_f32, &MtrVelLPFKSV_Cnt_M_str);

	AbsMotorVelCRFFilt_MtrRadpS_T_u12p4 = FPM_FloatToFixed_m(Abs_f32_m(MotorVelCRFFilt_MtrRadpS_T_f32), u12p4_T);
	...
	MtrVelDampingCmd_MtrNm_T_f32 = FPM_FixedToFloat_m(HwVelDepDmp_MtrNm_T_u5p11, u5p11_T) * ((float32)Sign_f32_m(MotorVelCRFFilt_MtrRadpS_T_f32));
	DampMtrVelDmp_MtrNm_D_f32 = MtrVelDampingCmd_MtrNm_T_f32;    /* Display variable */


	/* Handwheel Torque Dependent Multiplier */

	HwTrq_HwNm_T_s7p8 = FPM_FloatToFixed_m(HwTorque_HwNm_T_f32, s7p8_T);
