/*****************************************************************************
* Copyright 2009 Nexteer Automotive, Inc., All Rights Reserved.
...
#include "sys_pmu.h" /* Required to use */

/************ Metric Module Exclusive Area Protection *****************/
/* Task Start */
#define METRICS_ENTER_EXCLUSIVEAREA0	DisableAllInterrupts() /* area not configured because the resulting cpu usage was too high to collect metrics */
...
/* Runnable Start */
#define METRICS_ENTER_EXCLUSIVEAREA3	DisableAllInterrupts()
#define METRICS_EXIT_EXCLUSIVEAREA3		ResumeAllInterrupts()
/* Runnable End */
#define METRICS_ENTER_EXCLUSIVEAREA4	DisableAllInterrupts()
