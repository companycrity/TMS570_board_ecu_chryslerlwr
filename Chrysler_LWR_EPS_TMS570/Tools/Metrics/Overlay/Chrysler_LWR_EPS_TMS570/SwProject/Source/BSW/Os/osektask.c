...
#error "This version of osektask.c is not intended for a production build. Please replace with the official versoin from Vector."
#endif
...
/* TR:SOSK22:0088 Start */
   ...
   Metrics_TaskEnd(osaActiveTaskIndex);
