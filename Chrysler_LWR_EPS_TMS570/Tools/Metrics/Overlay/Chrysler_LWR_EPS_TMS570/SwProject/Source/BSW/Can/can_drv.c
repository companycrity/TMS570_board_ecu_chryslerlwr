...
#if( DRVCAN_TMS470DCANHLL_RELEASE_VERSION != 0x01)
 #error "Source and Header file are inconsistent!"
#endif
...
{
  Metrics_TaskStart(D_COMIRQ1_CNT_U08);
...
#   endif
  ...
  Metrics_TaskEnd(D_COMIRQ1_CNT_U08);
} /* END OF CanISR */
...
#  endif /* C_ENABLE_OSEK_OS */
{
  Metrics_TaskStart(D_COMIRQ2_CNT_U08);
...
#   endif
  ...
  Metrics_TaskEnd(D_COMIRQ2_CNT_U08);
} /* END OF CanISR */
...
#  endif /* C_ENABLE_OSEK_OS */
{
  Metrics_TaskStart(D_COMIRQ3_CNT_U08);
...
#   endif
  ...
  Metrics_TaskEnd(D_COMIRQ3_CNT_U08);
} /* END OF CanISR */
