 ...
 *
 *  Description: Header of BSW Scheduler for Memory Interface
 *
 ******************************************************************************
 *               C O P Y R I G H T
 ******************************************************************************
...
extern const uint8 MEMIF_EXCLUSIVE_AREA_0;

#if defined( __SCHM__ )

const uint8 MEMIF_EXCLUSIVE_AREA_0 = SCHM_EA_SUSPENDALLINTERRUPTS;

Std_ReturnType SchM_ActMainFunction_MemIf(uint8 activation)
{
   return SCHM_E_OK;
}
Std_ReturnType SchM_CancelMainFunction_MemIf(uint8 activation)
{
   return SCHM_E_OK;
}
void SchM_Enter_MemIf(uint8 ExclusiveArea)
{
   SCHM_ENTER_EXCLUSIVE(ExclusiveArea);
}

void SchM_Exit_MemIf(uint8 ExclusiveArea)
{
