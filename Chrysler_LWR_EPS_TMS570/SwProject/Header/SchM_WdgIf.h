 ...
 *
 *  Description: Header of BSW Scheduler for Watchdog Interface
 *
 ******************************************************************************
 *               C O P Y R I G H T
 ******************************************************************************
...
extern const uint8 WDGIF_EXCLUSIVE_AREA_0;

#if defined( __SCHM__ )

const uint8 WDGIF_EXCLUSIVE_AREA_0 = SCHM_EA_SUSPENDALLINTERRUPTS;

Std_ReturnType SchM_ActMainFunction_WdgIf(uint8 activation)
{
   return SCHM_E_OK;
}
Std_ReturnType SchM_CancelMainFunction_WdgIf(uint8 activation)
{
   return SCHM_E_OK;
}
void SchM_Enter_WdgIf(uint8 ExclusiveArea)
{
   SCHM_ENTER_EXCLUSIVE(ExclusiveArea);
}

void SchM_Exit_WdgIf(uint8 ExclusiveArea)
{
