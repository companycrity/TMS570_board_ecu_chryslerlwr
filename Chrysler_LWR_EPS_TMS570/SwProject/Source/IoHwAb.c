 ...
 * 01/18/14	 10		  SAH		Changed vim.h to vim_regs.h
 */
/**********************************************************************************************************************
...
)
{
    ...
    ******************************************************************************************************************/
    ...
    if (TRUE == signal)
    {
		Port_SetPinDirection(FetFlt2_Clk, PORT_PIN_OUT);
    }
	else
	{
		Port_SetPinDirection(FetFlt2_Clk, PORT_PIN_IN);
	}
