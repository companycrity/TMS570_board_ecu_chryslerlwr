...
#define TP_ISO15765_VERSION           0x0307
...
# define TP_USE_WITHOUT_FC_TPCI_ADDON         kTpOn
# else
...
#  if defined (C_MULTIPLE_RECEIVE_CHANNEL)         || \
      defined (C_SINGLE_RECEIVE_CHANNEL)           
extern canuint8 TP_INTERNAL_CALL_TYPE TpPrecopy(vuint8 addrInfoHandle, CanRxInfoStructPtr rxStruct);
#  else
#   if defined (C_MULTIPLE_RECEIVE_BUFFER)
extern canuint8 TP_INTERNAL_CALL_TYPE TpPrecopy(vuint8 addrInfoHandle, CanChipDataPtr rxDataPtr);
#   endif
#   if defined (C_SINGLE_RECEIVE_BUFFER)
extern canuint8 TP_INTERNAL_CALL_TYPE TpPrecopy(vuint8 addrInfoHandle, CanReceiveHandle rxObject);
#   endif
#  endif
#  if defined TP_FUNC_ENABLE_RECEPTION
#   if ( defined (C_MULTIPLE_RECEIVE_CHANNEL) ||\
         defined (C_SINGLE_RECEIVE_CHANNEL) )
extern canuint8 TP_INTERNAL_CALL_TYPE TpFuncPrecopy(vuint8 addrInfoHandle, CanRxInfoStructPtr rxStruct);
#   else
#    if defined ( C_MULTIPLE_RECEIVE_BUFFER )
extern canuint8 TP_INTERNAL_CALL_TYPE TpFuncPrecopy(vuint8 addrInfoHandle, CanChipDataPtr rxDataPtr);
#    endif
#    if defined ( C_SINGLE_RECEIVE_BUFFER )
extern canuint8 TP_INTERNAL_CALL_TYPE TpFuncPrecopy(vuint8 addrInfoHandle, CanReceiveHandle rxObject);
#    endif
#   endif
#  endif
#else
...
#if defined(TP_ENABLE_PRE_DISPATCHED_MODE)
# define TpGetConnectionGroup(addrinfo)    (kTpAddressInfo[addrinfo].connectionGroup)
# if (kTpNumberOfCanChannels > 1)
#  define TpGetCanChannel(addrinfo)        (kTpAddressInfo[addrinfo].canChannel)
# else
#  define TpGetCanChannel(addrinfo)        0
# endif
# if (TP_USE_NORMAL_ADDRESSING == kTpOn) || (TP_USE_MIXED_11_ADDRESSING == kTpOn)
#  define TpGetRxId(addrinfo)              (kTpNormalAddressInfo[addrinfo-kTpNormalAddrInfoOffset].rxHandle)
#  define TpGetTxId(addrinfo)              (kTpNormalAddressInfo[addrinfo-kTpNormalAddrInfoOffset].txHandle)
# endif
# if (TP_USE_EXTENDED_ADDRESSING == kTpOn)
#  define TpGetBaseAddress(addrinfo)       (kTpExtendedAddressInfo[addrinfo-kTpExtendedAddrInfoOffset].baseAddress)
#  define TpGetAddressOffset(addrinfo)     (kTpExtendedAddressInfo[addrinfo-kTpExtendedAddrInfoOffset].addressOffset)
# endif
# if (TP_USE_NORMAL_FIXED_ADDRESSING == kTpOn) || (TP_USE_MIXED_29_ADDRESSING == kTpOn)
#  define TpGetPriority(addrinfo)          (kTpFixedAddressInfo[addrinfo-kTpFixedAddrInfoOffset].priority)
#  define TpGetPGN(addrinfo)               (kTpFixedAddressInfo[addrinfo-kTpFixedAddrInfoOffset].baseAddress)
#  define TpGetEcuNumber(addrinfo)         (kTpFixedAddressInfo[addrinfo-kTpFixedAddrInfoOffset].ecuNr)
# endif
# if (TP_USE_NORMAL_ADDRESSING == kTpOn)
extern canuint8 TP_API_CALL_TYPE TpTransmitNormal(canuint8 addrInfoHandle, TP_MEMORY_MODEL_DATA canuint8 *ptrData, canuint16 count);
# endif
# if (TP_USE_EXTENDED_ADDRESSING == kTpOn)
extern canuint8 TP_API_CALL_TYPE TpTransmitExtended(canuint8 addrInfoHandle, canuint8 target_address, TP_MEMORY_MODEL_DATA canuint8 *ptrData, canuint16 count);
# endif
# if (TP_USE_NORMAL_FIXED_ADDRESSING == kTpOn)
extern canuint8 TP_API_CALL_TYPE TpTransmitNormalFixed(canuint8 addrInfoHandle, canuint8 target_address, TP_MEMORY_MODEL_DATA canuint8 *ptrData, canuint16 count);
# endif
# if (TP_USE_MIXED_11_ADDRESSING == kTpOn)
extern canuint8 TP_API_CALL_TYPE TpTransmitMixed11(canuint8 addrInfoHandle, canuint8 address_extension, TP_MEMORY_MODEL_DATA canuint8 *ptrData, canuint16 count);
# endif
# if (TP_USE_MIXED_29_ADDRESSING == kTpOn)
extern canuint8 TP_API_CALL_TYPE TpTransmitMixed29(canuint8 addrInfoHandle, canuint8 target_address, canuint8 address_extension, TP_MEMORY_MODEL_DATA canuint8 *ptrData, canuint16 count);
# endif
#endif
...
# endif
#else
# define TpRxGetAddressInfoHandle(channel)  (tpRxInfoStruct[channel].Connection)
#endif
...
# else
#  define TpTxGetAddressInfoHandle(channel)  (tpTxInfoStruct[channel].Connection)
# endif
#endif
...
*******************************************************************************/
#  if defined (TP_ENABLE_NORMAL_ADDRESSING)       || \
      defined (TP_ENABLE_PRE_DISPATCHED_MODE)
