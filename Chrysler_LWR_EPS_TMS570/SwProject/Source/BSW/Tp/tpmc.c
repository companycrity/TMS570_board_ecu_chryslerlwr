...
| 2012-07-25  3.07.03  Dth   ESCAN00060198: Compiler error with dynamic TP and GM use case
******************************************************************************/
...
#  if defined (TP_ENABLE_PRE_DISPATCHED_MODE)
V_MEMROM0 extern V_MEMROM1 tTpEngineTimer V_MEMROM2 tpTxConfirmationTimeout[];
V_MEMROM0 extern V_MEMROM1 tTpEngineTimer V_MEMROM2 tpRxConfirmationTimeout[];
#   define TpRxConfirmationTimeout(tpChannel)   (tTpEngineTimer)(tpRxConfirmationTimeout[TpGetConnectionGroup(TpRxGetAddressInfoHandle(tpChannel))])    
#   define TpTxConfirmationTimeout(tpChannel)   (tTpEngineTimer)(tpTxConfirmationTimeout[TpGetConnectionGroup(TpTxGetAddressInfoHandle(tpChannel))])
#  else
...
# if defined(TP_CHANNEL_SPECIFIC_TIMING)
#  if defined (TP_ENABLE_PRE_DISPATCHED_MODE)
#   define TpRxGetBlockSizeDefault(tpChannel)    (TpBlockSize[TpGetConnectionGroup(TpRxGetAddressInfoHandle(tpChannel))])
#  else
...
# if defined(TP_CHANNEL_SPECIFIC_TIMING)
#  if defined (TP_ENABLE_PRE_DISPATCHED_MODE)
#   define TpRxReloadBSCnt(tpChannel)            (tpRxState[tpChannel].BSCounter = (TpBlockSize[TpGetConnectionGroup(TpRxGetAddressInfoHandle(tpChannel))])) 
#   define TpRxGetBlockSize(tpChannel)           (TpBlockSize[TpGetConnectionGroup(TpRxGetAddressInfoHandle(tpChannel))])
#  else 
...
# if defined(TP_CHANNEL_SPECIFIC_TIMING)
#  if defined (TP_ENABLE_PRE_DISPATCHED_MODE)
#   define TpRxGetSTMINtimeDefault(tpChannel)    (TpSTMin[TpGetConnectionGroup(TpRxGetAddressInfoHandle(tpChannel))])
#  else
...
# if defined(TP_CHANNEL_SPECIFIC_TIMING)
#  if defined (TP_ENABLE_PRE_DISPATCHED_MODE)
#   define TpRxGetSTMINtime(tpChannel)           (TpSTMin[TpGetConnectionGroup(TpRxGetAddressInfoHandle(tpChannel))])
#  else
...
# if defined(TP_CHANNEL_SPECIFIC_TIMING)
#  if defined (TP_ENABLE_PRE_DISPATCHED_MODE)
#   define TpTxGetSTMINtime(tpChannel)           (tTpEngineTimer)(TpTxTransmitCF[TpGetConnectionGroup(TpTxGetAddressInfoHandle(tpChannel))])
#  else
...
# if defined(TP_CHANNEL_SPECIFIC_TIMING)
#  if defined (TP_ENABLE_PRE_DISPATCHED_MODE)
#   define TpTxGetSTMINDefaultTime(tpChannel)    (tTpEngineTimer)(TpTxTransmitCF[TpGetConnectionGroup(TpTxGetAddressInfoHandle(tpChannel))])
#  else
...
#if defined(TP_CHANNEL_SPECIFIC_TIMING)
# if defined (TP_ENABLE_PRE_DISPATCHED_MODE)
V_MEMROM0 extern V_MEMROM1 canuint8 V_MEMROM2 TpTxTransmitCF[];
V_MEMROM0 extern V_MEMROM1 canuint8 V_MEMROM2 TpRxTimeoutCF [];
V_MEMROM0 extern V_MEMROM1 canuint8 V_MEMROM2 TpTxTimeoutFC [];
V_MEMROM0 extern V_MEMROM1 canuint8 V_MEMROM2 TpSTMin       [];
V_MEMROM0 extern V_MEMROM1 canuint8 V_MEMROM2 TpBlockSize   [];
# else
...
# if defined(TP_CHANNEL_SPECIFIC_TIMING)
#  if defined (TP_ENABLE_PRE_DISPATCHED_MODE)
#   define kTimeoutCF(tpChannel)   (tTpEngineTimer)(TpRxTimeoutCF[TpGetConnectionGroup(TpRxGetAddressInfoHandle(tpChannel))] * kTpTimeoutFactorCF)
#   define kTimeoutFC(tpChannel)   (tTpEngineTimer)(TpTxTimeoutFC[TpGetConnectionGroup(TpTxGetAddressInfoHandle(tpChannel))] * kTpTimeoutFactorFC)
#  else
...
# if defined (TP_ENABLE_PRE_DISPATCHED_MODE)
static canuint8 TpIntTransmit(canuint8 tpChannel, canuint8 *ptrData, canuint16 count);
static canuint8 TpIntTxGetFreeChannel(canuint8 connection);
# endif
...
# if defined( TP_ENABLE_PRE_DISPATCHED_MODE )
    __ApplTpTxErrorIndication(tpChannel, errorCode);
# else
...
#   if defined (C_MULTIPLE_RECEIVE_CHANNEL)         || \
       defined (C_SINGLE_RECEIVE_CHANNEL)           
canuint8 TP_INTERNAL_CALL_TYPE TpPrecopy(vuint8 addrInfoHandle, CanRxInfoStructPtr rxStruct)
#   else
#    if defined (C_MULTIPLE_RECEIVE_BUFFER)
canuint8 TP_INTERNAL_CALL_TYPE TpPrecopy(vuint8 addrInfoHandle, CanChipDataPtr rxDataPtr)
#    endif
#    if defined (C_SINGLE_RECEIVE_BUFFER)
canuint8 TP_INTERNAL_CALL_TYPE TpPrecopy(vuint8 addrInfoHandle, CanReceiveHandle rxObject)
#    endif
#   endif
# else
#   if ( defined (C_MULTIPLE_RECEIVE_CHANNEL) ||\
...
#if defined (TP_ENABLE_PRE_DISPATCHED_MODE)
      tpRxInfoStruct[tpChannel].Connection = addrInfoHandle;
#endif
...
# if defined (TP_ENABLE_PRE_DISPATCHED_MODE)
#  if defined(TP_ENABLE_NORMAL_ADDRESSING)       
              tpRxInfoStruct[tpChannel].TransmitID = TpGetTxId(addrInfoHandle);
#  endif
# endif
# if (defined(TP_ENABLE_FC_WAIT) || defined(TP_ENABLE_FC_SUPPRESS) || defined(TP_ENABLE_FC_OVERFLOW))
...
*******************************************************************************/
#if defined (TP_ENABLE_PRE_DISPATCHED_MODE)
static canuint8 TP_API_CALL_TYPE TpIntTransmit(canuint8 tpChannel, TP_MEMORY_MODEL_DATA canuint8 *ptrData, canuint16 count)
#else
# if defined (TP_ENABLE_SINGLE_CHANNEL_TP)
...
#   if ( defined (C_MULTIPLE_RECEIVE_CHANNEL) ||\
         defined (C_SINGLE_RECEIVE_CHANNEL) )
canuint8 TP_INTERNAL_CALL_TYPE TpFuncPrecopy(vuint8 addrInfoHandle, CanRxInfoStructPtr rxStruct)
#   else
#    if defined ( C_MULTIPLE_RECEIVE_BUFFER )
canuint8 TP_INTERNAL_CALL_TYPE TpFuncPrecopy(vuint8 addrInfoHandle, CanChipDataPtr rxDataPtr)
#    endif
#    if defined ( C_SINGLE_RECEIVE_BUFFER )
canuint8 TP_INTERNAL_CALL_TYPE TpFuncPrecopy(vuint8 addrInfoHandle, CanReceiveHandle rxObject)
#    endif
#   endif
#  else
#   if ( defined (C_MULTIPLE_RECEIVE_CHANNEL) ||\
...
# if defined (TP_ENABLE_PRE_DISPATCHED_MODE)
              tpFuncInfoStruct.DataBufferPtr.DataApplBufferPtr = __ApplTpFuncGetBuffer(kTpAddressInfo[addrInfoHandle].responseHandle, tpFuncInfoStruct.DataLength);
# else
...
# if defined (TP_ENABLE_PRE_DISPATCHED_MODE)
                  __ApplTpFuncIndication(kTpAddressInfo[addrInfoHandle].responseHandle, tpFuncInfoStruct.DataLength);
# else
