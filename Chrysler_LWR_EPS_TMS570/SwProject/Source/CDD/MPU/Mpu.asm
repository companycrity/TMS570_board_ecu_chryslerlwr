...
_mpuSetup_:
	;Nexteer EPS Default Region Configuration
	...
	;Nexteer EPS Default Peripheral Region Configuration
	...
	;Nexteer EPS NHET Region Configuration
	MOV R0, #2 ; Select MPU Region
	LDR R1, nhet_start ; Base Address per JJW Nexteer
	MOVW R2, #0x15 ;Size in blocks per JJW Nexteer
