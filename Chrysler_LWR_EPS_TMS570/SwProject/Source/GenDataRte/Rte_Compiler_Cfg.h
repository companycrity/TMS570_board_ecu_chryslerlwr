...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!     << Start of compiler abstraction implementation >>       DO NOT CHANGE THIS COMMENT!
 * Symbol: RTE_AP_ABSHWPOSSCOM_APPL
 *********************************************************************************************************************/

/* used for references on application variables */
# define RTE_AP_ABSHWPOSSCOM_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_AP_ABSHWPOSSCOM_APPL_DATA

/* used for references on application functions */
# define RTE_AP_ABSHWPOSSCOM_APPL_CODE
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!     << Start of compiler abstraction implementation >>       DO NOT CHANGE THIS COMMENT!
 * Symbol: RTE_AP_ARBLMT_APPL
 *********************************************************************************************************************/

/* used for references on application variables */
# define RTE_AP_ARBLMT_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_AP_ARBLMT_APPL_DATA

/* used for references on application functions */
# define RTE_AP_ARBLMT_APPL_CODE
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!     << Start of compiler abstraction implementation >>       DO NOT CHANGE THIS COMMENT!
 * Symbol: RTE_AP_HALFTO_APPL
 *********************************************************************************************************************/

/* used for references on application variables */
# define RTE_AP_HALFTO_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_AP_HALFTO_APPL_DATA

/* used for references on application functions */
# define RTE_AP_HALFTO_APPL_CODE
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!     << Start of compiler abstraction implementation >>       DO NOT CHANGE THIS COMMENT!
 * Symbol: RTE_AP_PAWTO_APPL
 *********************************************************************************************************************/

/* used for references on application variables */
# define RTE_AP_PAWTO_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_AP_PAWTO_APPL_DATA

/* used for references on application functions */
# define RTE_AP_PAWTO_APPL_CODE
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!     << Start of compiler abstraction implementation >>       DO NOT CHANGE THIS COMMENT!
 * Symbol: RTE_AP_STBCTO_APPL
 *********************************************************************************************************************/

/* used for references on application variables */
# define RTE_AP_STBCTO_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_AP_STBCTO_APPL_DATA

/* used for references on application functions */
# define RTE_AP_STBCTO_APPL_CODE
...
/* used for references on application variables */
# define RTE_CCL_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_CCL_APPL_DATA

/* used for references on application functions */
# define RTE_CCL_APPL_CODE
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_WHLIMBREJ_APPL)  **************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_CDD_IL_COM_APPL)  ****************/

/* used for references on application variables */
# define RTE_CDD_IL_COM_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_CDD_IL_COM_APPL_DATA

/* used for references on application functions */
# define RTE_CDD_IL_COM_APPL_CODE

/***  End of saved code  ************************************************************************************/
#endif

#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_ACTIVEPULL_APPL)  *************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_PARAMCOMP_APPL)  **************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_SA_MTRCURR_APPL)  ****************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_VLTGCTRL_APPL)  ***************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_PHASECTRL_APPL)  **************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_CURRENTEST_APPL)  *************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_MTRCTRLOPCONV_APPL)  **********/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_PEAKCURREST_APPL)  ************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_CURRPARAMCOMP_APPL)  **********/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_CURRCMD_APPL)  ****************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_CURRREASDIAG_APPL)  ***********/

/* used for references on application variables */
# define RTE_AP_CURRREASDIAG_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_AP_CURRREASDIAG_APPL_DATA

/* used for references on application functions */
# define RTE_AP_CURRREASDIAG_APPL_CODE
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_FINALHWPOS_APPL)  *************/

/* used for references on application variables */
# define RTE_AP_FINALHWPOS_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_AP_FINALHWPOS_APPL_DATA

/* used for references on application functions */
# define RTE_AP_FINALHWPOS_APPL_CODE

/***  End of saved code  ************************************************************************************/
#endif

#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_KINEMATICINTEGRITYDIAG_APPL)  */

/* used for references on application variables */
# define RTE_AP_KINEMATICINTEGRITYDIAG_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_AP_KINEMATICINTEGRITYDIAG_APPL_DATA

/* used for references on application functions */
# define RTE_AP_KINEMATICINTEGRITYDIAG_APPL_CODE
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_SCOMBASEDHWPOS_APPL)  *********/

/* used for references on application variables */
# define RTE_AP_SCOMBASEDHWPOS_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_AP_SCOMBASEDHWPOS_APPL_DATA

/* used for references on application functions */
# define RTE_AP_SCOMBASEDHWPOS_APPL_CODE

/***  End of saved code  ************************************************************************************/
#endif

#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_SA_DIGHWTRQ_APPL)  ***************/

/* used for references on application variables */
# define RTE_SA_DIGHWTRQ_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_SA_DIGHWTRQ_APPL_DATA

/* used for references on application functions */
# define RTE_SA_DIGHWTRQ_APPL_CODE

/***  End of saved code  ************************************************************************************/
#endif

#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_SA_HWTRQARB_APPL)  ***************/

/* used for references on application variables */
# define RTE_SA_HWTRQARB_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_SA_HWTRQARB_APPL_DATA

/* used for references on application functions */
# define RTE_SA_HWTRQARB_APPL_CODE
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_TRQBASEDINRTCMP_APPL)  ********/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_ABSHWPOS_APPL)  ***************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_CD_TURNSCOUNTER_APPL)  ***********/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_SPINXT_APPL)  ********************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_DUTYCYCLE_APPL)  **************/

/* used for references on application variables */
# define RTE_AP_DUTYCYCLE_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_AP_DUTYCYCLE_APPL_DATA

/* used for references on application functions */
# define RTE_AP_DUTYCYCLE_APPL_CODE

/***  End of saved code  ************************************************************************************/
#endif

#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_BLKBOXANCINTERFACE_APPL)  *****/

/* used for references on application variables */
# define RTE_AP_BLKBOXANCINTERFACE_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_AP_BLKBOXANCINTERFACE_APPL_DATA

/* used for references on application functions */
# define RTE_AP_BLKBOXANCINTERFACE_APPL_CODE

/***  End of saved code  ************************************************************************************/
#endif

#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_PHSREASDIAG_APPL)  ************/

/* used for references on application variables */
# define RTE_AP_PHSREASDIAG_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_AP_PHSREASDIAG_APPL_DATA

/* used for references on application functions */
# define RTE_AP_PHSREASDIAG_APPL_CODE
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_HYSTADD_APPL)  ****************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_COMM_APPL)  **********************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_CD_UNDINSTRTEST_APPL)  ***********/

/* used for references on application variables */
# define RTE_CD_UNDINSTRTEST_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_CD_UNDINSTRTEST_APPL_DATA

/* used for references on application functions */
# define RTE_CD_UNDINSTRTEST_APPL_CODE

/***  End of saved code  ************************************************************************************/
#endif

#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_CD_RESETHANDLER_APPL)  ***********/

/* used for references on application variables */
# define RTE_CD_RESETHANDLER_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_CD_RESETHANDLER_APPL_DATA

/* used for references on application functions */
# define RTE_CD_RESETHANDLER_APPL_CODE

/***  End of saved code  ************************************************************************************/
#endif

#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_CD_MEMCHK_APPL)  *****************/

/* used for references on application variables */
# define RTE_CD_MEMCHK_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_CD_MEMCHK_APPL_DATA

/* used for references on application functions */
# define RTE_CD_MEMCHK_APPL_CODE
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_ASSISTSUMNLMT_APPL)  **********/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_MTRTRQLMT_APPL)  **************/

/* used for references on application variables */
# define RTE_AP_MTRTRQLMT_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_AP_MTRTRQLMT_APPL_DATA

/* used for references on application functions */
# define RTE_AP_MTRTRQLMT_APPL_CODE
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_DIAGMGR_APPL)  ****************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_VEHICLESPEED_APPL)  ***********/

/* used for references on application variables */
# define RTE_AP_VEHICLESPEED_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_AP_VEHICLESPEED_APPL_DATA

/* used for references on application functions */
# define RTE_AP_VEHICLESPEED_APPL_CODE
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_SA_PRIMARYSHUTDOWN_APPL)  ********/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_IPMTRQCANC_APPL)  *************/

/* used for references on application variables */
# define RTE_AP_IPMTRQCANC_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_AP_IPMTRQCANC_APPL_DATA

/* used for references on application functions */
# define RTE_AP_IPMTRQCANC_APPL_CODE

/***  End of saved code  ************************************************************************************/
#endif

#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_IPMCURRCMD_APPL)  *************/

/* used for references on application variables */
# define RTE_AP_IPMCURRCMD_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_AP_IPMCURRCMD_APPL_DATA

/* used for references on application functions */
# define RTE_AP_IPMCURRCMD_APPL_CODE
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_AP_DIAGMGRD_APPL)  ***************/

/* used for references on application variables */
# define RTE_AP_DIAGMGRD_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_AP_DIAGMGRD_APPL_DATA

/* used for references on application functions */
# define RTE_AP_DIAGMGRD_APPL_CODE
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_RTEERRATA_APPL)  *****************/

/* used for references on application variables */
# define RTE_RTEERRATA_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_RTEERRATA_APPL_DATA

/* used for references on application functions */
# define RTE_RTEERRATA_APPL_CODE
...
#    error "The magic number of the generated file <C:/Sankar/Chrysler/Synergy/CL/Temp_work/Chrysler_LWR_EPS_TMS570/SwProject/Source/GenDataRte/Rte_Compiler_Cfg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
