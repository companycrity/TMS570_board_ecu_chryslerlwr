...
#  define Rte_IRead_QuadDet_Per1_MRFMtrTrqCmdScl_MtrNm_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_QuadDet_QuadDet_Per1.Rte_MRFMtrTrqCmdScl_MtrNm_f32.value)
...
#  define Rte_IWrite_QuadDet_Per1_MtrQuad_Cnt_u08(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_QuadDet_QuadDet_Per1.Rte_MtrQuad_Cnt_u08.value = (data) \
  )

#  define Rte_IWriteRef_QuadDet_Per1_MtrQuad_Cnt_u08() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_QuadDet_QuadDet_Per1.Rte_MtrQuad_Cnt_u08.value)
...
#    error "The magic number of the generated file <C:/Sankar/Chrysler/Synergy/CL/Temp_work/Chrysler_LWR_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_QuadDet.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
