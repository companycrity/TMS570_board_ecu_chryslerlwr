...
#  define Rte_InitValue_AsstAssemPol_Cnt_s08 (0)
...
#  define Rte_InitValue_MRFMotorVel_MtrRadpS_f32 (0.0F)
#  define Rte_InitValue_MRFMotorVelUnfiltered_MtrRadpS_f32 (0.0F)
#  define Rte_InitValue_SysCDiagHandWheelVel_HwRadpS_f32 (0.0F)
...
#  define Rte_IRead_MtrVel_Per1_AsstAssemPol_Cnt_s08() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Sa_MtrVel_MtrVel_Per1.Rte_AsstAssemPol_Cnt_s08.value)
...
#  define Rte_IWrite_MtrVel_Per1_CRFMotorVel_MtrRadpS_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_MtrVel_CRFMotorVel_MtrRadpS_f32.value = (data) \
  )

#  define Rte_IWriteRef_MtrVel_Per1_CRFMotorVel_MtrRadpS_f32() \
  (&Rte_Task_2ms_10.Rte_TB.Rte_I_MtrVel_CRFMotorVel_MtrRadpS_f32.value)

#  define Rte_IWrite_MtrVel_Per1_HandwheelVel_HwRadpS_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_MtrVel_HandwheelVel_HwRadpS_f32.value = (data) \
  )
...
#  define Rte_IWrite_MtrVel_Per1_HwVelValid_Cnt_lgc(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Sa_MtrVel_MtrVel_Per1.Rte_HwVelValid_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_MtrVel_Per1_HwVelValid_Cnt_lgc() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Sa_MtrVel_MtrVel_Per1.Rte_HwVelValid_Cnt_lgc.value)

#  define Rte_IWrite_MtrVel_Per1_MRFMotorVelUnfiltered_MtrRadpS_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Sa_MtrVel_MtrVel_Per1.Rte_MRFMotorVelUnfiltered_MtrRadpS_f32.value = (data) \
  )

#  define Rte_IWriteRef_MtrVel_Per1_MRFMotorVelUnfiltered_MtrRadpS_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Sa_MtrVel_MtrVel_Per1.Rte_MRFMotorVelUnfiltered_MtrRadpS_f32.value)

#  define Rte_IWrite_MtrVel_Per1_MRFMotorVel_MtrRadpS_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Sa_MtrVel_MtrVel_Per1.Rte_MRFMotorVel_MtrRadpS_f32.value = (data) \
  )

#  define Rte_IWriteRef_MtrVel_Per1_MRFMotorVel_MtrRadpS_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Sa_MtrVel_MtrVel_Per1.Rte_MRFMotorVel_MtrRadpS_f32.value)
...
#  define Rte_IRead_MtrVel_Per2_SysCDiagHandWheelVel_HwRadpS_f32() \
  (Rte_Task_4ms_10.Rte_RB.Rte_Sa_MtrVel_MtrVel_Per2.Rte_SysCDiagHandWheelVel_HwRadpS_f32.value)

#  define Rte_IRead_MtrVel_Per2_SysCDiagMtrVelMRF_MtrRadpS_f32() \
  (Rte_Task_4ms_10.Rte_RB.Rte_Sa_MtrVel_MtrVel_Per2.Rte_SysCDiagMtrVelMRF_MtrRadpS_f32.value)
...
#  define Rte_Call_MtrVel_Per1_CP0_CheckpointReached() (WdgM_CheckpointReached((WdgM_SupervisedEntityIdType)7, (WdgM_CheckpointIdType)0))
...
#    error "The magic number of the generated file <C:/Sankar/Chrysler/Synergy/CL/Temp_work/Chrysler_LWR_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Sa_MtrVel.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
