...
#  define Rte_Call_BatteryVoltage_Per1_CP0_CheckpointReached() (WdgM_CheckpointReached((WdgM_SupervisedEntityIdType)8, (WdgM_CheckpointIdType)0))
...
#  define Rte_Call_OvervoltageData_SetRamBlockStatus(arg1) (NvMProxy_SetRamBlockStatus((UInt8)12, arg1), ((Std_ReturnType)RTE_E_OK))
...
#    error "The magic number of the generated file <C:/Sankar/Chrysler/Synergy/CL/Temp_work/Chrysler_LWR_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_BatteryVoltage.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
