...
#  define Rte_Call_CtrlTemp_Per2_CP0_CheckpointReached() (WdgM_CheckpointReached((WdgM_SupervisedEntityIdType)0, (WdgM_CheckpointIdType)0))
...
#    error "The magic number of the generated file <C:/Sankar/Chrysler/Synergy/CL/Temp_work/Chrysler_LWR_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Sa_CtrlTemp.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
