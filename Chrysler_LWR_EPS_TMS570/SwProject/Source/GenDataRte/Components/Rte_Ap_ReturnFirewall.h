...
#  define Rte_IRead_ReturnFirewall_Per1_HandwheelPosition_HwDeg_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_ReturnFirewall_ReturnFirewall_Per1.Rte_HandwheelPosition_HwDeg_f32.value)
...
#  define Rte_IWrite_ReturnFirewall_Per1_LimitedReturn_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_ReturnFirewall_LimitedReturn_MtrNm_f32.value = (data) \
  )
...
#    error "The magic number of the generated file <C:/Sankar/Chrysler/Synergy/CL/Temp_work/Chrysler_LWR_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_ReturnFirewall.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
