...
#  define Rte_InitValue_LatAcc_g_f32 (0.0F)
...
#  define Rte_IRead_AvgFricLrn_Per1_LatAcc_g_f32() \
  (0.0F)
...
#  define Rte_Call_AvgFricLrnData_WriteBlock(arg1) (NvM_WriteBlock((NvM_BlockIdType)42, arg1))
...
#  define Rte_Pim_AvgFricLrnData() \
  (&Rte_Ap_AvgFricLrn_AvgFricLrnData)
...
#    error "The magic number of the generated file <C:/Sankar/Chrysler/Synergy/CL/Temp_work/Chrysler_LWR_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_AvgFricLrn.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
