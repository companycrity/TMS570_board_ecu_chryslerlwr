...
#  define Rte_Call_uDiagLossOfExec_Per3_CP0_CheckpointReached() (WdgM_CheckpointReached((WdgM_SupervisedEntityIdType)6, (WdgM_CheckpointIdType)0))
#  define Rte_Call_uDiagStaticRegs_Per_CP1_CheckpointReached() (WdgM_CheckpointReached((WdgM_SupervisedEntityIdType)1, (WdgM_CheckpointIdType)1))
...
#    error "The magic number of the generated file <C:/Sankar/Chrysler/Synergy/CL/Temp_work/Chrysler_LWR_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Cd_uDiag.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
