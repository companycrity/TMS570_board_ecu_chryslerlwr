...
#  define Rte_IRead_AssistFirewall_Per1_Defeat_AsstTbl_Service_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_AssistFirewall_AssistFirewall_Per1.Rte_Defeat_AsstTbl_Service_Cnt_lgc.value)

#  define Rte_IRead_AssistFirewall_Per1_HighFreqAssist_MtrNm_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_AssistFirewall_AssistFirewall_Per1.Rte_HighFreqAssist_MtrNm_f32.value)
...
#  define Rte_IRead_AssistFirewall_Per1_HysteresisComp_MtrNm_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_AssistFirewall_AssistFirewall_Per1.Rte_HysteresisComp_MtrNm_f32.value)
...
#  define Rte_IWrite_AssistFirewall_Per1_AsstFirewallActive_Uls_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_AssistFirewall_AsstFirewallActive_Uls_f32.value = (data) \
  )

#  define Rte_IWriteRef_AssistFirewall_Per1_AsstFirewallActive_Uls_f32() \
  (&Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_AssistFirewall_AsstFirewallActive_Uls_f32.value)

#  define Rte_IWrite_AssistFirewall_Per1_CombinedAssist_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_AssistFirewall_CombinedAssist_MtrNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_AssistFirewall_Per1_CombinedAssist_MtrNm_f32() \
  (&Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_AssistFirewall_CombinedAssist_MtrNm_f32.value)
...
#    error "The magic number of the generated file <C:/Sankar/Chrysler/Synergy/CL/Temp_work/Chrysler_LWR_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_AssistFirewall.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
