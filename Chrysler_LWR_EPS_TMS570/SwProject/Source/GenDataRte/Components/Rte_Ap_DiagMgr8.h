 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Components/Rte_Ap_DiagMgr8.h
...
#  define Rte_Read_Ap_DiagMgr8_HwTrq_HwNm_f32(data) (*(data) = Rte_HwTrq_AnaHwTorque_HwNm_f32, ((Std_ReturnType)RTE_E_OK))
#  define Rte_Read_IgnCnt_Cnt_u16 Rte_Read_Ap_DiagMgr8_IgnCnt_Cnt_u16
#  define Rte_Read_Ap_DiagMgr8_IgnCnt_Cnt_u16(data) (*(data) = Rte_CDDInterface_IgnCnt_Cnt_u16, ((Std_ReturnType)RTE_E_OK))
#  define Rte_Read_MEC_Cnt_enum Rte_Read_Ap_DiagMgr8_MEC_Cnt_enum
#  define Rte_Read_Ap_DiagMgr8_MEC_Cnt_enum(data) (*(data) = Rte_CDDInterface_MEC_Cnt_enum, ((Std_ReturnType)RTE_E_OK))
#  define Rte_Read_MfgDiagInhibit_Cnt_lgc Rte_Read_Ap_DiagMgr8_MfgDiagInhibit_Cnt_lgc
#  define Rte_Read_Ap_DiagMgr8_MfgDiagInhibit_Cnt_lgc(data) (*(data) = Rte_CDDInterface_MfgDiagInhibit_Cnt_lgc, ((Std_ReturnType)RTE_E_OK))
#  define Rte_Read_MtrTrq_MtrNm_f32 Rte_Read_Ap_DiagMgr8_MtrTrq_MtrNm_f32
#  define Rte_Read_Ap_DiagMgr8_MtrTrq_MtrNm_f32(data) (*(data) = Rte_Ap_PwrLmtFuncCr_MRFMtrTrqCmd_MtrNm_f32, ((Std_ReturnType)RTE_E_OK))
#  define Rte_Read_VehSpd_Kph_f32 Rte_Read_Ap_DiagMgr8_VehSpd_Kph_f32
#  define Rte_Read_Ap_DiagMgr8_VehSpd_Kph_f32(data) (*(data) = Rte_Ap_SignlCondn_VehicleSpeed_Kph_f32, ((Std_ReturnType)RTE_E_OK))
...
#    error "The magic number of the generated file <C:/Sankar/Chrysler/Synergy/CL/Temp_work/Chrysler_LWR_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_DiagMgr8.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
