...
#  define Rte_InitValue_MtrVoltDaxFF_Volt_f32 (0.0F)
#  define Rte_InitValue_MtrVoltQaxFF_Volt_f32 (0.0F)
...
#  define Rte_IRead_CurrCmd_Per1_EstLd_Henry_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_CurrCmd_CurrCmd_Per1.Rte_EstLd_Henry_f32.value)

#  define Rte_IRead_CurrCmd_Per1_EstLq_Henry_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_CurrCmd_CurrCmd_Per1.Rte_EstLq_Henry_f32.value)
...
#  define Rte_IRead_CurrCmd_Per1_MRFTrqCmdScl_MtrNm_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_CurrCmd_CurrCmd_Per1.Rte_MRFTrqCmdScl_MtrNm_f32.value)

#  define Rte_IRead_CurrCmd_Per1_MtrQuad_Cnt_u08() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_CurrCmd_CurrCmd_Per1.Rte_MtrQuad_Cnt_u08.value)
...
#  define Rte_IWrite_CurrCmd_Per1_MtrTrqCmdSign_Cnt_s16(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_CurrCmd_MtrTrqCmdSign_Cnt_s16.value = (data) \
  )

#  define Rte_IWriteRef_CurrCmd_Per1_MtrTrqCmdSign_Cnt_s16() \
  (&Rte_Task_2ms_10.Rte_TB.Rte_I_CurrCmd_MtrTrqCmdSign_Cnt_s16.value)

#  define Rte_IWrite_CurrCmd_Per1_MtrVoltDaxFF_Volt_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_CurrCmd_MtrVoltDaxFF_Volt_f32.value = (data) \
  )

#  define Rte_IWriteRef_CurrCmd_Per1_MtrVoltDaxFF_Volt_f32() \
  (&Rte_Task_2ms_10.Rte_TB.Rte_I_CurrCmd_MtrVoltDaxFF_Volt_f32.value)

#  define Rte_IWrite_CurrCmd_Per1_MtrVoltQaxFF_Volt_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_CurrCmd_MtrVoltQaxFF_Volt_f32.value = (data) \
  )

#  define Rte_IWriteRef_CurrCmd_Per1_MtrVoltQaxFF_Volt_f32() \
...
#    error "The magic number of the generated file <C:/Sankar/Chrysler/Synergy/CL/Temp_work/Chrysler_LWR_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_CurrCmd.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
