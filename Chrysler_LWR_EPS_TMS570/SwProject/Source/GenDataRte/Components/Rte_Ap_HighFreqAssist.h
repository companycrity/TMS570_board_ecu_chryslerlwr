...
#  define Rte_IRead_HighFreqAssist_Per1_HwTorque_HwNm_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_HighFreqAssist_HighFreqAssist_Per1.Rte_HwTorque_HwNm_f32.value)

#  define Rte_IRead_HighFreqAssist_Per1_VehicleSpeed_Kph_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_HighFreqAssist_HighFreqAssist_Per1.Rte_VehicleSpeed_Kph_f32.value)
...
#  define Rte_IWrite_HighFreqAssist_Per1_HighFreqAssist_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_HighFreqAssist_HighFreqAssist_Per1.Rte_HighFreqAssist_MtrNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_HighFreqAssist_Per1_HighFreqAssist_MtrNm_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_HighFreqAssist_HighFreqAssist_Per1.Rte_HighFreqAssist_MtrNm_f32.value)
...
#    error "The magic number of the generated file <C:/Sankar/Chrysler/Synergy/CL/Temp_work/Chrysler_LWR_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_HighFreqAssist.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
