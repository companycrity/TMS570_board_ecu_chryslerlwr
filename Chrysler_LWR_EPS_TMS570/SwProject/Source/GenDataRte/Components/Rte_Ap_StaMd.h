...
#  define Rte_IRead_StaMd_Per1_FTerm_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_TB.Rte_I_DiagMgr_DiagRmpToZeroActive_Cnt_lgc.value)
...
#  define Rte_Call_CloseCheckData_GetErrorStatus(arg1) (NvMProxy_GetErrorStatus((UInt8)9, arg1), ((Std_ReturnType)RTE_E_OK))
#  define RTE_START_SEC_NVMPROXY_APPL_CODE
#  include "MemMap.h"
...
#  define Rte_Call_CloseCheckData_WriteBlock(arg1) (NvMProxy_WriteBlock((UInt8)9, arg1))
...
#  define Rte_Call_StaMd_Per1_CP1_CheckpointReached() (WdgM_CheckpointReached((WdgM_SupervisedEntityIdType)7, (WdgM_CheckpointIdType)1))
...
#  define Rte_Call_TypeHData_WriteBlock(arg1) (NvMProxy_WriteBlock((UInt8)10, arg1))
...
#    error "The magic number of the generated file <C:/Sankar/Chrysler/Synergy/CL/Temp_work/Chrysler_LWR_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_StaMd.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
