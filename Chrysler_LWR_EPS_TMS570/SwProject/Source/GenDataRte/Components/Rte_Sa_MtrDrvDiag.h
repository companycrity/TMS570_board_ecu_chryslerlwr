...
#  define Rte_IRead_MtrDrvDiag_Per1_VswitchClosed_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Sa_MtrDrvDiag_MtrDrvDiag_Per1.Rte_VswitchClosed_Cnt_lgc.value)
...
#  define Rte_IWrite_MtrDrvDiag_Trns1_MtrDrvrInitComplete_Cnt_lgc(data) \
  ( \
    Rte_Task_Trans_10.Rte_RB.Rte_Sa_MtrDrvDiag_MtrDrvDiag_Trns1.Rte_MtrDrvrInitComplete_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_MtrDrvDiag_Trns1_MtrDrvrInitComplete_Cnt_lgc() \
  (&Rte_Task_Trans_10.Rte_RB.Rte_Sa_MtrDrvDiag_MtrDrvDiag_Trns1.Rte_MtrDrvrInitComplete_Cnt_lgc.value)
...
#    error "The magic number of the generated file <C:/Sankar/Chrysler/Synergy/CL/Temp_work/Chrysler_LWR_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Sa_MtrDrvDiag.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
