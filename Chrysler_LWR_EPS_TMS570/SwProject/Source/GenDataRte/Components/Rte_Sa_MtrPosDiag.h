...
#  define Rte_IRead_MtrPosDiag_Per1_Cos1RTOffset_Volts_f32() \
  (Rte_Task_2ms.Rte_TB.Rte_I_MtrPosSnsrLearning_Cos1RTOffset_Volts_f32.value)

#  define Rte_IRead_MtrPosDiag_Per1_Sin1RTOffset_Volts_f32() \
  (Rte_Task_2ms.Rte_TB.Rte_I_MtrPosSnsrLearning_Sin1RTOffset_Volts_f32.value)

#  define Rte_IRead_MtrPosDiag_Per2_MtrPosMech2_Rev_f32() \
  (Rte_Task_2ms.Rte_TB.Rte_I_MtrPos_MtrPosMech2_Rev_f32.value)

#  define Rte_IRead_MtrPosDiag_Per2_MtrPosMech_Rev_f32() \
  (Rte_Task_2ms.Rte_TB.Rte_I_CDDInterface_MtrPosMech_Rev_f32.value)
...
#  include "MemMap.h"
FUNC(Std_ReturnType, RTE_IOHWABSTRACTIONUSR_APPL_CODE) IoHwAb_InputCosTheta1_V_f32(P2VAR(Float, AUTOMATIC, RTE_IOHWABSTRACTIONUSR_APPL_VAR) signal);
...
#  define RTE_START_SEC_IOHWABSTRACTIONUSR_APPL_CODE
#  include "MemMap.h"
FUNC(Std_ReturnType, RTE_IOHWABSTRACTIONUSR_APPL_CODE) IoHwAb_InputSinTheta1_V_f32(P2VAR(Float, AUTOMATIC, RTE_IOHWABSTRACTIONUSR_APPL_VAR) signal);
#  define RTE_STOP_SEC_IOHWABSTRACTIONUSR_APPL_CODE
#  include "MemMap.h"
...
#  define Rte_Call_NxtrDiagMgr_SetNTCStatus NxtrDiagMgrD_SetNTCStatus
...
#    error "The magic number of the generated file <C:/cmsynergy/My_ePWM_LWR/Chrysler_LWR_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Sa_MtrPosDiag.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
