...
FUNC(void, RTE_NVM_APPL_CODE) NvM_MainFunction(void);
...
#    error "The magic number of the generated file <C:/Sankar/Chrysler/Synergy/CL/Temp_work/Chrysler_LWR_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_NvM.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
