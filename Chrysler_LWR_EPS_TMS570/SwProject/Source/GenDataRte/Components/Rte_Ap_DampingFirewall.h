...
#  define Rte_IWrite_DampingFirewall_Per1_CombinedDamping_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_Ap_DampingFirewall_CombinedDamping_MtrNm_f32.value = (data) \
  )
...
#    error "The magic number of the generated file <C:/Sankar/Chrysler/Synergy/CL/Temp_work/Chrysler_LWR_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_DampingFirewall.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
