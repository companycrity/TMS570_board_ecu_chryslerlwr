...
#  define Rte_IRead_Damping_Per1_AssistCmd_MtrNm_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_Damping_Damping_Per1.Rte_AssistCmd_MtrNm_f32.value)
...
#  define Rte_IWrite_Damping_Per1_DampingCmd_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_Damping_Damping_Per1.Rte_DampingCmd_MtrNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_Damping_Per1_DampingCmd_MtrNm_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_Damping_Damping_Per1.Rte_DampingCmd_MtrNm_f32.value)
...
#    error "The magic number of the generated file <C:/Sankar/Chrysler/Synergy/CL/Temp_work/Chrysler_LWR_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_Damping.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
