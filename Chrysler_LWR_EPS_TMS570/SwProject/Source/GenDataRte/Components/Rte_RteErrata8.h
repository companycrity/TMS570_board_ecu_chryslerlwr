 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Components/Rte_RteErrata8.h
...
#ifndef _RTE_RTEERRATA8_H
# define _RTE_RTEERRATA8_H
...
#    error "The magic number of the generated file <C:/Sankar/Chrysler/Synergy/CL/Temp_work/Chrysler_LWR_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_RteErrata8.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
