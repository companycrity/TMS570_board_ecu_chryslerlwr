...
#  define Rte_IRead_PwrLmtFuncCr_Per2_CntDisMtrTrqCmdMRF_MtrNm_f32() \
  (Rte_Task_10ms_10.Rte_RB.Rte_Ap_PwrLmtFuncCr_PwrLmtFuncCr_Per2.Rte_CntDisMtrTrqCmdMRF_MtrNm_f32.value)

#  define Rte_IRead_PwrLmtFuncCr_Per2_Vecu_Volt_f32() \
  (Rte_Task_10ms_10.Rte_RB.Rte_Ap_PwrLmtFuncCr_PwrLmtFuncCr_Per2.Rte_Vecu_Volt_f32.value)

#  define Rte_IWrite_PwrLmtFuncCr_Per2_FltTrqLmt_Uls_f32(data) \
  ( \
    Rte_Task_10ms_10.Rte_RB.Rte_Ap_PwrLmtFuncCr_PwrLmtFuncCr_Per2.Rte_FltTrqLmt_Uls_f32.value = (data) \
  )

#  define Rte_IWriteRef_PwrLmtFuncCr_Per2_FltTrqLmt_Uls_f32() \
  (&Rte_Task_10ms_10.Rte_RB.Rte_Ap_PwrLmtFuncCr_PwrLmtFuncCr_Per2.Rte_FltTrqLmt_Uls_f32.value)

#  define Rte_IWrite_PwrLmtFuncCr_Per2_ThresholdExceeded_Cnt_lgc(data) \
  ( \
    Rte_Task_10ms_10.Rte_RB.Rte_Ap_PwrLmtFuncCr_PwrLmtFuncCr_Per2.Rte_ThresholdExceeded_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_PwrLmtFuncCr_Per2_ThresholdExceeded_Cnt_lgc() \
  (&Rte_Task_10ms_10.Rte_RB.Rte_Ap_PwrLmtFuncCr_PwrLmtFuncCr_Per2.Rte_ThresholdExceeded_Cnt_lgc.value)
...
#    error "The magic number of the generated file <C:/Sankar/Chrysler/Synergy/CL/Temp_work/Chrysler_LWR_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_PwrLmtFuncCr.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
