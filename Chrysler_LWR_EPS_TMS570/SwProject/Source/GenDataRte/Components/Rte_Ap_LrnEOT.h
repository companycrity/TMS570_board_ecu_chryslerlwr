...
#  define Rte_IRead_LrnEOT_Per1_PostLimitTorque_MtrNm_f32() \
  (Rte_Task_10ms_9.Rte_RB.Rte_Ap_LrnEOT_LrnEOT_Per1.Rte_PostLimitTorque_MtrNm_f32.value)
...
#  define Rte_Call_LearnedEOTData_SetRamBlockStatus(arg1) (NvM_SetRamBlockStatus((NvM_BlockIdType)14, arg1), ((Std_ReturnType)RTE_E_OK))
#  define RTE_START_SEC_NVM_APPL_CODE
#  include "MemMap.h"
...
#  define Rte_Call_LearnedEOTData_WriteBlock(arg1) (NvM_WriteBlock((NvM_BlockIdType)14, arg1))
...
#    error "The magic number of the generated file <C:/Sankar/Chrysler/Synergy/CL/Temp_work/Chrysler_LWR_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Ap_LrnEOT.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
