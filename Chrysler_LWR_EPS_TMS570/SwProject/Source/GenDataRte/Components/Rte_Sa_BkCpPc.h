...
extern VAR(Rte_tsTask_Trans_9, RTE_VAR_NOINIT) Rte_Task_Trans_9;
...
#  define Rte_IWrite_BkCpPc_Trns1_PwrDiscATestComplete_Cnt_lgc(data) \
  ( \
    Rte_Task_Trans_9.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns1.Rte_PwrDiscATestComplete_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_BkCpPc_Trns1_PwrDiscATestComplete_Cnt_lgc() \
  (&Rte_Task_Trans_9.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns1.Rte_PwrDiscATestComplete_Cnt_lgc.value)

#  define Rte_IWrite_BkCpPc_Trns1_PwrDiscBTestComplete_Cnt_lgc(data) \
  ( \
    Rte_Task_Trans_9.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns1.Rte_PwrDiscBTestComplete_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_BkCpPc_Trns1_PwrDiscBTestComplete_Cnt_lgc() \
  (&Rte_Task_Trans_9.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns1.Rte_PwrDiscBTestComplete_Cnt_lgc.value)

#  define Rte_IWrite_BkCpPc_Trns2_PwrDiscATestComplete_Cnt_lgc(data) \
  ( \
    Rte_Task_Trans_9.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns2.Rte_PwrDiscATestComplete_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_BkCpPc_Trns2_PwrDiscATestComplete_Cnt_lgc() \
  (&Rte_Task_Trans_9.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns2.Rte_PwrDiscATestComplete_Cnt_lgc.value)

#  define Rte_IWrite_BkCpPc_Trns2_PwrDiscBTestComplete_Cnt_lgc(data) \
  ( \
    Rte_Task_Trans_9.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns2.Rte_PwrDiscBTestComplete_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_BkCpPc_Trns2_PwrDiscBTestComplete_Cnt_lgc() \
  (&Rte_Task_Trans_9.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns2.Rte_PwrDiscBTestComplete_Cnt_lgc.value)

#  define Rte_IWrite_BkCpPc_Trns2_PwrDiscClosed_Cnt_lgc(data) \
  ( \
    Rte_Task_Trans_9.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns2.Rte_PwrDiscClosed_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_BkCpPc_Trns2_PwrDiscClosed_Cnt_lgc() \
  (&Rte_Task_Trans_9.Rte_RB.Rte_Sa_BkCpPc_BkCpPc_Trns2.Rte_PwrDiscClosed_Cnt_lgc.value)
...
#    error "The magic number of the generated file <C:/Sankar/Chrysler/Synergy/CL/Temp_work/Chrysler_LWR_EPS_TMS570/SwProject/Source/GenDataRte/Components/Rte_Sa_BkCpPc.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
