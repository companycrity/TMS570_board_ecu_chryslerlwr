...
# endif
# if (defined RTE_CONST_NTC_Num_InvalidMsg_ESP_A6) || (defined NTC_Num_InvalidMsg_ESP_A6)
#  if (!defined RTE_CONST_NTC_Num_InvalidMsg_ESP_A6) || (RTE_CONST_NTC_Num_InvalidMsg_ESP_A6 != 464U)
#   error "Enumeration constant <NTC_Num_InvalidMsg_ESP_A6> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_NTC_Num_InvalidMsg_ESP_A6 (464U)
#  define NTC_Num_InvalidMsg_ESP_A6 (464U)
# endif
# if (defined RTE_CONST_NTC_Num_MissingMsg_ESP_A6) || (defined NTC_Num_MissingMsg_ESP_A6)
#  if (!defined RTE_CONST_NTC_Num_MissingMsg_ESP_A6) || (RTE_CONST_NTC_Num_MissingMsg_ESP_A6 != 465U)
#   error "Enumeration constant <NTC_Num_MissingMsg_ESP_A6> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_NTC_Num_MissingMsg_ESP_A6 (465U)
#  define NTC_Num_MissingMsg_ESP_A6 (465U)
# endif
# if (defined RTE_CONST_NTC_Num_InvalidMsg_Wheel_Speed_2) || (defined NTC_Num_InvalidMsg_Wheel_Speed_2)
#  if (!defined RTE_CONST_NTC_Num_InvalidMsg_Wheel_Speed_2) || (RTE_CONST_NTC_Num_InvalidMsg_Wheel_Speed_2 != 466U)
#   error "Enumeration constant <NTC_Num_InvalidMsg_Wheel_Speed_2> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_NTC_Num_InvalidMsg_Wheel_Speed_2 (466U)
#  define NTC_Num_InvalidMsg_Wheel_Speed_2 (466U)
# endif
# if (defined RTE_CONST_NTC_Num_MissingMsg_Wheel_Speed_2) || (defined NTC_Num_MissingMsg_Wheel_Speed_2)
#  if (!defined RTE_CONST_NTC_Num_MissingMsg_Wheel_Speed_2) || (RTE_CONST_NTC_Num_MissingMsg_Wheel_Speed_2 != 467U)
#   error "Enumeration constant <NTC_Num_MissingMsg_Wheel_Speed_2> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_NTC_Num_MissingMsg_Wheel_Speed_2 (467U)
#  define NTC_Num_MissingMsg_Wheel_Speed_2 (467U)
# endif
# if (defined RTE_CONST_NTC_Num_InvalidMsg_GW_LIN_I_C2) || (defined NTC_Num_InvalidMsg_GW_LIN_I_C2)
#  if (!defined RTE_CONST_NTC_Num_InvalidMsg_GW_LIN_I_C2) || (RTE_CONST_NTC_Num_InvalidMsg_GW_LIN_I_C2 != 468U)
#   error "Enumeration constant <NTC_Num_InvalidMsg_GW_LIN_I_C2> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_NTC_Num_InvalidMsg_GW_LIN_I_C2 (468U)
#  define NTC_Num_InvalidMsg_GW_LIN_I_C2 (468U)
# endif
# if (defined RTE_CONST_NTC_Num_MissingMsg_GW_LIN_I_C2) || (defined NTC_Num_MissingMsg_GW_LIN_I_C2)
#  if (!defined RTE_CONST_NTC_Num_MissingMsg_GW_LIN_I_C2) || (RTE_CONST_NTC_Num_MissingMsg_GW_LIN_I_C2 != 469U)
#   error "Enumeration constant <NTC_Num_MissingMsg_GW_LIN_I_C2> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_NTC_Num_MissingMsg_GW_LIN_I_C2 (469U)
#  define NTC_Num_MissingMsg_GW_LIN_I_C2 (469U)
# endif
# if (defined RTE_CONST_NTC_Num_InvalidMsg_EcuCfg6) || (defined NTC_Num_InvalidMsg_EcuCfg6)
#  if (!defined RTE_CONST_NTC_Num_InvalidMsg_EcuCfg6) || (RTE_CONST_NTC_Num_InvalidMsg_EcuCfg6 != 470U)
#   error "Enumeration constant <NTC_Num_InvalidMsg_EcuCfg6> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_NTC_Num_InvalidMsg_EcuCfg6 (470U)
#  define NTC_Num_InvalidMsg_EcuCfg6 (470U)
# endif
# if (defined RTE_CONST_NTC_Num_MissingMsg_EcuCfg6) || (defined NTC_Num_MissingMsg_EcuCfg6)
#  if (!defined RTE_CONST_NTC_Num_MissingMsg_EcuCfg6) || (RTE_CONST_NTC_Num_MissingMsg_EcuCfg6 != 471U)
#   error "Enumeration constant <NTC_Num_MissingMsg_EcuCfg6> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_NTC_Num_MissingMsg_EcuCfg6 (471U)
#  define NTC_Num_MissingMsg_EcuCfg6 (471U)
# endif
# if (defined RTE_CONST_NTC_Num_InvalidMsg_VehCfg7) || (defined NTC_Num_InvalidMsg_VehCfg7)
#  if (!defined RTE_CONST_NTC_Num_InvalidMsg_VehCfg7) || (RTE_CONST_NTC_Num_InvalidMsg_VehCfg7 != 472U)
#   error "Enumeration constant <NTC_Num_InvalidMsg_VehCfg7> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_NTC_Num_InvalidMsg_VehCfg7 (472U)
#  define NTC_Num_InvalidMsg_VehCfg7 (472U)
# endif
# if (defined RTE_CONST_NTC_Num_MissingMsg_VehCfg7) || (defined NTC_Num_MissingMsg_VehCfg7)
#  if (!defined RTE_CONST_NTC_Num_MissingMsg_VehCfg7) || (RTE_CONST_NTC_Num_MissingMsg_VehCfg7 != 473U)
#   error "Enumeration constant <NTC_Num_MissingMsg_VehCfg7> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_NTC_Num_MissingMsg_VehCfg7 (473U)
#  define NTC_Num_MissingMsg_VehCfg7 (473U)
# endif
# if (defined RTE_CONST_NTC_Num_MissingMsg_CFG_RQ) || (defined NTC_Num_MissingMsg_CFG_RQ)
#  if (!defined RTE_CONST_NTC_Num_MissingMsg_CFG_RQ) || (RTE_CONST_NTC_Num_MissingMsg_CFG_RQ != 474U)
#   error "Enumeration constant <NTC_Num_MissingMsg_CFG_RQ> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_NTC_Num_MissingMsg_CFG_RQ (474U)
#  define NTC_Num_MissingMsg_CFG_RQ (474U)
# endif
# if (defined RTE_CONST_NTC_Num_MissingMsg_CFG_RQ_C) || (defined NTC_Num_MissingMsg_CFG_RQ_C)
#  if (!defined RTE_CONST_NTC_Num_MissingMsg_CFG_RQ_C) || (RTE_CONST_NTC_Num_MissingMsg_CFG_RQ_C != 475U)
#   error "Enumeration constant <NTC_Num_MissingMsg_CFG_RQ_C> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_NTC_Num_MissingMsg_CFG_RQ_C (475U)
#  define NTC_Num_MissingMsg_CFG_RQ_C (475U)
# endif
# if (defined RTE_CONST_NTC_Num_MissingMsg_ORC_YRS_DATA) || (defined NTC_Num_MissingMsg_ORC_YRS_DATA)
#  if (!defined RTE_CONST_NTC_Num_MissingMsg_ORC_YRS_DATA) || (RTE_CONST_NTC_Num_MissingMsg_ORC_YRS_DATA != 476U)
#   error "Enumeration constant <NTC_Num_MissingMsg_ORC_YRS_DATA> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_NTC_Num_MissingMsg_ORC_YRS_DATA (476U)
#  define NTC_Num_MissingMsg_ORC_YRS_DATA (476U)
# endif
# if (defined RTE_CONST_NTC_Num_InvalidMsg_ORC_YRS_DATA) || (defined NTC_Num_InvalidMsg_ORC_YRS_DATA)
#  if (!defined RTE_CONST_NTC_Num_InvalidMsg_ORC_YRS_DATA) || (RTE_CONST_NTC_Num_InvalidMsg_ORC_YRS_DATA != 477U)
#   error "Enumeration constant <NTC_Num_InvalidMsg_ORC_YRS_DATA> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_NTC_Num_InvalidMsg_ORC_YRS_DATA (477U)
#  define NTC_Num_InvalidMsg_ORC_YRS_DATA (477U)
# endif
...
# define Rte_TypeDef_TOC_STATE
typedef uint8 TOC_STATE;
# define TOC_STATE_LowerLimit (0U)
# define TOC_STATE_UpperLimit (255U)
# define Rte_InvalidValue_TOC_STATE (255U)
# define InvalidValue_TOC_STATE (255U)
# if (defined RTE_CONST_TOCSTATE_OFF) || (defined TOCSTATE_OFF)
#  if (!defined RTE_CONST_TOCSTATE_OFF) || (RTE_CONST_TOCSTATE_OFF != 0U)
#   error "Enumeration constant <TOCSTATE_OFF> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_TOCSTATE_OFF (0U)
#  define TOCSTATE_OFF (0U)
# endif
# if (defined RTE_CONST_TOCSTATE_TNA) || (defined TOCSTATE_TNA)
#  if (!defined RTE_CONST_TOCSTATE_TNA) || (RTE_CONST_TOCSTATE_TNA != 1U)
#   error "Enumeration constant <TOCSTATE_TNA> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_TOCSTATE_TNA (1U)
#  define TOCSTATE_TNA (1U)
# endif
# if (defined RTE_CONST_TOCSTATE_PNA) || (defined TOCSTATE_PNA)
#  if (!defined RTE_CONST_TOCSTATE_PNA) || (RTE_CONST_TOCSTATE_PNA != 2U)
#   error "Enumeration constant <TOCSTATE_PNA> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_TOCSTATE_PNA (2U)
#  define TOCSTATE_PNA (2U)
# endif
# if (defined RTE_CONST_TOCSTATE_READY) || (defined TOCSTATE_READY)
#  if (!defined RTE_CONST_TOCSTATE_READY) || (RTE_CONST_TOCSTATE_READY != 3U)
#   error "Enumeration constant <TOCSTATE_READY> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_TOCSTATE_READY (3U)
#  define TOCSTATE_READY (3U)
# endif
# if (defined RTE_CONST_TOCSTATE_REQUESTDENIED) || (defined TOCSTATE_REQUESTDENIED)
#  if (!defined RTE_CONST_TOCSTATE_REQUESTDENIED) || (RTE_CONST_TOCSTATE_REQUESTDENIED != 4U)
#   error "Enumeration constant <TOCSTATE_REQUESTDENIED> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_TOCSTATE_REQUESTDENIED (4U)
#  define TOCSTATE_REQUESTDENIED (4U)
# endif
# if (defined RTE_CONST_TOCSTATE_ACTIVEMODE05) || (defined TOCSTATE_ACTIVEMODE05)
#  if (!defined RTE_CONST_TOCSTATE_ACTIVEMODE05) || (RTE_CONST_TOCSTATE_ACTIVEMODE05 != 5U)
#   error "Enumeration constant <TOCSTATE_ACTIVEMODE05> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_TOCSTATE_ACTIVEMODE05 (5U)
#  define TOCSTATE_ACTIVEMODE05 (5U)
# endif
# if (defined RTE_CONST_TOCSTATE_ACTIVEMODE06) || (defined TOCSTATE_ACTIVEMODE06)
#  if (!defined RTE_CONST_TOCSTATE_ACTIVEMODE06) || (RTE_CONST_TOCSTATE_ACTIVEMODE06 != 6U)
#   error "Enumeration constant <TOCSTATE_ACTIVEMODE06> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_TOCSTATE_ACTIVEMODE06 (6U)
#  define TOCSTATE_ACTIVEMODE06 (6U)
# endif
# if (defined RTE_CONST_TOCSTATE_ACTIVEMODE07) || (defined TOCSTATE_ACTIVEMODE07)
#  if (!defined RTE_CONST_TOCSTATE_ACTIVEMODE07) || (RTE_CONST_TOCSTATE_ACTIVEMODE07 != 7U)
#   error "Enumeration constant <TOCSTATE_ACTIVEMODE07> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_TOCSTATE_ACTIVEMODE07 (7U)
#  define TOCSTATE_ACTIVEMODE07 (7U)
# endif
# if (defined RTE_CONST_TOCSTATE_NOTAVAILABLE) || (defined TOCSTATE_NOTAVAILABLE)
#  if (!defined RTE_CONST_TOCSTATE_NOTAVAILABLE) || (RTE_CONST_TOCSTATE_NOTAVAILABLE != 8U)
#   error "Enumeration constant <TOCSTATE_NOTAVAILABLE> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_TOCSTATE_NOTAVAILABLE (8U)
...
#  define Rte_TypeDef_CMDIgnStatType
typedef uint8 CMDIgnStatType;
#  define CMDIgnStatType_LowerLimit (0U)
#  define CMDIgnStatType_UpperLimit (7U)
#  if (defined RTE_CONST_IgnLock) || (defined IgnLock)
#   if (!defined RTE_CONST_IgnLock) || (RTE_CONST_IgnLock != 0U)
#    error "Enumeration constant <IgnLock> conflicts with another constant."
#   endif
#  else
#   define RTE_CONST_IgnLock (0U)
#   define IgnLock (0U)
#  endif
#  if (defined RTE_CONST_IgnOff) || (defined IgnOff)
#   if (!defined RTE_CONST_IgnOff) || (RTE_CONST_IgnOff != 1U)
#    error "Enumeration constant <IgnOff> conflicts with another constant."
#   endif
#  else
#   define RTE_CONST_IgnOff (1U)
#   define IgnOff (1U)
#  endif
#  if (defined RTE_CONST_IgnAcc) || (defined IgnAcc)
#   if (!defined RTE_CONST_IgnAcc) || (RTE_CONST_IgnAcc != 2U)
#    error "Enumeration constant <IgnAcc> conflicts with another constant."
#   endif
#  else
#   define RTE_CONST_IgnAcc (2U)
#   define IgnAcc (2U)
#  endif
#  if (defined RTE_CONST_IgnOffAcc) || (defined IgnOffAcc)
#   if (!defined RTE_CONST_IgnOffAcc) || (RTE_CONST_IgnOffAcc != 3U)
#    error "Enumeration constant <IgnOffAcc> conflicts with another constant."
#   endif
#  else
#   define RTE_CONST_IgnOffAcc (3U)
#   define IgnOffAcc (3U)
#  endif
#  if (defined RTE_CONST_IgnRun) || (defined IgnRun)
#   if (!defined RTE_CONST_IgnRun) || (RTE_CONST_IgnRun != 4U)
#    error "Enumeration constant <IgnRun> conflicts with another constant."
#   endif
#  else
#   define RTE_CONST_IgnRun (4U)
#   define IgnRun (4U)
#  endif
#  if (defined RTE_CONST_IgnStart) || (defined IgnStart)
#   if (!defined RTE_CONST_IgnStart) || (RTE_CONST_IgnStart != 5U)
#    error "Enumeration constant <IgnStart> conflicts with another constant."
#   endif
#  else
#   define RTE_CONST_IgnStart (5U)
#   define IgnStart (5U)
#  endif
#  if (defined RTE_CONST_StatNotUsed) || (defined StatNotUsed)
#   if (!defined RTE_CONST_StatNotUsed) || (RTE_CONST_StatNotUsed != 6U)
#    error "Enumeration constant <StatNotUsed> conflicts with another constant."
#   endif
#  else
#   define RTE_CONST_StatNotUsed (6U)
#   define StatNotUsed (6U)
#  endif
#  if (defined RTE_CONST_SignalNotAvailable) || (defined SignalNotAvailable)
#   if (!defined RTE_CONST_SignalNotAvailable) || (RTE_CONST_SignalNotAvailable != 7U)
#    error "Enumeration constant <SignalNotAvailable> conflicts with another constant."
#   endif
#  else
#   define RTE_CONST_SignalNotAvailable (7U)
#   define SignalNotAvailable (7U)
#  endif
...
#  define Rte_TypeDef_PersonalityType
typedef uint8 PersonalityType;
#  define PersonalityType_LowerLimit (0U)
#  define PersonalityType_UpperLimit (3U)
...
typedef struct
{
  Float RackCntrOffset_HwDeg_f32;
...
#  define Rte_TypeDef_RT_PPEI_Vheicle_Speed_and_Distance
typedef struct
{
  RT_VehSpdAvgNonDrvnGroup RT_VehSpdAvgNonDrvnGroup;
} RT_PPEI_Vheicle_Speed_and_Distance;
...
extern VAR(Boolean, RTE_VAR_DEFAULT_RTE_Ap_10_PIM_GROUP) Rte_Ap_AstLmt_SteerAsstDefeat;
extern VAR(CoggingCancTrq, RTE_VAR_DEFAULT_RTE_Ap_10_PIM_GROUP) Rte_Ap_TrqCanc_CogTrqCal;
extern VAR(CoggingCancTrqRplComp, RTE_VAR_DEFAULT_RTE_Ap_10_PIM_GROUP) Rte_Ap_TrqCanc_CogTrqRplComp;
...
extern VAR(AvgFricLrnType, RTE_VAR_DEFAULT_RTE_Ap_9_PIM_GROUP) Rte_Ap_AvgFricLrn_AvgFricLrnData;
extern VAR(EOTLearned_DataType, RTE_VAR_DEFAULT_RTE_Ap_9_PIM_GROUP) Rte_Ap_LrnEOT_LearnedEOT;
...
typedef struct
{
  Rte_DE_Float Rte_I_SrlComInput_AmbTempAvg_DegC_f32;
} Rte_tsTB_Task_100ms_9;

typedef struct
{
  Rte_tsTB_Task_100ms_9 Rte_TB;
...
typedef struct
{
  Rte_DE_Float Rte_IWSSCalcVspd_Kph_f32;
  Rte_DE_Boolean Rte_PAEnableRqst_Cnt_lgc;
  Rte_DE_UInt8 Rte_PAManoeuvrePhase_Cnt_u08;
  Rte_DE_Float Rte_PATrqOvCmdRqst_HwNm_f32;
  Rte_DE_UInt8 Rte_PAWhlDirRLStat_Cnt_u08;
  Rte_DE_UInt8 Rte_PAWhlDirRRStat_Cnt_u08;
  Rte_DE_Boolean Rte_PAWhlPlsCntRLValid_Cnt_lgc;
  Rte_DE_Boolean Rte_PAWhlPlsCntRRValid_Cnt_lgc;
  Rte_DE_Boolean Rte_PrkAsstFuncPresent_Cnt_lgc;
  Rte_DE_Boolean Rte_TrqOvReverseGearEngage_Cnt_lgc;
  Rte_DE_Float Rte_VehicleSpeed_Kph_f32;
} Rte_tsRB_Ap_PAwTO_PAwTO_Per2;
...
typedef union
{
  ...
  Rte_tsRB_Ap_PAwTO_PAwTO_Per2 Rte_Ap_PAwTO_PAwTO_Per2;
} Rte_tuRB_Task_10ms_10;

typedef struct
{
  Rte_DE_Float Rte_I_HwTrq_AnaHwTorque_HwNm_f32;
  Rte_DE_Boolean Rte_I_CDDInterface_KinIntDiagSrlComSvcDft_Cnt_lgc;
} Rte_tsTB_Task_10ms_10;

typedef struct
{
  Rte_tsTB_Task_10ms_10 Rte_TB;
...
typedef struct
{
  Rte_DE_Float Rte_DemLocalVoltage_Volt_f32;
  Rte_DE_Float Rte_DemSystemVoltage_Volt_f32;
  Rte_DE_UInt16 Rte_NET_CFG_STAT_PT_Cnt_u16;
  Rte_DE_UInt8 Rte_NWCONFIG_STATUS_EC6_DE_NET_CFG_STAT_PT;
} Rte_tsRB_Ap_DemIf_DemIf_SetInputsConditions;
...
typedef union
{
  ...
  Rte_tsRB_Ap_DemIf_DemIf_SetInputsConditions Rte_Ap_DemIf_DemIf_SetInputsConditions;
...
} Rte_tsRB_IoHwAbstractionUsr_IoHwAb_FwdPathAdc;
...
typedef struct
{
  ...
  Rte_DE_Float Rte_DaxIntegralGain_IPM_Uls_f32;
  Rte_DE_Float Rte_DaxIntegralGain_SPM_Uls_f32;
  Rte_DE_Float Rte_DaxPropotionalGain_IPM_Uls_f32;
  Rte_DE_Float Rte_DaxPropotionalGain_SPM_Uls_f32;
  Rte_DE_Float Rte_EstKe_VpRadpS_f32;
  Rte_DE_Float Rte_MRFMtrVel_MtrRadpS_f32;
  Rte_DE_Float Rte_MtrCurr1TempOffset_Volt_f32;
  Rte_DE_Float Rte_MtrCurr2TempOffset_Volt_f32;
  Rte_DE_Float Rte_MtrCurrDaxRef_IPM_Amp_f32;
  Rte_DE_Float Rte_MtrCurrDaxRef_SPM_Amp_f32;
  Rte_DE_Float Rte_MtrCurrQax12Mag_Amp_f32;
  Rte_DE_Float Rte_MtrCurrQax12Ph_Rev_f32;
  Rte_DE_Float Rte_MtrCurrQax6Mag_Amp_f32;
  Rte_DE_Float Rte_MtrCurrQax6Ph_Rev_f32;
  Rte_DE_Float Rte_MtrCurrQaxRef_IPM_Amp_f32;
  Rte_DE_Float Rte_MtrCurrQaxRef_SPM_Amp_f32;
  Rte_DE_Float Rte_MtrPosComputationDelay_IPM_Deg_f32;
  Rte_DE_Float Rte_MtrPosComputationDelay_SPM_Deg_f32;
  Rte_DE_SInt16 Rte_MtrTrqCmdSign_IPM_Cnt_s16;
  Rte_DE_SInt16 Rte_MtrTrqCmdSign_SPM_Cnt_s16;
  Rte_DE_Float Rte_MtrVoltDaxFF_IPM_Volt_f32;
  Rte_DE_Float Rte_MtrVoltDaxFF_SPM_Volt_f32;
  Rte_DE_Float Rte_MtrVoltQaxFF_IPM_Volt_f32;
  Rte_DE_Float Rte_MtrVoltQaxFF_SPM_Volt_f32;
  Rte_DE_Float Rte_QaxIntegralGain_IPM_Uls_f32;
  Rte_DE_Float Rte_QaxIntegralGain_SPM_Uls_f32;
  Rte_DE_Float Rte_QaxPropotionalGain_IPM_Uls_f32;
  Rte_DE_Float Rte_QaxPropotionalGain_SPM_Uls_f32;
  Rte_DE_Float Rte_Vecu_Volt_f32;
...
typedef struct
{
  Rte_DE_Boolean Rte_DiagStsWIRDisable_Cnt_lgc;
  Rte_DE_Float Rte_HwTrq_HwNm_f32;
  Rte_DE_Float Rte_QualWhlFreqL_Hz_f32;
  Rte_DE_Float Rte_QualWhlFreqR_Hz_f32;
  Rte_DE_Float Rte_VehSpd_Kph_f32;
...
typedef struct
{
  ...
  Rte_DE_Boolean Rte_DiagStsHwPosDis_Cnt_lgc;
  Rte_DE_Float Rte_HwTrq_HwNm_f32;
  Rte_DE_Float Rte_SComInpHwA_HwDeg_f32;
  Rte_DE_Boolean Rte_SComInpHwAValid_Cnt_lgc;
  Rte_DE_Float Rte_VehicleSpeed_Kph_f32;
  Rte_DE_Boolean Rte_VehicleSpeedValid_Cnt_lgc;
...
typedef struct
{
  Rte_DE_Boolean Rte_DSTEnableRqst_Cnt_lgc;
  Rte_DE_UInt8 Rte_DSTErrCntrRecvLevel_Cnt_u08;
  Rte_DE_Boolean Rte_DSTExtSystemFltActive_Cnt_lgc;
  Rte_DE_Boolean Rte_DSTFuncPresent_Cnt_lgc;
  Rte_DE_Boolean Rte_DSTRevGearValid_Cnt_lgc;
  Rte_DE_Boolean Rte_DSTSlewComplete_Cnt_lgc;
  Rte_DE_TOC_STATE Rte_DSTTOCState_Uls_enum;
  Rte_DE_Float Rte_DSTTrqOvCmdRqst_HwNm_f32;
  Rte_DE_Boolean Rte_DSTTrqOvRqstValid_Cnt_lgc;
  Rte_DE_Boolean Rte_DiagRedAssistLowVoltageActive_Cnt_lgc;
  ...
  Rte_DE_Float Rte_VehicleSpeed_Kph_f32;
  Rte_DE_Boolean Rte_VehicleSpeedValid_Cnt_lgc;
  Rte_DE_Boolean Rte_DSTActive_Cnt_lgc;
  Rte_DE_Boolean Rte_DSTSlewStart_Cnt_lgc;
  Rte_DE_UInt8 Rte_DSTState_Cnt_u08;
} Rte_tsRB_Ap_StbCTO_StbCTO_Per1;

typedef struct
{
  Rte_DE_Boolean Rte_PAEnableRqst_Cnt_lgc;
  Rte_DE_Boolean Rte_PAErrInterfaceActive_Cnt_lgc;
  Rte_DE_Boolean Rte_PAExtSystemFltActive_Cnt_lgc;
  Rte_DE_Boolean Rte_PAIntSystemFltActive_Cnt_lgc;
  Rte_DE_Boolean Rte_PAWheelCriteriaMet_Cnt_lgc;
  Rte_DE_Boolean Rte_PrkAsstFuncPresent_Cnt_lgc;
  Rte_DE_Boolean Rte_PrkAsstSlewComplete_Cnt_lgc;
  Rte_DE_Boolean Rte_TrqOvReverseGearEngage_Cnt_lgc;
  Rte_DE_Boolean Rte_HandsOnDetect_Cnt_lgc;
  Rte_DE_Boolean Rte_PABoostCurveSwitch_Cnt_lgc;
  Rte_DE_Boolean Rte_PrkAssistActive_Cnt_lgc;
  Rte_DE_UInt8 Rte_PrkAssistState_Cnt_u08;
  Rte_DE_Boolean Rte_PrkAssistSuspend_Cnt_lgc;
} Rte_tsRB_Ap_PAwTO_PAwTO_Per1;
...
typedef struct
{
  ...
  Rte_DE_Boolean Rte_DiagStsNonRecRmpToZeroFltPres_Cnt_lgc;
  Rte_DE_Boolean Rte_DiagStsRecRmpToZeroFltPres_Cnt_lgc;
  Rte_DE_Boolean Rte_HaLFEnableRqst_Cnt_lgc;
  Rte_DE_Boolean Rte_HaLFErrInterfaceActive_Cnt_lgc;
  Rte_DE_Boolean Rte_HaLFExtSystemFltActive_Cnt_lgc;
  Rte_DE_Boolean Rte_HaLFFuncPresent_Cnt_lgc;
  Rte_DE_Boolean Rte_HaLFIntSystemFltActive_Cnt_lgc;
  Rte_DE_Boolean Rte_HaLFSWATrqFail_Cnt_lgc;
  Rte_DE_Boolean Rte_HaLFSlewComplete_Cnt_lgc;
  Rte_DE_Boolean Rte_HaLFTrqOvReverseGearEngage_Cnt_lgc;
  Rte_DE_Float Rte_HwTorque_HwNm_f32;
  Rte_DE_Float Rte_LimitPercentFiltered_Uls_f32;
  Rte_DE_Boolean Rte_PrevHaLFEnableRqst_Cnt_lgc;
  Rte_DE_Float Rte_PrevHaLFTrqOvCmdRqst_MtrNm_f32;
  Rte_DE_Boolean Rte_TOEOLDisable_Cnt_lgc;
  Rte_DE_Boolean Rte_HaLFActive_Cnt_lgc;
  Rte_DE_UInt8 Rte_HaLFState_Cnt_u08;
  Rte_DE_Boolean Rte_HaLFSuspend_Cnt_lgc;
} Rte_tsRB_Ap_HaLFTO_HaLFTO_Per1;
...
typedef union
{
  ...
  Rte_tsRB_IoHwAbstractionUsr_IoHwAb_FwdPathAdc Rte_IoHwAbstractionUsr_IoHwAb_FwdPathAdc;
  ...
  Rte_tsRB_Ap_StbCTO_StbCTO_Per1 Rte_Ap_StbCTO_StbCTO_Per1;
  Rte_tsRB_Ap_PAwTO_PAwTO_Per1 Rte_Ap_PAwTO_PAwTO_Per1;
  Rte_tsRB_Ap_HaLFTO_HaLFTO_Per1 Rte_Ap_HaLFTO_HaLFTO_Per1;
...
typedef struct
{
  Rte_DE_Float Rte_I_Ap_SignlCondn_VehicleSpeed_Kph_f32;
  ...
  Rte_DE_Float Rte_I_HwTrq_AnaHwTorque_HwNm_f32;
  Rte_DE_Float Rte_I_Ap_MtrTempEst_AssistMechTempEst_DegC_f32;
  Rte_DE_Float Rte_I_Ap_WhlImbRej_WIRCmdAmpBlnd_MtrNm_f32;
  Rte_DE_Float Rte_I_Assist_BaseAssistCmd_MtrNm_f32;
  Rte_DE_ManufModeType Rte_I_CDDInterface_MEC_Cnt_enum;
  Rte_DE_Float Rte_I_Ap_AssistFirewall_AsstFirewallActive_Uls_f32;
  Rte_DE_Float Rte_I_Ap_AssistFirewall_CombinedAssist_MtrNm_f32;
  Rte_DE_Float Rte_I_StabilityComp_AssistCmd_MtrNm_f32;
  Rte_DE_Float Rte_I_Ap_DampingFirewall_CombinedDamping_MtrNm_f32;
  Rte_DE_Float Rte_I_Ap_ReturnFirewall_LimitedReturn_MtrNm_f32;
  Rte_DE_Boolean Rte_I_DiagMgr_DiagRmpToZeroActive_Cnt_lgc;
  Rte_DE_Boolean Rte_I_StOpCtrl_RampDwnStatusComplete_Cnt_lgc;
  Rte_DE_Float Rte_I_Ap_AstLmt_SumLimTrqCmd_MtrNm_f32;
  ...
  Rte_DE_Float Rte_I_CurrCmd_MtrVoltDaxFF_Volt_f32;
  Rte_DE_Float Rte_I_CurrCmd_MtrVoltQaxFF_Volt_f32;
  Rte_DE_Float Rte_I_MtrPos_CumMtrPosCRF_Deg_f32;
  Rte_DE_Boolean Rte_I_DiagMgr_DiagStsNonRecRmpToZeroFltPres_Cnt_lgc;
  Rte_DE_Boolean Rte_I_DiagMgr_DiagStsRecRmpToZeroFltPres_Cnt_lgc;
  Rte_DE_Float Rte_I_Ap_AstLmt_LimitPercentFiltered_Uls_f32;
  Rte_DE_Boolean Rte_I_CDDInterface_TOEOLDisable_Cnt_lgc;
...
typedef struct
{
  ...
  Rte_DE_Boolean Rte_EngONSrlComSvcDft_Cnt_lgc;
  Rte_DE_UInt16 Rte_EngRPM_Cnt_u16;
  Rte_DE_Boolean Rte_EssEngStop_Cnt_lgc;
  Rte_DE_Boolean Rte_SpStPrsnt_Cnt_lgc;
  Rte_DE_Float Rte_VehSpd_Kph_f32;
  Rte_DE_Boolean Rte_VehSpdValid_Cnt_lgc;
...
typedef struct
{
  ...
  Rte_DE_Float Rte_DSTTrqOvCmdRqst_HwNm_f32;
  Rte_DE_Boolean Rte_HaLFActive_Cnt_lgc;
  Rte_DE_UInt8 Rte_HaLFTOState_Cnt_u08;
  Rte_DE_Float Rte_HaLFTrqOvCmdRqst_MtrNm_f32;
  Rte_DE_Float Rte_PATrqOvCmdRqst_HwNm_f32;
  Rte_DE_UInt8 Rte_PrkAssistState_Cnt_u08;
  Rte_DE_Float Rte_VehicleSpeed_Kph_f32;
  Rte_DE_UInt8 Rte_ActiveFunctionBits_Cnt_u08;
  Rte_DE_Boolean Rte_DSTSlewComplete_Cnt_lgc;
  Rte_DE_Boolean Rte_HaLFSlewComplete_Cnt_lgc;
  Rte_DE_Float Rte_IpTrqOvr_HwNm_f32;
  Rte_DE_Float Rte_OpTrqOvr_MtrNm_f32;
  Rte_DE_Float Rte_PAReturnSclFct_Uls_f32;
  Rte_DE_Boolean Rte_PICmpDisableLearning_Cnt_lgc;
  Rte_DE_Boolean Rte_PrkAsstSlewComplete_Cnt_lgc;
} Rte_tsRB_Ap_ArbLmt_ArbLmt_Per1;

typedef union
{
  Rte_tsRB_Sa_HwTrq_HwTrq_Per2 Rte_Sa_HwTrq_HwTrq_Per2;
  Rte_tsRB_Sa_MtrVel_MtrVel_Per2 Rte_Sa_MtrVel_MtrVel_Per2;
  Rte_tsRB_Ap_ArbLmt_ArbLmt_Per1 Rte_Ap_ArbLmt_ArbLmt_Per1;
...
typedef struct
{
  Rte_DE_Boolean Rte_DSTActive_Cnt_lgc;
  Rte_DE_Boolean Rte_DSTSlewStart_Cnt_lgc;
} Rte_tsRB_Ap_StbCTO_StbCTO_Init1;
...
typedef union
{
  ...
  Rte_tsRB_Ap_StbCTO_StbCTO_Init1 Rte_Ap_StbCTO_StbCTO_Init1;
  Rte_tsRB_Sa_HwTrq_HwTrq_Init Rte_Sa_HwTrq_HwTrq_Init;
  Rte_tsRB_Ap_PAwTO_PAwTO_Init1 Rte_Ap_PAwTO_PAwTO_Init1;
...
} Rte_tuRB_Task_Trans_10;

typedef struct
{
  Rte_tuRB_Task_Trans_10 Rte_RB;
} Rte_tsTask_Trans_10;
...
} Rte_tuRB_Task_Trans_9;

typedef struct
{
  Rte_tuRB_Task_Trans_9 Rte_RB;
} Rte_tsTask_Trans_9;
...
#    error "The magic number of the generated file <C:/Sankar/Chrysler/Synergy/CL/Temp_work/Chrysler_LWR_EPS_TMS570/SwProject/Source/GenDataRte/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
