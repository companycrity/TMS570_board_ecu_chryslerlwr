...
STATIC FUNC(void, ECUM_CODE) EcuM_DriverInitOne_0(void);
STATIC FUNC(void, ECUM_CODE) EcuM_DriverInitTwo_0(void);
STATIC FUNC(void, ECUM_CODE) EcuM_DriverInitThree_0(void);
STATIC FUNC(void, ECUM_CODE) EcuM_DriverRestart_0(void);
/*</ECUM_DRIVER_INIT_DECLARATION>*/
...
STATIC CONST(struct EcuM_WakeupSourceDefType, ECUM_PBCFG) EcuM_WakeupSourceList0_at[] =
{
     {
...
STATIC CONST(EcuM_SleepModeConfigType,ECUM_PBCFG) EcuM_SleepModeList0_at[] =
{
     {
...
STATIC CONST(uint8, ECUM_PBCFG) EcuM_InternalCallId0_au8[] =
{
     0
    ,1
    ,2
...
/*<ECUM_CONFIGURATION>*/
CONST(EcuM_ConfigType, ECUM_PBCFG) EcuMConfiguration =
{
    #if !defined ( V_SUPPRESS_EXTENDED_VERSION_CHECK )
        (((uint32)SYSSERVICE_ASRECUM_GENTOOL_EAD_MAJOR_VERSION << 16u) |
            ((uint32)SYSSERVICE_ASRECUM_GENTOOL_EAD_MINOR_VERSION << 8u) |
            ((uint32)SYSSERVICE_ASRECUM_GENTOOL_EAD_PATCH_VERSION)),
    #endif
    EcuM_SleepModeList0_at,
    EcuM_WakeupSourceList0_at,
    NULL_PTR,
    EcuM_InternalCallId0_au8,
    NULL_PTR,
    NULL_PTR,
    NULL_PTR,
    EcuM_DriverInitOne_0,
    EcuM_DriverInitTwo_0,
    EcuM_DriverInitThree_0,
    EcuM_DriverRestart_0,
    (256), /* Maximum allowed value for wakeup sources */
    (AppModeType)OSDEFAULTAPPMODE, /* Default application mode */
    {(EcuM_StateType)ECUM_STATE_OFF , (0)}, /* Default shutdown target */
    (10), /* computed selfrequest period timeout */
    (9),  /* Number of wakeup sources. */
    (2), /* max(CommUsers,EcuMUsers) */
    (1), /* Only EcuM Users. */
    (0), /* Only ComM Users */
    (1), /* Max number of sleep modes */
    (0), /*configured TTII sleep modes. */
    (0u) /* Flags for Used Modules */
};
/*</ECUM_CONFIGURATION>*/
...
FUNC(void, ECUM_CODE) EcuM_InternalCall(EcuM_IntFunctionCallType functionId_t)
{
    ...
    /* ECUM_CALL_DEM_SHUTDOWN */
    case 3u:
        break;
 
    /* ECUM_CALL_COMM_DEINIT */
    case 4u:
        break;
 
    /* ECUM_CALL_NVM_READALL */
    case 5u:
        NvM_ReadAll();
        break;
 
    /* ECUM_CALL_NVM_WRITEALL */
    case 6u:
        NvM_WriteAll();
        break;
 
    /* ECUM_CALL_NVM_CANCEL_WRITEALL */
    case 7u:
        NvM_CancelWriteAll();
        break;
    ...
    /* ECUM_CALL_RTE_START */
    case 8u:
    	Call_Rte_Start(); /* Nexteer Patch to provide trusted Rte Start execution */
        break;
    ...
    /* ECUM_CALL_OS_SHUTDOWN_OS */
    case 10u:
        ShutdownOS(E_OK);
        break;
 
    /* ECUM_CALL_OS_GET_RES_SCHEDULER */
    case 11u:
        GetResource(RES_SCHEDULER);
        break;
 
    /* ECUM_CALL_OS_RELEASE_RES_SCHEDULER */
    case 12u:
        ReleaseResource(RES_SCHEDULER);
        break;
 
    /* ECUM_CALL_COMM_RUN_MODE_IND */
    case 13u:
        break;
