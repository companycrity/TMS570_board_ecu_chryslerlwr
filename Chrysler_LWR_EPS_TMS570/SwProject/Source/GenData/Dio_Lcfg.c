...
CONST(Dio_ChannelGroupType, DIO_CONST) DioChannelGroupSpi5 = { 0x05003F07, 0x00000001, 0 };
CONST(Dio_ChannelGroupType, DIO_CONST) DioChannelGroupEsm = { 0x06023D49, 0x00000001, 0 };
/*</DIO_CFG_GROUP_LIST>*/
