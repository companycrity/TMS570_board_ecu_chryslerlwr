...
* Generation Time   : 18.07.2016 15:05:32
*****************************************************************************/
/* Version Control:
 * Date Created:      Fri Jul 13 18:34:17 2012
 * %version:          EA3#14.1.19 %
 * %date_modified:    Tue Oct  8 13:26:40 2013 %
 *---------------------------------------------------------------------------------------------------------------------
...
VAR(NTCInfoQueue_Str, AP_DIAGMGR_VAR)	NTCInfoQueue10_Cnt_M_str[10];
 ...
 */
CONST(NTCNumber, AP_DIAGMGR_CONST) T_NTCMapTbl10_Cnt_enum[83] = { 0x01u, 0x02u, 0x03u, 0x04u, 0x06u, 0x07u, 0x08u, 0x0Au, 0x0Bu, 0x0Cu, 0x0Fu, 0x10u, 0x11u, 0x12u, 0x13u, 0x14u, 0x17u, 0x18u, 0x19u, 0x1Au, 0x1Bu, 0x1Cu, 0x1Du, 0x1Eu, 0x20u, 0x21u, 0x22u, 0x23u, 0x24u, 0x25u, 0x28u, 0x2Au, 0x2Bu, 0x2Cu, 0x30u, 0x31u, 0x32u, 0x33u, 0x35u, 0x36u, 0x40u, 0x41u, 0x46u, 0x48u, 0x4Du, 0x4Eu, 0x4Fu, 0x52u, 0x56u, 0x62u, 0x65u, 0x66u, 0x67u, 0x70u, 0x72u, 0x90u, 0xA9u, 0xB2u, 0xB4u, 0xBFu, 0xC0u, 0xC2u, 0xC3u, 0xC5u, 0xC6u, 0xC7u, 0xC8u, 0xC9u, 0xCAu, 0xCBu, 0xCCu, 0xCEu, 0xE0u, 0xE2u, 0xE3u, 0xE4u, 0xE5u, 0xE6u, 0xE7u, 0xE8u, 0xEDu, 0x1FAu, 0x1FBu };
 ...
 * Usage:       Index into the table with the Event Id to find the associated NTC
 */
CONST(NTCNumber, AP_DIAGMGR_CONST) T_NTCMapTbl8_Cnt_enum[6] = { 0x6Bu, 0x71u, 0x76u, 0xCDu, 0xCFu, 0xDFu };
 ...
 * Usage:       Index into the table with the Event Id to find the associated NTC
 */
CONST(NTCNumber, AP_DIAGMGR_CONST) T_NTCMapTbl9_Cnt_enum[98] = { 0x42u, 0x43u, 0x44u, 0x45u, 0x91u, 0x94u, 0x95u, 0xA0u, 0xB0u, 0xB1u, 0xB5u, 0xD1u, 0xE9u, 0xEAu, 0xEBu, 0xECu, 0xEEu, 0xEFu, 0x100u, 0x102u, 0x104u, 0x120u, 0x121u, 0x124u, 0x128u, 0x129u, 0x130u, 0x131u, 0x138u, 0x139u, 0x13Au, 0x13Bu, 0x140u, 0x141u, 0x148u, 0x149u, 0x14Eu, 0x14Fu, 0x151u, 0x158u, 0x159u, 0x160u, 0x161u, 0x169u, 0x170u, 0x171u, 0x176u, 0x178u, 0x179u, 0x180u, 0x181u, 0x188u, 0x189u, 0x18Au, 0x18Bu, 0x18Cu, 0x18Du, 0x18Eu, 0x18Fu, 0x190u, 0x191u, 0x192u, 0x193u, 0x194u, 0x195u, 0x196u, 0x199u, 0x19Au, 0x19Bu, 0x19Cu, 0x19Du, 0x1A1u, 0x1A8u, 0x1A9u, 0x1B0u, 0x1B6u, 0x1B9u, 0x1C0u, 0x1C6u, 0x1C8u, 0x1C9u, 0x1D0u, 0x1D1u, 0x1D2u, 0x1D3u, 0x1D4u, 0x1D5u, 0x1D6u, 0x1D7u, 0x1D8u, 0x1D9u, 0x1DAu, 0x1DBu, 0x1DCu, 0x1DDu, 0x1DEu, 0x1DFu, 0x1F5u };
 ...
 */
CONSTP2VAR(uint16, AUTOMATIC, AP_DIAGMGR_CONST) T_DiagMgrDiagSts_Ptr_b16[3u] = {DiagSts10_Cnt_M_b16, DiagSts8_Cnt_M_b16, DiagSts9_Cnt_M_b16};

/* 
 * Description: Application Id to DiagSts Lookup 
 * Usage:       Index into the table with the Application Id to find the associated DiagSts buffer
 */
CONSTP2VAR(float32, AUTOMATIC, AP_DIAGMGR_CONST) T_DiagMgrRmpRate_Ptr_f32[3u] = {ActiveRmpRate10_UlspmS_M_f32, ActiveRmpRate8_UlspmS_M_f32, ActiveRmpRate9_UlspmS_M_f32};
...
/*		NtcInfo		Size	*/
	{ &DiagMgr_NTCInfo10_Cnt_M_str[0], 83u /* Ap_10 */ },
	{ &DiagMgr_NTCInfo8_Cnt_M_str[0], 6u /* Ap_8 */ },
	{ &DiagMgr_NTCInfo9_Cnt_M_str[0], 98u /* Ap_9 */ },
};
...
/*Idx	App  Info	*/
	...
	{ 0x00u, 0x00u },	/* NTC 0x01 */
	{ 0x00u, 0x01u },	/* NTC 0x02 */
	{ 0x00u, 0x02u },	/* NTC 0x03 */
	{ 0x00u, 0x03u },	/* NTC 0x04 */
	{ 0xFFu, 0xFFu },	/* NTC 0x05 */
	{ 0x00u, 0x04u },	/* NTC 0x06 */
	{ 0x00u, 0x05u },	/* NTC 0x07 */
	{ 0x00u, 0x06u },	/* NTC 0x08 */
	{ 0xFFu, 0xFFu },	/* NTC 0x09 */
	{ 0x00u, 0x07u },	/* NTC 0x0A */
	{ 0x00u, 0x08u },	/* NTC 0x0B */
	{ 0x00u, 0x09u },	/* NTC 0x0C */
	{ 0xFFu, 0xFFu },	/* NTC 0x0D */
	{ 0xFFu, 0xFFu },	/* NTC 0x0E */
	{ 0x00u, 0x0Au },	/* NTC 0x0F */
	{ 0x00u, 0x0Bu },	/* NTC 0x10 */
	{ 0x00u, 0x0Cu },	/* NTC 0x11 */
	{ 0x00u, 0x0Du },	/* NTC 0x12 */
	{ 0x00u, 0x0Eu },	/* NTC 0x13 */
	{ 0x00u, 0x0Fu },	/* NTC 0x14 */
	{ 0xFFu, 0xFFu },	/* NTC 0x15 */
	{ 0xFFu, 0xFFu },	/* NTC 0x16 */
	{ 0x00u, 0x10u },	/* NTC 0x17 */
	{ 0x00u, 0x11u },	/* NTC 0x18 */
	{ 0x00u, 0x12u },	/* NTC 0x19 */
	{ 0x00u, 0x13u },	/* NTC 0x1A */
	{ 0x00u, 0x14u },	/* NTC 0x1B */
	{ 0x00u, 0x15u },	/* NTC 0x1C */
	{ 0x00u, 0x16u },	/* NTC 0x1D */
	{ 0x00u, 0x17u },	/* NTC 0x1E */
	{ 0xFFu, 0xFFu },	/* NTC 0x1F */
	{ 0x00u, 0x18u },	/* NTC 0x20 */
	{ 0x00u, 0x19u },	/* NTC 0x21 */
	{ 0x00u, 0x1Au },	/* NTC 0x22 */
	{ 0x00u, 0x1Bu },	/* NTC 0x23 */
	{ 0x00u, 0x1Cu },	/* NTC 0x24 */
	{ 0x00u, 0x1Du },	/* NTC 0x25 */
	{ 0xFFu, 0xFFu },	/* NTC 0x26 */
	{ 0xFFu, 0xFFu },	/* NTC 0x27 */
	{ 0x00u, 0x1Eu },	/* NTC 0x28 */
	{ 0xFFu, 0xFFu },	/* NTC 0x29 */
	{ 0x00u, 0x1Fu },	/* NTC 0x2A */
	{ 0x00u, 0x20u },	/* NTC 0x2B */
	{ 0x00u, 0x21u },	/* NTC 0x2C */
	{ 0xFFu, 0xFFu },	/* NTC 0x2D */
	{ 0xFFu, 0xFFu },	/* NTC 0x2E */
	{ 0xFFu, 0xFFu },	/* NTC 0x2F */
	{ 0x00u, 0x22u },	/* NTC 0x30 */
	{ 0x00u, 0x23u },	/* NTC 0x31 */
	{ 0x00u, 0x24u },	/* NTC 0x32 */
	{ 0x00u, 0x25u },	/* NTC 0x33 */
	{ 0xFFu, 0xFFu },	/* NTC 0x34 */
	{ 0x00u, 0x26u },	/* NTC 0x35 */
	{ 0x00u, 0x27u },	/* NTC 0x36 */
	{ 0xFFu, 0xFFu },	/* NTC 0x37 */
	...
	{ 0x00u, 0x28u },	/* NTC 0x40 */
	{ 0x00u, 0x29u },	/* NTC 0x41 */
	{ 0x02u, 0x00u },	/* NTC 0x42 */
	{ 0x02u, 0x01u },	/* NTC 0x43 */
	{ 0x02u, 0x02u },	/* NTC 0x44 */
	{ 0x02u, 0x03u },	/* NTC 0x45 */
	{ 0x00u, 0x2Au },	/* NTC 0x46 */
	{ 0xFFu, 0xFFu },	/* NTC 0x47 */
	{ 0x00u, 0x2Bu },	/* NTC 0x48 */
	{ 0xFFu, 0xFFu },	/* NTC 0x49 */
	{ 0xFFu, 0xFFu },	/* NTC 0x4A */
	{ 0xFFu, 0xFFu },	/* NTC 0x4B */
	{ 0xFFu, 0xFFu },	/* NTC 0x4C */
	{ 0x00u, 0x2Cu },	/* NTC 0x4D */
	{ 0x00u, 0x2Du },	/* NTC 0x4E */
	{ 0x00u, 0x2Eu },	/* NTC 0x4F */
	{ 0xFFu, 0xFFu },	/* NTC 0x50 */
	{ 0xFFu, 0xFFu },	/* NTC 0x51 */
	{ 0x00u, 0x2Fu },	/* NTC 0x52 */
	{ 0xFFu, 0xFFu },	/* NTC 0x53 */
	{ 0xFFu, 0xFFu },	/* NTC 0x54 */
	{ 0xFFu, 0xFFu },	/* NTC 0x55 */
	{ 0x00u, 0x30u },	/* NTC 0x56 */
	...
	{ 0xFFu, 0xFFu },	/* NTC 0x80 */
	{ 0xFFu, 0xFFu },	/* NTC 0x81 */
	{ 0xFFu, 0xFFu },	/* NTC 0x82 */
	{ 0xFFu, 0xFFu },	/* NTC 0x83 */
	{ 0xFFu, 0xFFu },	/* NTC 0x84 */
	{ 0xFFu, 0xFFu },	/* NTC 0x85 */
	...
	{ 0x00u, 0x37u },	/* NTC 0x90 */
	{ 0x02u, 0x04u },	/* NTC 0x91 */
	{ 0xFFu, 0xFFu },	/* NTC 0x92 */
	{ 0xFFu, 0xFFu },	/* NTC 0x93 */
	{ 0x02u, 0x05u },	/* NTC 0x94 */
	{ 0x02u, 0x06u },	/* NTC 0x95 */
	...
	{ 0x02u, 0x08u },	/* NTC 0xB0 */
	{ 0x02u, 0x09u },	/* NTC 0xB1 */
	{ 0x00u, 0x39u },	/* NTC 0xB2 */
	{ 0xFFu, 0xFFu },	/* NTC 0xB3 */
	{ 0x00u, 0x3Au },	/* NTC 0xB4 */
	{ 0x02u, 0x0Au },	/* NTC 0xB5 */
	{ 0xFFu, 0xFFu },	/* NTC 0xB6 */
	{ 0xFFu, 0xFFu },	/* NTC 0xB7 */
	{ 0xFFu, 0xFFu },	/* NTC 0xB8 */
	{ 0xFFu, 0xFFu },	/* NTC 0xB9 */
	{ 0xFFu, 0xFFu },	/* NTC 0xBA */
	{ 0xFFu, 0xFFu },	/* NTC 0xBB */
	{ 0xFFu, 0xFFu },	/* NTC 0xBC */
	{ 0xFFu, 0xFFu },	/* NTC 0xBD */
	{ 0xFFu, 0xFFu },	/* NTC 0xBE */
	{ 0x00u, 0x3Bu },	/* NTC 0xBF */
	{ 0x00u, 0x3Cu },	/* NTC 0xC0 */
	{ 0xFFu, 0xFFu },	/* NTC 0xC1 */
	{ 0x00u, 0x3Du },	/* NTC 0xC2 */
	{ 0x00u, 0x3Eu },	/* NTC 0xC3 */
	{ 0xFFu, 0xFFu },	/* NTC 0xC4 */
	{ 0x00u, 0x3Fu },	/* NTC 0xC5 */
	{ 0x00u, 0x40u },	/* NTC 0xC6 */
	{ 0x00u, 0x41u },	/* NTC 0xC7 */
	{ 0x00u, 0x42u },	/* NTC 0xC8 */
	{ 0x00u, 0x43u },	/* NTC 0xC9 */
	{ 0x00u, 0x44u },	/* NTC 0xCA */
	{ 0x00u, 0x45u },	/* NTC 0xCB */
	{ 0x00u, 0x46u },	/* NTC 0xCC */
	{ 0x01u, 0x03u },	/* NTC 0xCD */
	{ 0x00u, 0x47u },	/* NTC 0xCE */
	{ 0x01u, 0x04u },	/* NTC 0xCF */
	{ 0xFFu, 0xFFu },	/* NTC 0xD0 */
	{ 0x02u, 0x0Bu },	/* NTC 0xD1 */
	...
	{ 0x01u, 0x05u },	/* NTC 0xDF */
	{ 0x00u, 0x48u },	/* NTC 0xE0 */
	{ 0xFFu, 0xFFu },	/* NTC 0xE1 */
	{ 0x00u, 0x49u },	/* NTC 0xE2 */
	{ 0x00u, 0x4Au },	/* NTC 0xE3 */
	{ 0x00u, 0x4Bu },	/* NTC 0xE4 */
	{ 0x00u, 0x4Cu },	/* NTC 0xE5 */
	{ 0x00u, 0x4Du },	/* NTC 0xE6 */
	{ 0x00u, 0x4Eu },	/* NTC 0xE7 */
	{ 0x00u, 0x4Fu },	/* NTC 0xE8 */
	{ 0x02u, 0x0Cu },	/* NTC 0xE9 */
	{ 0x02u, 0x0Du },	/* NTC 0xEA */
	{ 0x02u, 0x0Eu },	/* NTC 0xEB */
	{ 0x02u, 0x0Fu },	/* NTC 0xEC */
	{ 0x00u, 0x50u },	/* NTC 0xED */
	{ 0x02u, 0x10u },	/* NTC 0xEE */
	{ 0x02u, 0x11u },	/* NTC 0xEF */
	...
	{ 0x02u, 0x12u },	/* NTC 0x100 */
	{ 0xFFu, 0xFFu },	/* NTC 0x101 */
	{ 0x02u, 0x13u },	/* NTC 0x102 */
	{ 0xFFu, 0xFFu },	/* NTC 0x103 */
	{ 0x02u, 0x14u },	/* NTC 0x104 */
	...
	{ 0x02u, 0x15u },	/* NTC 0x120 */
	{ 0x02u, 0x16u },	/* NTC 0x121 */
	{ 0xFFu, 0xFFu },	/* NTC 0x122 */
	{ 0xFFu, 0xFFu },	/* NTC 0x123 */
	{ 0x02u, 0x17u },	/* NTC 0x124 */
	{ 0xFFu, 0xFFu },	/* NTC 0x125 */
	{ 0xFFu, 0xFFu },	/* NTC 0x126 */
	{ 0xFFu, 0xFFu },	/* NTC 0x127 */
	{ 0x02u, 0x18u },	/* NTC 0x128 */
	{ 0x02u, 0x19u },	/* NTC 0x129 */
	...
	{ 0x02u, 0x1Au },	/* NTC 0x130 */
	{ 0x02u, 0x1Bu },	/* NTC 0x131 */
	...
	{ 0x02u, 0x1Cu },	/* NTC 0x138 */
	{ 0x02u, 0x1Du },	/* NTC 0x139 */
	{ 0x02u, 0x1Eu },	/* NTC 0x13A */
	{ 0x02u, 0x1Fu },	/* NTC 0x13B */
	{ 0xFFu, 0xFFu },	/* NTC 0x13C */
	{ 0xFFu, 0xFFu },	/* NTC 0x13D */
	{ 0xFFu, 0xFFu },	/* NTC 0x13E */
	{ 0xFFu, 0xFFu },	/* NTC 0x13F */
	{ 0x02u, 0x20u },	/* NTC 0x140 */
	{ 0x02u, 0x21u },	/* NTC 0x141 */
	...
	{ 0x02u, 0x22u },	/* NTC 0x148 */
	{ 0x02u, 0x23u },	/* NTC 0x149 */
	{ 0xFFu, 0xFFu },	/* NTC 0x14A */
	{ 0xFFu, 0xFFu },	/* NTC 0x14B */
	{ 0xFFu, 0xFFu },	/* NTC 0x14C */
	{ 0xFFu, 0xFFu },	/* NTC 0x14D */
	{ 0x02u, 0x24u },	/* NTC 0x14E */
	{ 0x02u, 0x25u },	/* NTC 0x14F */
	{ 0xFFu, 0xFFu },	/* NTC 0x150 */
	{ 0x02u, 0x26u },	/* NTC 0x151 */
	...
	{ 0x02u, 0x27u },	/* NTC 0x158 */
	{ 0x02u, 0x28u },	/* NTC 0x159 */
	...
	{ 0x02u, 0x29u },	/* NTC 0x160 */
	{ 0x02u, 0x2Au },	/* NTC 0x161 */
	...
	{ 0x02u, 0x2Cu },	/* NTC 0x170 */
	{ 0x02u, 0x2Du },	/* NTC 0x171 */
	{ 0xFFu, 0xFFu },	/* NTC 0x172 */
	{ 0xFFu, 0xFFu },	/* NTC 0x173 */
	{ 0xFFu, 0xFFu },	/* NTC 0x174 */
	{ 0xFFu, 0xFFu },	/* NTC 0x175 */
	{ 0x02u, 0x2Eu },	/* NTC 0x176 */
	{ 0xFFu, 0xFFu },	/* NTC 0x177 */
	{ 0x02u, 0x2Fu },	/* NTC 0x178 */
	{ 0x02u, 0x30u },	/* NTC 0x179 */
	...
	{ 0x02u, 0x31u },	/* NTC 0x180 */
	{ 0x02u, 0x32u },	/* NTC 0x181 */
	...
	{ 0x02u, 0x33u },	/* NTC 0x188 */
	{ 0x02u, 0x34u },	/* NTC 0x189 */
	{ 0x02u, 0x35u },	/* NTC 0x18A */
	{ 0x02u, 0x36u },	/* NTC 0x18B */
	{ 0x02u, 0x37u },	/* NTC 0x18C */
	{ 0x02u, 0x38u },	/* NTC 0x18D */
	{ 0x02u, 0x39u },	/* NTC 0x18E */
	{ 0x02u, 0x3Au },	/* NTC 0x18F */
	{ 0x02u, 0x3Bu },	/* NTC 0x190 */
	{ 0x02u, 0x3Cu },	/* NTC 0x191 */
	{ 0x02u, 0x3Du },	/* NTC 0x192 */
	{ 0x02u, 0x3Eu },	/* NTC 0x193 */
	{ 0x02u, 0x3Fu },	/* NTC 0x194 */
	{ 0x02u, 0x40u },	/* NTC 0x195 */
	{ 0x02u, 0x41u },	/* NTC 0x196 */
	{ 0xFFu, 0xFFu },	/* NTC 0x197 */
	{ 0xFFu, 0xFFu },	/* NTC 0x198 */
	{ 0x02u, 0x42u },	/* NTC 0x199 */
	{ 0x02u, 0x43u },	/* NTC 0x19A */
	{ 0x02u, 0x44u },	/* NTC 0x19B */
	{ 0x02u, 0x45u },	/* NTC 0x19C */
	{ 0x02u, 0x46u },	/* NTC 0x19D */
	{ 0xFFu, 0xFFu },	/* NTC 0x19E */
	{ 0xFFu, 0xFFu },	/* NTC 0x19F */
	{ 0xFFu, 0xFFu },	/* NTC 0x1A0 */
	{ 0x02u, 0x47u },	/* NTC 0x1A1 */
	...
	{ 0x02u, 0x48u },	/* NTC 0x1A8 */
	{ 0x02u, 0x49u },	/* NTC 0x1A9 */
	...
	{ 0x02u, 0x51u },	/* NTC 0x1D0 */
	{ 0x02u, 0x52u },	/* NTC 0x1D1 */
	{ 0x02u, 0x53u },	/* NTC 0x1D2 */
	{ 0x02u, 0x54u },	/* NTC 0x1D3 */
	{ 0x02u, 0x55u },	/* NTC 0x1D4 */
	{ 0x02u, 0x56u },	/* NTC 0x1D5 */
	{ 0x02u, 0x57u },	/* NTC 0x1D6 */
	{ 0x02u, 0x58u },	/* NTC 0x1D7 */
	{ 0x02u, 0x59u },	/* NTC 0x1D8 */
	{ 0x02u, 0x5Au },	/* NTC 0x1D9 */
	{ 0x02u, 0x5Bu },	/* NTC 0x1DA */
	{ 0x02u, 0x5Cu },	/* NTC 0x1DB */
	{ 0x02u, 0x5Du },	/* NTC 0x1DC */
	{ 0x02u, 0x5Eu },	/* NTC 0x1DD */
	{ 0x02u, 0x5Fu },	/* NTC 0x1DE */
	{ 0x02u, 0x60u },	/* NTC 0x1DF */
	...
	{ 0x02u, 0x61u },	/* NTC 0x1F5 */
	{ 0xFFu, 0xFFu },	/* NTC 0x1F6 */
	{ 0xFFu, 0xFFu },	/* NTC 0x1F7 */
	{ 0xFFu, 0xFFu },	/* NTC 0x1F8 */
	{ 0xFFu, 0xFFu },	/* NTC 0x1F9 */
	{ 0x00u, 0x51u },	/* NTC 0x1FA */
	{ 0x00u, 0x52u },	/* NTC 0x1FB */
