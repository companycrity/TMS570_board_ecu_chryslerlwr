...
static void DESC_API_CALLBACK_TYPE DescOemStartSessionNexteerMode(DescMsgContext* pMsgContext);
...
static void DESC_API_CALLBACK_TYPE DescOemPostStartSessionNexteerMode(vuint8 status);
...
V_MEMROM0 static V_MEMROM1 DescPostHandler V_MEMROM2 g_descPostHandlerTable[kDescNumPostHandlers] = 
{
  ...
  DescOemPostStartSessionNexteerMode, 
...
V_MEMROM0 static V_MEMROM1 DescSvcInst V_MEMROM2 g_descSvcInst[kDescSvcInstNumItems] = 
{
  ...
  {   2, { 0x03, 0x03, 0 }, { 0x0F, 0x00 },                      3,    4, DescOemStartSessionNexteerMode } /* $10 $7E */, 
  ...
  {   2, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescEcuResetNexteer_ECU_Reset } /* $11 $60 */, 
  ...
  { 325, { 0x03, 0x03, 0 }, { 0x0E, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD01_Internal_Software_Id } /* $2E $FD $1 */, 
  {   7, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD02_Serial_Comm_Service_Active } /* $2E $FD $2 */, 
  { 325, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD04_EOL_Sin_Cos_Motor_Param } /* $2E $FD $4 */, 
  {  16, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD05_EOL_Torque_Sensor_Analog } /* $2E $FD $5 */, 

  {   4, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD07_EOL_Polarity } /* $2E $FD $7 */, 
  {   8, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD08_EOL_Torque_Sensor_Scaling_Analog } /* $2E $FD $8 */, 
  {   7, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD09_Learned_Ke } /* $2E $FD $9 */, 
  {   7, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD0A_Learned_R } /* $2E $FD $A */, 
  {   5, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD0B_EOL_Wheel_Imbalance_Select } /* $2E $FD $B */, 
  {   9, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD0C_Analog_Ke_R_and_L } /* $2E $FD $C */, 
  {  11, { 0x03, 0x03, 0 }, { 0x0E, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD0E_Motor_Stiffness_Check } /* $2E $FD $E */, 
  {  39, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD0F_ECU_Hardware_Description_Table } /* $2E $FD $F */, 

  {  13, { 0x03, 0x03, 0 }, { 0x0E, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD10_Nexteer_CCP_XCP_Transmit_and_Receive_IDs } /* $2E $FD $10 */, 
  {  31, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD12_Current_Mode_Offset_and_Gain } /* $2E $FD $12 */, 
  {  63, { 0x03, 0x03, 0 }, { 0x0E, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD13_Read_Nexteer_DTCs } /* $2E $FD $13 */, 
  {   5, { 0x03, 0x03, 0 }, { 0x0E, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD14_Turns_Counter_Vehicle_System_Status } /* $2E $FD $14 */, 
  {  16, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD15_EOL_Torque_Sensor_Digital } /* $2E $FD $15 */, 
  {   8, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD16_EOL_Torque_Sensor_Scaling_Digital } /* $2E $FD $16 */, 
  {   4, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD19_Nexteer_Manufacturing_Enable_Counter_MEC } /* $2E $FD $19 */, 
  {   4, { 0x03, 0x03, 0 }, { 0x0E, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD1A_System_State } /* $2E $FD $1A */, 

  {   4, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD1B_Manual_Vehicle_Speed_Override } /* $2E $FD $1B */, 
  {   6, { 0x03, 0x03, 0 }, { 0x0E, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD1C_Manufacturing_Services_Version } /* $2E $FD $1C */, 
  {   5, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD1D_EPS_Return_Command } /* $2E $FD $1D */, 
  {   5, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD1E_Torque_Sensor_Diagnostic_Defeat } /* $2E $FD $1E */, 
  {   4, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD1F_Serial_Comm_Handwheel_Position_Defeat } /* $2E $FD $1F */, 
  {   4, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD21_Vehicle_Tuning_Select } /* $2E $FD $21 */, 
  {   5, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD25_Motor_Torque_Scale_Factor } /* $2E $FD $25 */, 
  {   6, { 0x03, 0x03, 0 }, { 0x0E, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD26_Average_Friction_Learning_Select } /* $2E $FD $26 */, 

  {   4, { 0x03, 0x03, 0 }, { 0x0E, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD27_Friction_Offset_Output_Defeat } /* $2E $FD $27 */, 
  {   5, { 0x03, 0x03, 0 }, { 0x0E, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD29_Set_EOL_Friction_Learned } /* $2E $FD $29 */, 
  {   7, { 0x03, 0x03, 0 }, { 0x0E, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FD41_Torque_Sensor_1_and_2 } /* $2E $FD $41 */, 
  {   7, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FDA1_ECU_Serial_Number } /* $2E $FD $A1 */, 
  {   7, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FDA2_EPS_Serial_Number } /* $2E $FD $A2 */, 
  {  15, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FDA3_ECU_Hardware_Part_Number } /* $2E $FD $A3 */, 
  {   7, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FDA5_Shunt_Current_and_Offset_Gain } /* $2E $FD $A5 */, 
  {  67, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FDAC_Nexteer_Manufacturing_Scratch_Pad } /* $2E $FD $AC */, 

  {  10, { 0x03, 0x03, 0 }, { 0x0E, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FDAD_Active_Pull_Compensation } /* $2E $FD $AD */, 
  {   5, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FDAE_Ignition_Counter } /* $2E $FD $AE */, 
  {   4, { 0x03, 0x03, 0 }, { 0x0E, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FDAF_Nexteer_Fault_Information_Black_Box } /* $2E $FD $AF */, 
  { 259, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FDB0_IPM_Cogging_Tbl_1 } /* $2E $FD $B0 */, 
  { 259, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FDB1_IPM_Cogging_Tbl_2 } /* $2E $FD $B1 */, 
  { 259, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FDB2_IPM_Cogging_Tbl_3 } /* $2E $FD $B2 */, 
  { 259, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FDB3_IPM_Cogging_Tbl_4 } /* $2E $FD $B3 */, 
  {  11, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FDB4_Current_Mode_Analog_Ke_R_Ld_and_Lq } /* $2E $FD $B4 */, 

  {   7, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FDB5_Active_Pull_Set_Short_Term_Comp } /* $2E $FD $B5 */, 
  {   7, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FDB6_Active_Pull_Set_Long_Term_Comp } /* $2E $FD $B6 */, 
  {   4, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FDE1_WIR_Disable } /* $2E $FD $E1 */, 
  {   4, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FDE2_Torque_Overlay_Feature_Disable } /* $2E $FD $E2 */, 
  {   4, { 0x03, 0x03, 0 }, { 0x0F, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidNexteer_FDE4_Drift_Pull_Disable } /* $2E $FD $E4 */, 
  {   4, { 0x03, 0x03, 0 }, { 0x08, 0x00 }, kDescStateNoTransition,    0, ApplDescIoCtrlRetCtrlToEcuNexteer_FD0D_Control_Motor_Torque_Command } /* $2F $FD $D $0 */, 
  {   6, { 0x03, 0x03, 0 }, { 0x08, 0x00 }, kDescStateNoTransition,    0, ApplDescIoCtrlShortTermAdjNexteer_FD0D_Control_Motor_Torque_Command } /* $2F $FD $D $3 */, 
  {   4, { 0x03, 0x03, 0 }, { 0x08, 0x00 }, kDescStateNoTransition,    0, ApplDescIoCtrlRetCtrlToEcuNexteer_FD11_Assist_Gain_Command } /* $2F $FD $11 $0 */, 

  {   6, { 0x03, 0x03, 0 }, { 0x08, 0x00 }, kDescStateNoTransition,    0, ApplDescIoCtrlShortTermAdjNexteer_FD11_Assist_Gain_Command } /* $2F $FD $11 $3 */, 
...
V_MEMROM0 static V_MEMROM1 DescPidInst V_MEMROM2 g_descPIDInfo[kDescNumPids] = 
{
  ...
  { 0xFD01, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD01_Internal_Software_Id }, 
  { 0xFD02, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD02_Serial_Comm_Service_Active }, 

  { 0xFD04, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD04_EOL_Sin_Cos_Motor_Param }, 
  { 0xFD05, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD05_EOL_Torque_Sensor_Analog }, 
  { 0xFD07, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD07_EOL_Polarity }, 
  { 0xFD08, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD08_EOL_Torque_Sensor_Scaling_Analog }, 
  { 0xFD09, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD09_Learned_Ke }, 
  { 0xFD0A, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD0A_Learned_R }, 
  { 0xFD0B, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD0B_EOL_Wheel_Imbalance_Select }, 
  { 0xFD0C, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD0C_Analog_Ke_R_and_L }, 

  { 0xFD0E, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD0E_Motor_Stiffness_Check }, 
  { 0xFD0F, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD0F_ECU_Hardware_Description_Table }, 
  { 0xFD10, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD10_Nexteer_CCP_XCP_Transmit_and_Receive_IDs }, 
  { 0xFD12, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD12_Current_Mode_Offset_and_Gain }, 
  { 0xFD13, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD13_Read_Nexteer_DTCs }, 
  { 0xFD14, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD14_Turns_Counter_Vehicle_System_Status }, 
  { 0xFD15, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD15_EOL_Torque_Sensor_Digital }, 
  { 0xFD16, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD16_EOL_Torque_Sensor_Scaling_Digital }, 

  { 0xFD17, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD17_TMS570_Flash_Memory_Size }, 
  { 0xFD19, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD19_Nexteer_Manufacturing_Enable_Counter_MEC }, 
  { 0xFD1A, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD1A_System_State }, 
  { 0xFD1B, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD1B_Manual_Vehicle_Speed_Override }, 
  { 0xFD1C, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD1C_Manufacturing_Services_Version }, 
  { 0xFD1D, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD1D_EPS_Return_Command }, 
  { 0xFD1E, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD1E_Torque_Sensor_Diagnostic_Defeat }, 
  { 0xFD1F, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD1F_Serial_Comm_Handwheel_Position_Defeat }, 
  { 0xFD20, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD20_Read_Transient_Overvoltage_Data }, 

  { 0xFD21, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD21_Vehicle_Tuning_Select }, 
  { 0xFD25, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD25_Motor_Torque_Scale_Factor }, 
  { 0xFD26, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD26_Average_Friction_Learning_Select }, 
  { 0xFD27, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD27_Friction_Offset_Output_Defeat }, 
  { 0xFD29, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD29_Set_EOL_Friction_Learned }, 
  { 0xFD41, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FD41_Torque_Sensor_1_and_2 }, 
  { 0xFDA1, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FDA1_ECU_Serial_Number }, 
  { 0xFDA2, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FDA2_EPS_Serial_Number }, 

  { 0xFDA3, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FDA3_ECU_Hardware_Part_Number }, 
  { 0xFDA5, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FDA5_Shunt_Current_and_Offset_Gain }, 
  { 0xFDAC, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FDAC_Nexteer_Manufacturing_Scratch_Pad }, 
  { 0xFDAD, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FDAD_Active_Pull_Compensation }, 
  { 0xFDAE, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FDAE_Ignition_Counter }, 
  { 0xFDAF, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FDAF_Nexteer_Fault_Information_Black_Box }, 
  { 0xFDB0, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FDB0_IPM_Cogging_Tbl_1 }, 
  { 0xFDB1, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FDB1_IPM_Cogging_Tbl_2 }, 

  { 0xFDB2, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FDB2_IPM_Cogging_Tbl_3 }, 
  { 0xFDB3, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FDB3_IPM_Cogging_Tbl_4 }, 
  { 0xFDB4, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FDB4_Current_Mode_Analog_Ke_R_Ld_and_Lq }, 
  { 0xFDB5, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FDB5_Active_Pull_Set_Short_Term_Comp }, 
  { 0xFDB6, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FDB6_Active_Pull_Set_Long_Term_Comp }, 
  { 0xFDE0, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FDE0_Steering_Wheel_Active_Pull_Compensation }, 
  { 0xFDE1, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FDE1_WIR_Disable }, 
  { 0xFDE2, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FDE2_Torque_Overlay_Feature_Disable }, 

  { 0xFDE3, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidFDE2_NTC_for_CTC }, 
  { 0xFDE4, { { 0x0F, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidNexteer_FDE4_Drift_Pull_Disable }
};
/* Table of all RIDs' */
...
V_MEMROM0 static V_MEMROM1 DescRidInst V_MEMROM2 g_descRIDInstInfo[kDescNumRidInst] = 
{
  ...
  {   6, { { 0x0E, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescRtnCtrlStartNexteer_F000_Manufacturing_Service_Reset } /* $31 $1 $F0 $0 */, 
  {   5, { { 0x0E, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescRtnCtrlStartNexteer_F001_Clear_DTCs } /* $31 $1 $F0 $1 */, 
  {   4, { { 0x0E, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescRtnCtrlStartNexteer_F002_Torque_Sensor_End_of_Line_Calibration_Analog } /* $31 $1 $F0 $2 */, 
  {   4, { { 0x0E, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescRtnCtrlStartNexteer_F004_Torque_Sensor_End_of_Line_Calibration_Digital } /* $31 $1 $F0 $4 */, 
  {   5, { { 0x0E, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescRtnCtrlStartNexteer_F005_DTC_Status_by_Number } /* $31 $1 $F0 $5 */, 
  {   4, { { 0x0E, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescRtnCtrlStartNexteer_F006_Turns_Counter_Flash_Programming } /* $31 $1 $F0 $6 */, 
  {   0, { { 0x0E, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescRtnCtrlStartNexteer_F007_Turns_Counter_Position_EOL_Calibraiton } /* $31 $1 $F0 $7 */, 

  {   4, { { 0x0E, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescRtnCtrlStartNexteer_F008_Current_Mode_Current_Gain_Calc } /* $31 $1 $F0 $8 */, 
  {   3, { { 0x0E, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescRtnCtrlStartNexteer_F009_Current_Mode_Current_Offset_Calc } /* $31 $1 $F0 $9 */, 
  {   3, { { 0x0E, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescRtnCtrlStopNexteer_F009_Current_Mode_Current_Offset_Calc } /* $31 $2 $F0 $9 */, 
  {   3, { { 0x0E, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescRtnCtrlReqResNexteer_F009_Current_Mode_Current_Offset_Calc } /* $31 $3 $F0 $9 */, 
  {   4, { { 0x0E, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescRtnCtrlStartNexteer_F00D_Calculate_Current_Gain } /* $31 $1 $F0 $D */, 
  {   4, { { 0x0E, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescRtnCtrlStartNexteer_F00E_Calculate_Current_Offset } /* $31 $1 $F0 $E */, 
...
/*  ********************************************************************************
 * Function name:DescOemStartSessionNexteerMode
 * Description:Processes the session change request, parametrizing the common processing
 * function.
 * Returns:  nothing
 * Parameter(s):
...
static void DESC_API_CALLBACK_TYPE DescOemStartSessionNexteerMode(DescMsgContext* pMsgContext)
{
  DescOemPrepareSessionControl(pMsgContext, kDescStateSessionNexteer_Mode);
}
...
/*  ********************************************************************************
 * Function name:DescOemPostStartSessionNexteerMode (Service request header:$10 $7E )
 * Description:This session is for Nexteer personnel only
 * Returns:  nothing
 * Parameter(s):
 *   - status:
 *       - Shows the status of the process accomplishment. Can be: kDescPostHandlerStateOk or kDescPostHandlerStateNegResSent or/and kDescPostHandlerStateTxFailed.
...
static void DESC_API_CALLBACK_TYPE DescOemPostStartSessionNexteerMode(vuint8 status)
{
  DescOemCommonSessionPostProcessing(status, kDescStateSessionNexteer_Mode);
}
  ...
  */
  ...
  { /* Take the linear case always */
    ...
    * this function call is just spended - no copy will be performed (dataU16 = 0) */
    ...
    returnValue = kDescUsdtNetworkOk;   /*Everything´s ok now*/
  }
  return returnValue;
}
