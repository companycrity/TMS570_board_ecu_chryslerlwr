...
extern VAR(uint8, NVM_APPL_DATA) CDD_EOLNxtrWIRSelect_Cnt_G_u16[];
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_MtrPos_MtrPosSnsr_EOLData[];
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_HwTrq_HwTrqScaleData[];
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_Polarity_Polarity_Cnt_Str[];
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_HwTrq_HwTrqTrimData[];
...
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_TrqCmdScl_TorqueCmdSF_Uls_f32[];
extern VAR(uint8, NVM_APPL_DATA) Rte_CmMtrCurr_CurrTempOffset[];
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_CmMtrCurr_ShCurrCal[];
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_CurrParamComp_EOLNomMtrParam[];
extern VAR(uint8, NVM_APPL_DATA) Rte_Ap_LrnEOT_LearnedEOT[];
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_Ap_TrqCanc_CogTrqCal[];
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_HwTrq_EOLTrqStepData[];
extern VAR(uint8, NVM_APPL_DATA) Nvm_MetadataAppl_Cnt_u8[];
extern VAR(uint8, NVM_APPL_DATA) Nvm_MetadataCal1_Cnt_u8[];
extern VAR(uint8, NVM_APPL_DATA) Nvm_MetadataCal2_Cnt_u8[];
extern VAR(uint8, NVM_APPL_DATA) Nvm_ActiveDiagInfoBoot_Cnt_u8[];
extern VAR(uint8, NVM_APPL_DATA) Nvm_HwPartNumber_Cnt_u8[];
extern VAR(uint8, NVM_APPL_DATA) Nvm_HwVersionInfo_Cnt_u8[];
extern VAR(uint8, NVM_APPL_DATA) Nvm_BootSwVersionInfo_Cnt_u8[];
extern VAR(uint8, NVM_APPL_DATA) Nvm_HwSupplierID_Cnt_u8[];
extern VAR(uint8, NVM_APPL_DATA) Nvm_ResponseOnEventActv_Cnt_u8[];
extern VAR(uint8, NVM_APPL_DATA) Nvm_VINOdometer_Cnt_u8[];
extern VAR(uint8, NVM_APPL_DATA) Nvm_DiagSpecInfo_Cnt_u8[];
extern VAR(uint8, NVM_APPL_DATA) Nvm_VehicleInfo_Cnt_u8[];
extern VAR(uint8, NVM_APPL_DATA) Nvm_ECUSerialNumber_Cnt_u8[];
extern VAR(uint8, NVM_APPL_DATA) Nvm_VINCurrent_Cnt_u8[];
extern VAR(uint8, NVM_APPL_DATA) Nvm_VINOriginal_Cnt_u8[];
extern VAR(uint8, NVM_APPL_DATA) Nvm_ActiveDiagInfoAppl_Cnt_u8[];
...
extern VAR(uint8, NVM_APPL_DATA) Nvm_EcuPn_Cnt_u8[];
extern VAR(uint8, NVM_APPL_DATA) Nvm_NxtrManfScrpd_Cnt_u8[];
extern VAR(uint8, NVM_APPL_DATA) Nvm_IgnCntr_Cnt_u16[];
extern VAR(uint8, NVM_APPL_DATA) CloseCheck_Cnt_u32[];
extern VAR(uint8, NVM_APPL_DATA) NTCBlackBoxData_Cnt_str[];
extern VAR(uint8, NVM_APPL_DATA) Rte_Ap_AvgFricLrn_AvgFricLrnData[];
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_BatteryVoltage_OvervoltageData[];
extern VAR(uint8, NVM_APPL_DATA) LatchCounter_Cnt_u16[];
extern VAR(uint8, NVM_APPL_DATA) Dem_NvData[];
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_Ap_TrqCanc_CogTrqRplComp[];
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_Ap_AstLmt_SteerAsstDefeat[];
...
#include "MemMap.h"
    ...
    /* block descriptor user block NVM_BLOCK_NXTRWIRSELECT */
    ,{
        (NvM_RamAddressType)&CDD_EOLNxtrWIRSelect_Cnt_G_u16 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
    ...
    ,{
        (NvM_RamAddressType)&NvMP_Rte_Polarity_Polarity_Cnt_Str /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    ,{
        (NvM_RamAddressType)&Rte_CmMtrCurr_CurrTempOffset /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    ,{
        (NvM_RamAddressType)&NvMP_Rte_CmMtrCurr_ShCurrCal /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    ,{
        (NvM_RamAddressType)&NvMP_Rte_CurrParamComp_EOLNomMtrParam /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    ,{
        (NvM_RamAddressType)&Rte_Ap_LrnEOT_LearnedEOT /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Rte_NvmBlock_IPMTrqCanc_CogTrqCal */
    ,{
        (NvM_RamAddressType)&NvMP_Rte_Ap_TrqCanc_CogTrqCal /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Rte_NvmBlock_HwTrq_EOLTrqStepData */
    ,{
    ...
    /* block descriptor user block NVM_BLOCK_SER_METADATA_APPLICATION */
    ,{
        (NvM_RamAddressType)&Nvm_MetadataAppl_Cnt_u8 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NVM_BLOCK_SER_METADATA_CAL1 */
    ,{
        (NvM_RamAddressType)&Nvm_MetadataCal1_Cnt_u8 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NVM_BLOCK_SER_METADATA_CAL2 */
    ,{
        (NvM_RamAddressType)&Nvm_MetadataCal2_Cnt_u8 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NVM_BLOCK_SER_ACTIVEDIAGINFO_BOOT */
    ,{
        (NvM_RamAddressType)&Nvm_ActiveDiagInfoBoot_Cnt_u8 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NVM_BLOCK_SER_HWPARTNUMBER */
    ,{
        (NvM_RamAddressType)&Nvm_HwPartNumber_Cnt_u8 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NVM_BLOCK_SER_HWVERSIONINFO */
    ,{
        (NvM_RamAddressType)&Nvm_HwVersionInfo_Cnt_u8 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NVM_BLOCK_SER_BOOTSWVERSIONINFO */
    ,{
        (NvM_RamAddressType)&Nvm_BootSwVersionInfo_Cnt_u8 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NVM_BLOCK_SER_HWSUPPID */
    ,{
        (NvM_RamAddressType)&Nvm_HwSupplierID_Cnt_u8 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NVM_BLOCK_SER_RESPONEVENTACTVSTATE */
    ,{
        (NvM_RamAddressType)&Nvm_ResponseOnEventActv_Cnt_u8 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NVM_BLOCK_SER_VINODOMETERCOUNTER */
    ,{
        (NvM_RamAddressType)&Nvm_VINOdometer_Cnt_u8 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NVM_BLOCK_SER_DIAGSPECINFO */
    ,{
        (NvM_RamAddressType)&Nvm_DiagSpecInfo_Cnt_u8 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NVM_BLOCK_SER_VEHICLEINFO */
    ,{
        (NvM_RamAddressType)&Nvm_VehicleInfo_Cnt_u8 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NVM_BLOCK_SER_ECUSERIALNUMBER */
    ,{
        (NvM_RamAddressType)&Nvm_ECUSerialNumber_Cnt_u8 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NVM_BLOCK_SER_VINCURRENT */
    ,{
        (NvM_RamAddressType)&Nvm_VINCurrent_Cnt_u8 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NVM_BLOCK_SER_VINORIGINAL */
    ,{
        (NvM_RamAddressType)&Nvm_VINOriginal_Cnt_u8 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NVM_BLOCK_SER_ACTIVEDIAGINFO_APPL */
    ,{
        (NvM_RamAddressType)&Nvm_ActiveDiagInfoAppl_Cnt_u8 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NVM_BLOCK_SER_ECUPN */
    ,{
        (NvM_RamAddressType)&Nvm_EcuPn_Cnt_u8 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    ,{
        (NvM_RamAddressType)&CloseCheck_Cnt_u32 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Rte_NvmBlock_Ap_AvgFricLrn_AvgFricLrnData */
    ,{
        (NvM_RamAddressType)&Rte_Ap_AvgFricLrn_AvgFricLrnData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    ,{
        (NvM_RamAddressType)&NvMP_Rte_BatteryVoltage_OvervoltageData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NvM_NVM_BLOCK_DEM */
    ,{
        ...
        330u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
        NVM_BLOCK_NATIVE,/* Management Type */
    ...
    /* block descriptor user block Rte_NvmBlock_Ap_TrqCanc_CogTrqRplComp */
    ,{
        (NvM_RamAddressType)&NvMP_Rte_Ap_TrqCanc_CogTrqRplComp /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Rte_NvmBlock_Ap_AstLmt_SteerAsstDefeat */
    ,{
        (NvM_RamAddressType)&NvMP_Rte_Ap_AstLmt_SteerAsstDefeat /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NVM_BLOCK_SWFINGERPRINT */
    ,{
        (NvM_RamAddressType)&Nvm_SWFingerprint_Cnt_u32 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NVM_BLOCK_RESETRESP */
    ,{
        (NvM_RamAddressType)&Nvm_ResetResp_Cnt_u8 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NVM_BLOCK_PROGREQCNT */
    ,{
        (NvM_RamAddressType)&Nvm_ProgReqCnt_Cnt_u8 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block NVM_BLOCK_SECDLYEN */
    ,{
        (NvM_RamAddressType)&Nvm_SecDlyEn_Cnt_u8 /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
