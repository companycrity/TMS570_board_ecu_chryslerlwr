...
/* No RTE is used - types IoHwAb_Types.h has to be included */
...
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_GetEpsEn(P2VAR(IoHwAb_BoolType, AUTOMATIC, IOHWAB_APPL_DATA) signal);
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_GetPwrSwitchEn(P2VAR(IoHwAb_BoolType, AUTOMATIC, IOHWAB_APPL_DATA) signal);
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_GetFetDrvCntl(P2VAR(IoHwAb_BoolType, AUTOMATIC, IOHWAB_APPL_DATA) signal);
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_SetFetFlt2Clk(IoHwAb_BoolType signal);
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_GetFetFlt2Clk(P2VAR(IoHwAb_BoolType, AUTOMATIC, IOHWAB_APPL_DATA) signal);
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_GetFetFlt1Data(P2VAR(IoHwAb_BoolType, AUTOMATIC, IOHWAB_APPL_DATA) signal);
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_SetSysFault2(IoHwAb_BoolType signal);
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_GetSysFault2(P2VAR(IoHwAb_BoolType, AUTOMATIC, IOHWAB_APPL_DATA) signal);
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_SetWdMonitor(IoHwAb_BoolType signal);
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_SetFetDrvReset(IoHwAb_BoolType signal);
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_GetFetDrvReset(P2VAR(IoHwAb_BoolType, AUTOMATIC, IOHWAB_APPL_DATA) signal);
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_SetWdReset(IoHwAb_BoolType signal);
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_SetTODReset(IoHwAb_BoolType signal);
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_GetOvrVoltFdbk(P2VAR(IoHwAb_BoolType, AUTOMATIC, IOHWAB_APPL_DATA) signal);
/*</IOHWAB_CFG_CALPROTOTYPES>*/

/*<IOHWAB_CFG_USERDEFPROTOTYPES>*/
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_OutputSetFetFlt2ToOutput(IoHwAb_BoolType signal);
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_InputOP_GET(P2VAR(IoHwAb_BoolType, AUTOMATIC, IOHWAB_APPL_DATA) signal);
FUNC(Std_ReturnType, IOHWAB_APPL_CODE) IoHwAb_OutputOP_SET(IoHwAb_BoolType signal);
/*</IOHWAB_CFG_USERDEFPROTOTYPES>*/
