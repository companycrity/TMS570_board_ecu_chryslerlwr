 ...
 * --------------------------------------------------*/
#define FEE_OPERATING_FREQUENCY (160.0)
 ...
 * Block configuration
 * --------------------------------------------------*/
#define FEE_NUMBER_OF_BLOCKS    (51U)
#define FEE_NUMBER_OF_UNCONFIGUREDBLOCKSTOCOPY	(10U)
...
#define FEE_TOTAL_BLOCKS_DATASETS       (52U)
