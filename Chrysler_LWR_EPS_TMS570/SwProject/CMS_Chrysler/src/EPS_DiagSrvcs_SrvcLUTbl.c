...
const struct EPS_DiagSrv_PIDtbl t_DiagSrv_PIDtbl[D_DIAGSRCVS_COMPIDTBLSIZE_CNT_U16 + D_DIAGSRCVS_PROGPIDTBLSIZE_CNT_U16] =
{
	...
	/* Reset Services */
	{0x1160U, &EPSInternal_RESET_1160, D_PIDTBL_RESETTYPE, 0U, 0U, 0U, 0x0000U, D_PIDTBL_READONLY, D_EPSDIAGSRVRESET1160_CNT_ENUM}, /* Nexteer ECU Reset */
	...
	{0xFD19U, &EPSInternal_PID_FD19, D_PIDTBL_PIDTYPE, 1U, 0U, 0U, 0x0000U, D_PIDTBL_READWRITE, D_EPSDIAGSRVPIDFD19_CNT_ENUM}, /* Nexteer MEC */
