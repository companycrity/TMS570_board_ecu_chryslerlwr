 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_Type.h
 *     Workspace:  C:/cmsynergy/My_Ford_WA/Ford_S550_P552_EPS_TMS570/Tools/AsrProject/Config/DCF/EPS.dcf
 *   ECU-Project:  EPS
 *  Generated at:  Fri Jul 20 14:44:21 2012
 *
...
# define Rte_TypeDef_DT_TmprlMonSt
typedef uint8 DT_TmprlMonSt;
# define DT_TmprlMonSt_LowerLimit (0U)
# define DT_TmprlMonSt_UpperLimit (11U)
# if (defined RTE_CONST_TMPMON_RESET1) || (defined TMPMON_RESET1)
#  if (!defined RTE_CONST_TMPMON_RESET1) || (RTE_CONST_TMPMON_RESET1 != 0U)
#   error "Enumeration constant <TMPMON_RESET1> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_TMPMON_RESET1 (0U)
#  define TMPMON_RESET1 (0U)
# endif
# if (defined RTE_CONST_TMPMON_INIT_ALLOFF1) || (defined TMPMON_INIT_ALLOFF1)
#  if (!defined RTE_CONST_TMPMON_INIT_ALLOFF1) || (RTE_CONST_TMPMON_INIT_ALLOFF1 != 1U)
#   error "Enumeration constant <TMPMON_INIT_ALLOFF1> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_TMPMON_INIT_ALLOFF1 (1U)
#  define TMPMON_INIT_ALLOFF1 (1U)
# endif
# if (defined RTE_CONST_TMPMON_INIT_TMOFF1) || (defined TMPMON_INIT_TMOFF1)
#  if (!defined RTE_CONST_TMPMON_INIT_TMOFF1) || (RTE_CONST_TMPMON_INIT_TMOFF1 != 2U)
#   error "Enumeration constant <TMPMON_INIT_TMOFF1> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_TMPMON_INIT_TMOFF1 (2U)
#  define TMPMON_INIT_TMOFF1 (2U)
# endif
# if (defined RTE_CONST_TMPMON_INIT_ALLON1) || (defined TMPMON_INIT_ALLON1)
#  if (!defined RTE_CONST_TMPMON_INIT_ALLON1) || (RTE_CONST_TMPMON_INIT_ALLON1 != 3U)
#   error "Enumeration constant <TMPMON_INIT_ALLON1> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_TMPMON_INIT_ALLON1 (3U)
#  define TMPMON_INIT_ALLON1 (3U)
# endif
# if (defined RTE_CONST_TMPMON_INIT_SFOFF) || (defined TMPMON_INIT_SFOFF)
#  if (!defined RTE_CONST_TMPMON_INIT_SFOFF) || (RTE_CONST_TMPMON_INIT_SFOFF != 4U)
#   error "Enumeration constant <TMPMON_INIT_SFOFF> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_TMPMON_INIT_SFOFF (4U)
#  define TMPMON_INIT_SFOFF (4U)
# endif
# if (defined RTE_CONST_TMPMON_INIT_ALLON2) || (defined TMPMON_INIT_ALLON2)
#  if (!defined RTE_CONST_TMPMON_INIT_ALLON2) || (RTE_CONST_TMPMON_INIT_ALLON2 != 5U)
#   error "Enumeration constant <TMPMON_INIT_ALLON2> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_TMPMON_INIT_ALLON2 (5U)
#  define TMPMON_INIT_ALLON2 (5U)
# endif
# if (defined RTE_CONST_TMPMON_INIT_TMOFF2) || (defined TMPMON_INIT_TMOFF2)
#  if (!defined RTE_CONST_TMPMON_INIT_TMOFF2) || (RTE_CONST_TMPMON_INIT_TMOFF2 != 6U)
#   error "Enumeration constant <TMPMON_INIT_TMOFF2> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_TMPMON_INIT_TMOFF2 (6U)
#  define TMPMON_INIT_TMOFF2 (6U)
# endif
# if (defined RTE_CONST_TMPMON_RESET2) || (defined TMPMON_RESET2)
#  if (!defined RTE_CONST_TMPMON_RESET2) || (RTE_CONST_TMPMON_RESET2 != 7U)
#   error "Enumeration constant <TMPMON_RESET2> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_TMPMON_RESET2 (7U)
#  define TMPMON_RESET2 (7U)
# endif
# if (defined RTE_CONST_TMPMON_INIT_ALLON3) || (defined TMPMON_INIT_ALLON3)
#  if (!defined RTE_CONST_TMPMON_INIT_ALLON3) || (RTE_CONST_TMPMON_INIT_ALLON3 != 8U)
#   error "Enumeration constant <TMPMON_INIT_ALLON3> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_TMPMON_INIT_ALLON3 (8U)
#  define TMPMON_INIT_ALLON3 (8U)
# endif
# if (defined RTE_CONST_TMPMON_OPERATE) || (defined TMPMON_OPERATE)
#  if (!defined RTE_CONST_TMPMON_OPERATE) || (RTE_CONST_TMPMON_OPERATE != 9U)
#   error "Enumeration constant <TMPMON_OPERATE> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_TMPMON_OPERATE (9U)
#  define TMPMON_OPERATE (9U)
# endif
# if (defined RTE_CONST_TMPMON_DISABLE) || (defined TMPMON_DISABLE)
#  if (!defined RTE_CONST_TMPMON_DISABLE) || (RTE_CONST_TMPMON_DISABLE != 10U)
#   error "Enumeration constant <TMPMON_DISABLE> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_TMPMON_DISABLE (10U)
#  define TMPMON_DISABLE (10U)
# endif
# if (defined RTE_CONST_TMPMON_NUMSTATES) || (defined TMPMON_NUMSTATES)
#  if (!defined RTE_CONST_TMPMON_NUMSTATES) || (RTE_CONST_TMPMON_NUMSTATES != 11U)
#   error "Enumeration constant <TMPMON_NUMSTATES> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_TMPMON_NUMSTATES (11U)
#  define TMPMON_NUMSTATES (11U)
# endif
...
# endif
# if (defined RTE_CONST_NTC_Num_AngleCntrlFltAE) || (defined NTC_Num_AngleCntrlFltAE)
#  if (!defined RTE_CONST_NTC_Num_AngleCntrlFltAE) || (RTE_CONST_NTC_Num_AngleCntrlFltAE != 225U)
#   error "Enumeration constant <NTC_Num_AngleCntrlFltAE> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_NTC_Num_AngleCntrlFltAE (225U)
#  define NTC_Num_AngleCntrlFltAE (225U)
# endif
...
typedef struct
{
  OFFS_GRD_MID_EPS value;
} Rte_DE_OFFS_GRD_MID_EPS;
...
typedef struct
{
  ElPwDStatStrtStopType value;
} Rte_DE_ElPwDStatStrtStopType;

typedef struct
{
  PwPckTqDStatType value;
} Rte_DE_PwPckTqDStatType;
...
extern VAR(Float, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Rte_ActivePull_LTComp_HwNm_N_f32;
extern VAR(Float, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Rte_Ap_AbsHwPos_VehCntrOffset;
...
extern VAR(OFFS_GRD_MID_EPS, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Rte_Ap_AbsHwPos_RacktoVehCntrOffset;
extern VAR(UInt16, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Rte_Polarity_EOLCtrlPolarity;
extern VAR(Boolean, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Rte_Ap_AbsHwPos_LTVehCntrComplete;
extern VAR(Boolean, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Rte_Ap_LrnEOT_RackCntrPerf;
extern VAR(NTCStrgArray, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Rte_DiagMgr_NTCStrgArray;
extern VAR(IPMCoggingCancTrq, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Rte_IPMTrqCanc_CogTrqCal;
...
extern VAR(CurrTempOffsetType, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Rte_CmMtrCurr_CurrTempOffset;
extern VAR(PhaseCurrCal_DataType, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Rte_CmMtrCurr_ShCurrCal;
...
typedef struct
{
  ...
  Rte_DE_OFFS_GRD_MID_EPS Rte_RacktoVehCntrOffset_Cnt_u16;
...
typedef struct
{
  ...
  Rte_DE_UInt8 Rte_TCSWVersion_Cnt_u08;
...
typedef struct
{
  Rte_DE_Float Rte_T1Duty_Uls_f32;
  Rte_DE_Float Rte_T2Duty_Uls_f32;
...
typedef struct
{
  ...
  Rte_DE_SInt8 Rte_Polarity_Cnt_s8;
  Rte_DE_Float Rte_TCMtrPosOffsMRF_Deg_f32;
...
typedef struct
{
  ...
  Rte_DE_Boolean Rte_PAActive_Cnt_lgc;
...
{
  Rte_DE_Float Rte_CorrMtrPosElec_Rev_f32;
  Rte_DE_Float Rte_MtrCurrAngle_IPM_Rev_f32;
  Rte_DE_Float Rte_MtrCurrAngle_SPM_Rev_f32;
  Rte_DE_Float Rte_MtrCurrK1_Amp_f32;
  Rte_DE_Float Rte_MtrCurrK2_Amp_f32;
...
typedef struct
{
  ...
  Rte_DE_Float Rte_VehSpd_Kph_f32;
  Rte_DE_Float Rte_DaxIntegralGain_Uls_f32;
  Rte_DE_Float Rte_DaxPropotionalGain_Uls_f32;
  Rte_DE_Float Rte_MtrCurrAngle_Rev_f32;
  Rte_DE_Float Rte_MtrPosComputationDelay_Deg_f32;
  Rte_DE_SInt16 Rte_MtrTrqCmdSign_Cnt_s16;
  Rte_DE_Float Rte_MtrVoltDaxFF_Volt_f32;
  Rte_DE_Float Rte_MtrVoltQaxFF_Volt_f32;
  Rte_DE_Float Rte_QaxIntegralGain_Uls_f32;
  Rte_DE_Float Rte_QaxPropotionalGain_Uls_f32;
...
typedef struct
{
  ...
  Rte_DE_Float Rte_QaxIntegralGain_Uls_f32;
  Rte_DE_Float Rte_QaxPropotionalGain_Uls_f32;
} Rte_tsRB_Ap_IPMCurrCmd_IPMCurrCmd_Per1;
...
} Rte_tsRB_Ap_IPMTrqCanc_IPMTrqCanc_Per1;
...
typedef struct
{
  ...
  Rte_DE_Float Rte_MtrTrq_MtrNm_f32;
  Rte_DE_Float Rte_EstKe_VpRadpS_f32;
  Rte_DE_Float Rte_EstLd_Henry_f32;
  Rte_DE_Float Rte_EstLq_Henry_f32;
  Rte_DE_Float Rte_EstR_Ohm_f32;
...
typedef struct
{
  ...
  Rte_DE_Float Rte_MtrCurrQaxRef_SPM_Amp_f32;
  Rte_DE_Float Rte_Vecu_Volt_f32;
} Rte_tsRB_Ap_CurrReasDiag_CurrReasDiag_Per1;
...
typedef struct
{
  ...
  Rte_DE_Float Rte_MRFCumMtrPos_Deg_f32;
  Rte_DE_Float Rte_MfgMtrBasedPos_HwDeg_f32;
  Rte_DE_Float Rte_MtrBasedPos_HwDeg_f32;
...
typedef struct
{
  Rte_DE_ElPwDStatStrtStopType Rte_ElPwDStatStrtStop_Cnt_enum;
  Rte_DE_Boolean Rte_EngONSrlComSvcDft_Cnt_lgc;
  Rte_DE_PwPckTqDStatType Rte_PwPckTqDStat_Cnt_enum;
...
typedef struct
{
  ...
  Rte_DE_Boolean Rte_CtrldDmpStsCmp_Cnt_lgc;
  Rte_DE_Boolean Rte_FTermActive_Cnt_lgc;
  Rte_DE_Boolean Rte_RampStatusCmp_Cnt_lgc;
} Rte_tsRB_Ap_StaMd_StaMd_Per1;

typedef struct
{
  Rte_DE_UInt8 Rte_ArbiterCommandEAC_Cnt_u08;
  Rte_DE_Float Rte_HwTorqueHysAdd_HwNm_f32;
  ...
  Rte_DE_Boolean Rte_PAHwARqstValid_Cnt_lgc;
  Rte_DE_Float Rte_PAHwAngleRqst_HwDeg_f32;
  Rte_DE_Boolean Rte_PASpdHigh_Cnt_lgc;
  Rte_DE_Boolean Rte_PASpdStdStill_Cnt_lgc;
  Rte_DE_Boolean Rte_PAVehSpdValid_Cnt_lgc;
  Rte_DE_Boolean Rte_PosServoSmoothEnable_Cnt_lgc;
  Rte_DE_Boolean Rte_PosTrajEnable_Cnt_lgc;
  Rte_DE_Float Rte_PosTrajHwAngle_HwDeg_f32;
  Rte_DE_Boolean Rte_TBAEnableRqst_Cnt_lgc;
  Rte_DE_Boolean Rte_TBAHwARqstValid_Cnt_lgc;
  Rte_DE_Float Rte_TBAHwAngleRqst_HwDeg_f32;
  Rte_DE_Boolean Rte_PosServEnable_Cnt_lgc;
  Rte_DE_Float Rte_PosServHwAngle_HwDeg_f32;
  Rte_DE_UInt8 Rte_TBAAngleCntrlState_Cnt_u08;
} Rte_tsRB_Ap_PkAsEn_PkAsEn_Per1;
...
typedef struct
{
  Rte_DE_Float Rte_HwTrq_HwNm_f32;
  Rte_DE_Float Rte_HwVel_HwRadpS_f32;
  Rte_DE_UInt16 Rte_ApedPos_Cnt_u16;
  Rte_DE_ElPwDStatStrtStopType Rte_ElPwDStatStrtStop_Cnt_enum;
  Rte_DE_UInt8 Rte_GearLvrPosD_Cnt_u08;
  Rte_DE_Boolean Rte_PAEnableRqst_Cnt_lgc;
  Rte_DE_Boolean Rte_PAErrInterfaceActive_Cnt_lgc;
  Rte_DE_Boolean Rte_PAHwARqstValid_Cnt_lgc;
  Rte_DE_Float Rte_PAHwAngleRqst_HwDeg_f32;
  ...
  Rte_DE_PwPckTqDStatType Rte_PwPckTqDStat_Cnt_enum;
  Rte_DE_Boolean Rte_SS_Event_Disable_Cnt_lgc;
  Rte_DE_UInt16 Rte_SrlComANCWhlSpdFL_cRadPerSec_u16;
  Rte_DE_UInt16 Rte_SrlComANCWhlSpdFR_cRadPerSec_u16;
  Rte_DE_Float Rte_SrlComVehSpd_Kph_f32;
  Rte_DE_Boolean Rte_TBACANSignalsValid_Cnt_lgc;
  Rte_DE_UInt16 Rte_TrlrAidAn_Cnt_u16;
  Rte_DE_UInt16 Rte_TrlrAidAnRate_Cnt_u16;
  Rte_DE_UInt16 Rte_TrlrAidCtlPotRqDrv_Cnt_u16;
  Rte_DE_UInt8 Rte_TrlrAidDStat_Cnt_u08;
  Rte_DE_UInt16 Rte_VehV_Cnt_u16;
  Rte_DE_Boolean Rte_VehVTrlrAidBAvail_Cnt_lgc;
  Rte_DE_UInt16 Rte_VehYawCompW_Cnt_u16;
  Rte_DE_UInt8 Rte_WhlDirFl_Cnt_u08;
  Rte_DE_UInt8 Rte_WhlDirFr_Cnt_u08;
  Rte_DE_UInt16 Rte_WhlRlWMeas_Cnt_u16;
  Rte_DE_UInt8 Rte_WhlRotatFl_Cnt_u08;
  Rte_DE_UInt8 Rte_WhlRotatFr_Cnt_u08;
  Rte_DE_UInt8 Rte_WhlRotatRl_Cnt_u08;
  Rte_DE_UInt8 Rte_WhlRotatRr_Cnt_u08;
  Rte_DE_UInt16 Rte_WhlRrWMeas_Cnt_u16;
...
typedef union
{
  ...
  Rte_tsRB_Ap_GenPosTraj_GenPosTraj_Per1 Rte_Ap_GenPosTraj_GenPosTraj_Per1;
  ...
  Rte_tsRB_Ap_IPMCurrCmd_IPMCurrCmd_Per1 Rte_Ap_IPMCurrCmd_IPMCurrCmd_Per1;
  Rte_tsRB_Ap_IPMTrqCanc_IPMTrqCanc_Per1 Rte_Ap_IPMTrqCanc_IPMTrqCanc_Per1;
  ...
  Rte_tsRB_Ap_CurrReasDiag_CurrReasDiag_Per1 Rte_Ap_CurrReasDiag_CurrReasDiag_Per1;
  ...
  Rte_tsRB_Ap_PkAsEn_PkAsEn_Per1 Rte_Ap_PkAsEn_PkAsEn_Per1;
...
typedef struct
{
  ...
  Rte_DE_Float Rte_I_Ap_AbsHwPos_HandwheelPosition_HwDeg_f32;
  Rte_DE_Float Rte_I_Ap_PosServo_PAReturnSclFct_Uls_f32;
  ...
  Rte_DE_Float Rte_I_CDDInterface_ADCMtrCurr1_Volts_f32;
  Rte_DE_Float Rte_I_CDDInterface_ADCMtrCurr2_Volts_f32;
  Rte_DE_Float Rte_I_CurrParamComp_EstLd_Henry_f32;
  Rte_DE_Float Rte_I_CurrParamComp_EstLq_Henry_f32;
  Rte_DE_Float Rte_I_CurrParamComp_EstR_Ohm_f32;
  Rte_DE_Float Rte_I_CurrCmd_MtrCurrDaxRef_Amp_f32;
  Rte_DE_Float Rte_I_CurrCmd_MtrCurrQaxRef_Amp_f32;
  Rte_DE_Float Rte_I_IPMCurrCmd_MtrCurrDaxRef_Amp_f32;
  Rte_DE_Float Rte_I_IPMCurrCmd_MtrCurrQaxRef_Amp_f32;
  Rte_DE_Float Rte_I_CDDInterface_MtrCurrQax_Amp_f32;
  ...
  Rte_DE_Float Rte_I_Ap_LrnEOT_CCWPosition_HwDeg_f32;
  Rte_DE_Boolean Rte_I_Ap_LrnEOT_CCWFound_Cnt_lgc;
  Rte_DE_Float Rte_I_Ap_LrnEOT_CWPosition_HwDeg_f32;
  Rte_DE_Boolean Rte_I_Ap_LrnEOT_CWFound_Cnt_lgc;
  Rte_DE_Float Rte_I_Ap_AbsHwPos_HandwheelAuthority_Uls_f32;
  Rte_DE_Float Rte_I_MtrVel_HwVel_HwRadpS_f32;
} Rte_tsTB_Task_2ms;
...
{
  Rte_DE_Float Rte_HWTorque_HwNm_f32;
  Rte_DE_PersonalizationType Rte_Personalization_Cnt_enum;
  Rte_DE_UInt16 Rte_QualWhlFLWMeas_cRadPerSec_u16;
  Rte_DE_UInt16 Rte_QualWhlFRWMeas_cRadPerSec_u16;
} Rte_tsRB_Ap_BlkBoxANCInterface_BlkBoxANCInterface_Per1;

typedef struct
{
  Rte_DE_Float Rte_ANCCmdReqst_MtrNm_f32;
  Rte_DE_UInt8 Rte_ANCStateReqst_Cnt_u08;
  Rte_DE_Float Rte_LDWCmdReqst_MtrNm_f32;
  Rte_DE_UInt8 Rte_LDWStateReqst_Cnt_u08;
  Rte_DE_Float Rte_LKACmdReqst_MtrNm_f32;
  Rte_DE_UInt8 Rte_LKAStateReqst_Cnt_u08;
  Rte_DE_Boolean Rte_PosServEnable_Cnt_lgc;
  Rte_DE_Float Rte_PosSrvoCmd_MtrNm_f32;
  Rte_DE_Boolean Rte_PosSrvoSmoothEnable_Cnt_lgc;
  Rte_DE_UInt8 Rte_ArbiterCommandANC_Cnt_u08;
  Rte_DE_UInt8 Rte_ArbiterCommandEAC_Cnt_u08;
  Rte_DE_UInt8 Rte_ArbiterCommandLDW_Cnt_u08;
  Rte_DE_UInt8 Rte_ArbiterCommandLKA_Cnt_u08;
  Rte_DE_Float Rte_IpTrqOvr_HwNm_f32;
  Rte_DE_Float Rte_OpTrqOvr_MtrNm_f32;
...
typedef union
{
  ...
  Rte_tsRB_Ap_BlkBoxANCInterface_BlkBoxANCInterface_Per1 Rte_Ap_BlkBoxANCInterface_BlkBoxANCInterface_Per1;
...
typedef struct
{
  Rte_DE_SInt8 Rte_HwPosPolarity_Cnt_s8;
  Rte_DE_SInt8 Rte_HwTrqPolarity_Cnt_s08;
...
{
  Rte_DE_Float Rte_HwTorqueHysAdd_HwNm_f32;
} Rte_tsRB_Ap_PkAsEn_PkAsEn_Init1;
...
typedef struct
{
  ...
  Rte_DE_UInt16 Rte_QualWhlFLWMeas_cRadPerSec_u16;
  Rte_DE_UInt16 Rte_QualWhlFRWMeas_cRadPerSec_u16;
} Rte_tsRB_Ap_BlkBoxANCInterface_BlkBoxANCInterface_Init1;
...
typedef union
{
  ...
  Rte_tsRB_Ap_PkAsEn_PkAsEn_Init1 Rte_Ap_PkAsEn_PkAsEn_Init1;
  Rte_tsRB_Ap_BlkBoxANCInterface_BlkBoxANCInterface_Init1 Rte_Ap_BlkBoxANCInterface_BlkBoxANCInterface_Init1;
...
#    error "The magic number of the generated file <C:/cmsynergy/My_Ford_WA/Ford_S550_P552_EPS_TMS570/SwProject/Source/GenDataRte/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
