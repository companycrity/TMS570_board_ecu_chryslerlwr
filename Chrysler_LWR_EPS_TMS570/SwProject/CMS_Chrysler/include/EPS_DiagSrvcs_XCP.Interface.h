 ...
 * %version:          1 %
 * %derived_by:       jzh87w %
 * %date_modified:    Thu Dec  5 14:32:11 2013 %
 *---------------------------------------------------------------------------------------------------------------------
 * Date      Rev      Author         Change Description                                                        SCR #
 * -------   -------  --------  ---------------------------------------------------------------------------  ----------
 * 07/31/12 	1		KS		Initial Component Release
 * 08/31/12 	2		SAH		changed kXcpMaxCTO to kCanXcpMaxCTO
 */
/**********************************************************************************************************************
 ...
 */
#define D_XCP_MASTER_ID_ULS_U32				0x0000060Au
#define D_XCP_SLAVE_ID_ULS_U32				0x0000060Bu
