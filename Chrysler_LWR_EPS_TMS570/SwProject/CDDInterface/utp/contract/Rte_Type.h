...
#  define PinionCtrStateType_LowerLimit ((PinionCtrStateType)0u)
#  define PinionCtrStateType_UpperLimit ((PinionCtrStateType)7u)
...
#   define HOLD ((PinionCtrStateType)0u)
#  endif
...
#   define POSANGVEL ((PinionCtrStateType)1u)
#  endif
...
#   define POSMTRTRQ ((PinionCtrStateType)2u)
#  endif
...
#   define NEGANGVEL ((PinionCtrStateType)3u)
#  endif
...
#   define NEGMTRTRQ ((PinionCtrStateType)4u)
#  endif
...
#   define MOVETO ((PinionCtrStateType)5u)
#  endif
...
#   define DONE ((PinionCtrStateType)6u)
#  endif
...
#   define TIMEOUT ((PinionCtrStateType)7u)
#  endif
...
struct Rte_CDS_Sa_CDDInterface
{
  ...
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Init1_Cos1RTAmpRec_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Init1_Cos1RTOffset_Volts_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Init1_Sin1RTAmpRec_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Init1_Sin1RTOffset_Volts_f32;
  ...
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per1_CorrMtrPosElec_Rev_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per1_Cos1Theta_Volts_f32;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per1_DutyCycleSmall_Cnt_u16;
  ...
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per1_MtrPosElec_Rev_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per1_MtrPosMech_Rev_f32;
  P2VAR(Rte_DE_SInt16, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per1_MtrRevCntr_Cnt_s16;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per1_PhsReasA_Volts_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per1_PhsReasB_Volts_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per1_PhsReasC_Volts_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per1_SWDutyCycleA_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per1_SWDutyCycleB_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per1_SWDutyCycleC_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per1_Sin1Theta_Volts_f32;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_CommOffset_Cnt_u16;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_DaxIntegralGain_IPM_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_DaxIntegralGain_SPM_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_DaxPropotionalGain_IPM_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_DaxPropotionalGain_SPM_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_EstKe_VpRadpS_f32;
  ...
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_MtrCurrDaxRef_IPM_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_MtrCurrDaxRef_SPM_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_MtrCurrQax12Mag_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_MtrCurrQax12Ph_Rev_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_MtrCurrQax6Mag_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_MtrCurrQax6Ph_Rev_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_MtrCurrQaxRef_IPM_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_MtrCurrQaxRef_SPM_Amp_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_MtrPosComputationDelay_IPM_Deg_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_MtrPosComputationDelay_SPM_Deg_f32;
  P2VAR(Rte_DE_SInt16, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_MtrTrqCmdSign_IPM_Cnt_s16;
  P2VAR(Rte_DE_SInt16, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_MtrTrqCmdSign_SPM_Cnt_s16;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_MtrVoltDaxFF_IPM_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_MtrVoltDaxFF_SPM_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_MtrVoltQaxFF_IPM_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_MtrVoltQaxFF_SPM_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_QaxIntegralGain_IPM_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_QaxIntegralGain_SPM_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_QaxPropotionalGain_IPM_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_QaxPropotionalGain_SPM_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per2_Vecu_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per3_Cos1RTAmpRec_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per3_Cos1RTOffset_Volts_f32;
  P2VAR(Rte_DE_FETPHASETYPE_ENUM, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per3_FETFaultPhase_Cnt_enum;
  P2VAR(Rte_DE_FETFAULTTYPE_ENUM, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per3_FETFaultType_Cnt_enum;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per3_Sin1RTAmpRec_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per3_Sin1RTOffset_Volts_f32;
  ...
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per4_DiagStsDefVehSpd_Cnt_lgc;
  ...
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per4_VehSpdValid_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per4_WIREnabled_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_CDDINTERFACE_APPL_VAR) CDDInterface_Per4_WhlImbRejSrlComSvcDft_Cnt_lgc;
...
#    error "The magic number of the generated file <C:/CMSynergy_Projects/Ford_S550_P552_EPS_TMS570/SwProject/CDDInterface/utp/contract/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
