...
#    error "The magic number of the generated file <C:/Synergy/working_projects/ESG_Dev_65/StbCTO/StbCTO/utp/contract/Ap_StbCTO/Rte_Compiler_Cfg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
