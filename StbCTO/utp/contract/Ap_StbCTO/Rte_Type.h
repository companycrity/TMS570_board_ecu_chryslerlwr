...
# define TOC_STATE_LowerLimit ((TOC_STATE)0u)
# define TOC_STATE_UpperLimit ((TOC_STATE)255u)
# define Rte_InvalidValue_TOC_STATE ((TOC_STATE)255u)
...
#  define TOCSTATE_OFF ((TOC_STATE)0u)
# endif
...
#  define TOCSTATE_TNA ((TOC_STATE)1u)
# endif
...
#  define TOCSTATE_PNA ((TOC_STATE)2u)
# endif
...
#  define TOCSTATE_READY ((TOC_STATE)3u)
# endif
...
#  define TOCSTATE_REQUESTDENIED ((TOC_STATE)4u)
# endif
...
#  define TOCSTATE_ACTIVEMODE05 ((TOC_STATE)5u)
# endif
...
#  define TOCSTATE_ACTIVEMODE06 ((TOC_STATE)6u)
# endif
...
#  define TOCSTATE_ACTIVEMODE07 ((TOC_STATE)7u)
# endif
...
#  define TOCSTATE_NOTAVAILABLE ((TOC_STATE)8u)
# endif
...
struct Rte_CDS_Ap_StbCTO
{
  /* Data Handles section */
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_STBCTO_APPL_VAR) StbCTO_Init1_DSTActive_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_STBCTO_APPL_VAR) StbCTO_Init1_DSTSlewStart_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_STBCTO_APPL_VAR) StbCTO_Per1_DSTActive_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_STBCTO_APPL_VAR) StbCTO_Per1_DSTEnableRqst_Cnt_lgc;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_STBCTO_APPL_VAR) StbCTO_Per1_DSTErrCntrRecvLevel_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_STBCTO_APPL_VAR) StbCTO_Per1_DSTExtSystemFltActive_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_STBCTO_APPL_VAR) StbCTO_Per1_DSTFuncPresent_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_STBCTO_APPL_VAR) StbCTO_Per1_DSTRevGearValid_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_STBCTO_APPL_VAR) StbCTO_Per1_DSTSlewComplete_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_STBCTO_APPL_VAR) StbCTO_Per1_DSTSlewStart_Cnt_lgc;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_STBCTO_APPL_VAR) StbCTO_Per1_DSTState_Cnt_u08;
  P2VAR(Rte_DE_TOC_STATE, TYPEDEF, RTE_AP_STBCTO_APPL_VAR) StbCTO_Per1_DSTTOCState_Uls_enum;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_STBCTO_APPL_VAR) StbCTO_Per1_DSTTrqOvCmdRqst_HwNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_STBCTO_APPL_VAR) StbCTO_Per1_DSTTrqOvRqstValid_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_STBCTO_APPL_VAR) StbCTO_Per1_DiagRedAssistLowVoltageActive_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_STBCTO_APPL_VAR) StbCTO_Per1_DiagStsNonRecRmpToZeroFltPres_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_STBCTO_APPL_VAR) StbCTO_Per1_DiagStsRecRmpToZeroFltPres_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_STBCTO_APPL_VAR) StbCTO_Per1_LimitPercentFiltered_Uls_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_STBCTO_APPL_VAR) StbCTO_Per1_TOEOLDisable_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_STBCTO_APPL_VAR) StbCTO_Per1_TrqOvReverseGearEngage_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_STBCTO_APPL_VAR) StbCTO_Per1_VehicleSpeedValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_STBCTO_APPL_VAR) StbCTO_Per1_VehicleSpeed_Kph_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_StbCTO, RTE_CONST, RTE_CONST) Rte_Inst_Ap_StbCTO;
...
#    error "The magic number of the generated file <C:/Synergy/working_projects/ESG_Dev_65/StbCTO/StbCTO/utp/contract/Ap_StbCTO/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
