...
#   error "The magic number of the generated file <C:/Synergy_projects/ThrmDutyCycle-lz4p8n/ThrmDutyCycle/utp/contract/Ap_ThrmlDutyCycle/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
