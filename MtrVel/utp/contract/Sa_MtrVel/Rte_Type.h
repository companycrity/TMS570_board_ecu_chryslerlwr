 ...
 *     SW-C Type:  Sa_MtrVel
 *  Generated at:  Tue May  7 10:30:13 2013
 *
...
struct Rte_CDS_Sa_MtrVel
{
  ...
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_SA_MTRVEL_APPL_VAR) MtrVel_Per1_AsstAssemPol_Cnt_s08;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRVEL_APPL_VAR) MtrVel_Per1_CRFMotorVel_MtrRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRVEL_APPL_VAR) MtrVel_Per1_HandwheelVel_HwRadpS_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_MTRVEL_APPL_VAR) MtrVel_Per1_HwVelValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRVEL_APPL_VAR) MtrVel_Per1_MRFMotorVelUnfiltered_MtrRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRVEL_APPL_VAR) MtrVel_Per1_MRFMotorVel_MtrRadpS_f32;
  ...
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRVEL_APPL_VAR) MtrVel_Per1_VehicleSpeed_Kph_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRVEL_APPL_VAR) MtrVel_Per2_SysCDiagHandWheelVel_HwRadpS_f32;
...
#   if RTE_MAGIC_NUMBER != 1359728067
#    error "The magic number of the generated file <C:/ccm_wa/EPS/570/I490/MtrVel/utp/contract/Sa_MtrVel/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
#   define RTE_MAGIC_NUMBER 1359728067
