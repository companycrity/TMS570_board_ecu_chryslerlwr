...
struct Rte_CDS_Sa_MtrPos3
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRPOS3_APPL_VAR) MtrPos3_Per1_InvCos2Scaled_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRPOS3_APPL_VAR) MtrPos3_Per1_InvSin2Scaled_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRPOS3_APPL_VAR) MtrPos3_Per2_CorrectedMtrPos_Rev_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRPOS3_APPL_VAR) MtrPos3_Per2_InvCos2Scaled_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_MTRPOS3_APPL_VAR) MtrPos3_Per2_InvSin2Scaled_Volt_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Sa_MtrPos3, RTE_CONST, RTE_CONST) Rte_Inst_Sa_MtrPos3;
...
#    error "The magic number of the generated file <C:/Workspace/MtrPos-CBD_MtrPosMeas/FDD06B/MtrPos/utp/contract/Sa_MtrPos3/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
