...
#    error "The magic number of the generated file <C:/Synergy_projects/ArbLmt-lz4p8n1/ArbLmt/utp/contract/Ap_ArbLmt/Rte_Compiler_Cfg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
