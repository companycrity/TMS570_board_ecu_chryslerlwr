...
#    error "The magic number of the generated file <C:/Synergy/TuningSelAuth-zz4r1x/TuningSelAuth/utp/contract/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
