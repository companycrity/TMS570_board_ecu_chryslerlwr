 ...
 *********************************************************************************************************************/
	...
	PreLimitForStall_MtrNm_T_f32 = Min_m(PreLimitForStall_MtrNm_T_f32, AssistVehSpdLimit_MtrNm_T_f32);
	...
	else
	{
		...
		AbsLimitedTorque_MtrNm_T_f32 = Min_m(AbsLimitedTorque_MtrNm_T_f32, ThermalLimit_MtrNm_T_f32);
	}
